/**
 * Leaving this in temporarily until we move project tiles to
 * Helios.
 */
...
export const ARCH_PATH_D = 'M120.714+1.08927L0.71409+0.852993C0.67471+20.853+0.63533+40.8529+0.59595+60.8529C0.530703+93.9899+27.3407+120.906+60.4777+120.971C93.6147+121.036+120.53+94.2262+120.596+61.0892C120.635+41.0892+120.674+21.0892+120.714+1.08927Z'
      ...
      return (
        <>
          ...
          <path
            ...
            transform={`translate(${innerTranslate}) scale(0.68)`}
