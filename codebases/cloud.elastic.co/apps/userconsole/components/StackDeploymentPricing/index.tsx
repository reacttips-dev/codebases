...
const StackDeploymentPricing: FunctionComponent<Props> = () => (
  ...
  >
    {(props: CreateEditorComponentConsumerProps) => <StackDeploymentPricingEditor {...props} />}
  </CreateStackDeploymentEditorDependencies>
)

export default StackDeploymentPricing
