...
const definition: SliderNodeDefinition = {
  messages: defineMessages({
    prettyName: {
      id: `sliders.elasticsearch.data_hot.prettyName`,
      defaultMessage: `Hot data`,
    },
    deploymentTemplateDescription: {
      id: `sliders.elasticsearch.data_hot.deploymentTemplateDescription`,
      defaultMessage: `Nodes in this tier ingest and process frequently queried data.`,
    },
    instanceConfigurationDescription: {
      id: `sliders.elasticsearch.data_hot.instanceConfigurationDescription`,
      defaultMessage: `Nodes in this tier ingest and process frequently queried data.`,
    },
  }),
