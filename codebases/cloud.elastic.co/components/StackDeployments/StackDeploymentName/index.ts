...
import StackDeploymentName from './StackDeploymentName'

import { updateDeployment } from '../../../actions/stackDeployments'

import { updateStackDeploymentRequest } from '../../../reducers'

import { ReduxState, AsyncRequestState, StackDeployment, ThunkDispatch } from '../../../types'
...
type DispatchProps = {
  updateDeployment: (updateRequest: DeploymentUpdateRequest) => void
}
...
const mapDispatchToProps = (
  ...
  updateDeployment: (updateRequest: DeploymentUpdateRequest) =>
    dispatch(
      updateDeployment({
