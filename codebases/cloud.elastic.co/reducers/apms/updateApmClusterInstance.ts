...
import { ApmCluster, ApmClusterInstance } from '../../types'
...
function updateInstances(
  oldCluster: ApmCluster,
  instanceIds: string[],
  updateFn: (instance: ApmClusterInstance) => ApmClusterInstance,
) {
  return instanceIds.reduce((cluster: ApmCluster, instanceId) => {
