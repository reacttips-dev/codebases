.confirmation_28FTb {
  ...
  .confirmation_28FTb h1 {
      font-family: "Human BBY", Arial, sans-serif;
      font-size: 14px;
      font-weight: 600;
      margin: 3px 0 15px;
    }
  .confirmation_28FTb p {
      font-size: 14px;
    }
  .confirmation_28FTb .toasterContainer.failed .toaster {
        background-color: #FCEDF0;
      }
  .confirmation_28FTb .toasterContainer.failed .toaster .confirmation {
        padding-left: 30px;
      }
  .confirmation_28FTb .toasterContainer.failed .toaster .confirmation svg {
          position: absolute;
          left: -30px;
          top: -2px;
        }
  .confirmation_28FTb .toasterContainer.failed .toaster .confirmation h1 {
          position: relative;
          color: rgb(187, 22, 46);
          margin: 0 24px 5px 0;
        }
  .confirmation_28FTb .toasterContainer.failed .toaster .confirmation p {
          margin: 0;
          font-size: 14px;
        }
...
@media (min-width: 1025px) {
  .confirmation_28FTb {
    -webkit-filter: none;
      ...
      .confirmation_28FTb .toasterContainer {
        position: static;
      }

        .confirmation_28FTb .toasterContainer .toaster {
        ...
        .confirmation_28FTb .toasterContainer .toaster:after {
    bottom: 100%;
    right: 40px;
    ...
    margin-left: -10px;
      ...
      .confirmation_28FTb .toasterContainer.visible .toaster {
      ...
      .confirmation_28FTb .toasterContainer.visible .toaster:after {
    opacity: 1;
    -webkit-transition: opacity 200ms;
    transition: opacity 200ms;
  }
      .confirmation_28FTb .toasterContainer.failed .toaster:after {
            border-bottom: 10px solid #FCEDF0;
  }

      .confirmation_28FTb .fixed {
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
        ...
        .confirmation_28FTb .fixed .toasterContainer {
          position: relative;
        ...
        .confirmation_28FTb .fixed .toasterContainer.visible .toaster {
              top: 12px;
              right: 24px;
        ...
        .confirmation_28FTb .fixed .toasterContainer.visible .toaster:after {
    opacity: 0;
  }
}
