...
const parseOperands = (inputs) => {
    return inputs.reduce((acc, item) => {
        const hasDefaultValue = item.defaultValue || item.defaultValue === 0;
        const operands = hasDefaultValue ? { [item.name]: item.defaultValue } : {};
...
exports.default = NestedQueryBuilder;
