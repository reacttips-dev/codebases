...
var Formatter = require('@pipedrive/formatter');
var getTranslator = require('@pipedrive/translator-client/fe');
var awesomeDebouncePromise = require('awesome-debounce-promise');
var classNames = require('classnames');
var Downshift = require('downshift');
var moment$1 = require('moment');
var validate = require('validate.js');
var fetch = require('@pipedrive/fetch');
...
var Formatter__default = /*#__PURE__*/_interopDefaultLegacy(Formatter);
var getTranslator__default = /*#__PURE__*/_interopDefaultLegacy(getTranslator);
...
var TagsInput__default = /*#__PURE__*/_interopDefaultLegacy(TagsInput);
var Linkify__default = /*#__PURE__*/_interopDefaultLegacy(Linkify);

const FormFieldsContext = /*#__PURE__*/React__default['default'].createContext({
  translator: {
    getLanguage: () => 'en',
    gettext: f => f,
  ...
  languageCode: 'en',
  locale: 'en-US',
  formatter: new Formatter__default['default']()
});
...
const parseContext = ({
  ...
  if (webappApi) {
    ...
    return {
      ...
      formatter: new Formatter__default['default'](getLocaleConvention(userSelf)),
...
const getFFContextData = async componentLoader => {
  ...
  const [users, formatter, translator] = await Promise.all([componentLoader.load('webapp:users'), componentLoader.load('froot:formatter'), getTranslator__default['default']('form-fields', userLanguage)]);
  return {
    translator,
    formatter,
...
const AddressRead = ({
  ...
  }, parseValue()), /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Modal, {
    backdrop: false,
    closeOnEsc: true,
    visible: isVisible,
    header: modalTitle || translator.gettext('Address'),
    onClose: closeModal,
    footer: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
      color: "green",
      onClick: closeModal
...
const InputIcon = ({
  ...
  if (isNew && !disableNewLabel) {
    return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Badge, {
      color: "blue"
...
var css_248z$x = ".ff_v4361__InputSelect__wrapper__3As{\n\tdisplay:flex;\n\tposition:relative;\n}\n.ff_v4361__InputSelect__suggestion__1y6{\n\tdisplay:flex;\n\talign-items:center;\n\twhite-space:pre;\n}\n.ff_v4361__InputSelect__suggestion__1y6 span{\n\t\tdisplay:block;\n\t\toverflow:hidden;\n\t\twhite-space:nowrap;\n\t\ttext-overflow:ellipsis;\n\t}\n.ff_v4361__InputSelect__suggestionIcon__3bT{\n\tmargin-right:10px;\n}\n.ff_v4361__InputSelect__highlight__3rw{\n\tbackground-color:#fff570;\n\tcolor:#26292c;\n}\n.ff_v4361__InputSelect__noMatchFound__1Gv{\n\tpointer-events:none;\n}\n.ff_v4361__InputSelect__noMatchFound__1Gv span{\n\t\tcolor:#747678;\n\t}\n.ff_v4361__InputSelect__input__2jq{\n\twidth:100%;\n\tflex:1;\n}\n.ff_v4361__InputSelect__popover__bUo{\n\tz-index:6001;\n}\n.ff_v4361__InputSelect__popover__bUo .cui4-popover__inner{\n\t\tmax-width:none;\n\t}\n.ff_v4361__InputSelect__content__1mH{\n\tposition:absolute;\n\tright:0;\n\tdisplay:flex;\n\talign-items:center;\n\tpadding:0 10px;\n\ttext-transform:uppercase;\n\theight:32px;\n}\n.ff_v4361__InputSelect__defaultSuggestions__PUG{\n\tmax-height:416px;\n}\n.ff_v4361__InputSelect__popverRoot__jrA{\n\twidth:100%;\n}\n.ff_v4361__InputSelect__warning__2f3{\n\tdisplay:flex;\n\talign-items:center;\n\tmargin-top:4px;\n\tfont:400 13px/16px 'Source Sans Pro',sans-serif;\n}\n.ff_v4361__InputSelect__warning__2f3 .ff_v4361__InputSelect__warningLink__1l2{\n\t\tpadding-left:8px;\n\t}\n.ff_v4361__InputSelect__warning__2f3 .ff_v4361__InputSelect__warningIcon__1_v{\n\t\tmargin-right:8px;\n\t}\n";
var styles$v = {
  "wrapper": "ff_v4361__InputSelect__wrapper__3As",
  "suggestion": "ff_v4361__InputSelect__suggestion__1y6",
  "suggestionIcon": "ff_v4361__InputSelect__suggestionIcon__3bT",
  "highlight": "ff_v4361__InputSelect__highlight__3rw",
  "noMatchFound": "ff_v4361__InputSelect__noMatchFound__1Gv",
  "input": "ff_v4361__InputSelect__input__2jq",
  "popover": "ff_v4361__InputSelect__popover__bUo",
  "content": "ff_v4361__InputSelect__content__1mH",
  "defaultSuggestions": "ff_v4361__InputSelect__defaultSuggestions__PUG",
  "popverRoot": "ff_v4361__InputSelect__popverRoot__jrA",
  "warning": "ff_v4361__InputSelect__warning__2f3",
  "warningLink": "ff_v4361__InputSelect__warningLink__1l2",
  "warningIcon": "ff_v4361__InputSelect__warningIcon__1_v"
};
...
function InputSelect({
  ...
  const {
    translator
  } = parseContext(React__default['default'].useContext(FormFieldsContext));
  const [isLoading, setIsLoading] = React.useState(false);
  const [selected, setSelected] = React.useState(false);
  const [isNew, setIsNew] = React.useState(showNewLabel);
  const [inputValueState, setInputValue] = React.useState();
  const [internalStateSuggestions, setSuggestions] = React.useState(initialSuggestions || null);
  ...
  const onInputValueChangeDebounced = React.useMemo(() => awesomeDebouncePromise__default['default'](onInputValueChange, searchDelay), []);
  ...
  React.useEffect(() => {
    if (lodash.isNil(value) || isNewValue && !isNewValue(value)) {
      setIsNew(false);
    }
  ...
  const renderInput = ({
    ...
    const handleEnterOrEnterKeyPress = () => {
      setState({
        type: Downshift__default['default'].stateChangeTypes.keyDownEscape
      });
    };

    return /*#__PURE__*/React__default['default'].createElement("div", {
      className: classNames__default['default'](className, 'cui4-input__box')
    }, /*#__PURE__*/React__default['default'].createElement("div", {
      className: classNames__default['default']('cui4-input', styles$v.input, inputClassName)
    }, /*#__PURE__*/React__default['default'].createElement("div", {
      className: styles$v.wrapper
    }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, {
      forwardRef: inputRef,
      className: classNames__default['default'](inputClassName, styles$v.input),
      style: {
      ...
      ...restDownshiftInputProps,
      ...restCuiInputProps
    }), IconComponent && /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  const renderDefaultSuggestions = (getItemProps, highlightedIndex) => {
    ...
    }, (suggestionsList || []).map((item, index) => /*#__PURE__*/React__default['default'].createElement("div", { ...getItemProps({
        item,
        index
      }),
      key: `${item}${index}`
    }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Option, {
      "data-testid": "option",
      highlighted: highlightedIndex === index,
      className: classNames__default['default'](styles$v.suggestion)
    }, suggestionIcon && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
      icon: getSuggestionIcon(item),
      size: "s",
      color: "black-64",
      className: styles$v.suggestionIcon
    }), getSuggestionValue(item)))), (suggestionsList === null || suggestionsList === void 0 ? void 0 : suggestionsList.length) === 0 && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Option, {
  ...
  const renderDropMenu = ({
    ...
    return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Dropmenu, {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Downshift__default['default'], {
...
const isEmpty = wrapperValue => {
  if (lodash.isNumber(wrapperValue)) {
    return false;
  }

  if (wrapperValue !== 0 && lodash.isEmpty(wrapperValue) || lodash.isNil(wrapperValue)) {
    return true;
  }

  if (wrapperValue.label && wrapperValue.id) {
    return lodash.isEmpty(wrapperValue.id.toString());
  }

  if (wrapperValue.label !== undefined && wrapperValue.value !== undefined) {
    return lodash.isEmpty(wrapperValue.label) && lodash.isEmpty(wrapperValue.value);
  } // Empty check for the label field and compound field


  if (wrapperValue.label) {
    return lodash.isEmpty(wrapperValue.value.toString());
  } // Empty check for single the value fields


  return lodash.isEmpty(wrapperValue.toString());
};
const createBccLink = bcc => {
  return bcc ? `?bcc=${encodeURIComponent(bcc)}` : '';
};
const formatTextArea = inputValue => {
  let val = lodash.trim(inputValue);
  val = val.replace(/\n\s*\n/g, '\n\n');
  val = val.replace(/\n\s/g, '\n');
  val = val.replace(/\t/g, '');
  return val;
...
const localeMomentFormat = (locale, format) => {
  return moment__default['default']().locale(locale || 'en-GB').creationData().locale.longDateFormat(format);
};
...
const useValidation = translator => {
  ...
  return {
    getValidation: ({
      ...
      const trimmedValues = lodash.trim(String(value));
      const constraints = {
        defaultValidation: {
          presence: {
            allowEmpty: true
      ...
      return validate__default['default']({
    ...
    getNumberValidation: ({
      ...
      if (formatter) {
        ...
        validateValue = lodash.replace(validateValue, new RegExp(thousands_sep, 'g'), '');
        validateValue = lodash.replace(validateValue, decimal_point, '.');
        trimmedValues = lodash.isNaN(Number(validateValue)) ? value : // @ts-expect-error TODO: library defines as `Number` requirement but takes also `String`
    ...
    getPercentageValidation: ({
      ...
      const trimmedValues = Number(lodash.trimStart(value));
      const constraints = {
        percentage: {
          presence: {
            allowEmpty: true
    ...
    getTextAreaValidation: ({
      ...
      const trimmedValues = lodash.trimStart(formattedText);
      const constraints = {
        textarea: {
          presence: {
            allowEmpty: true
...
const AddressFooter = () => {
  return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Spacing, {
    all: "m",
...
const Address = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(InputSelect, {
    ...
    value: value,
    dropmenuProps: {
      footer: /*#__PURE__*/React__default['default'].createElement(AddressFooter, null)
    },
...
const AutocompleteRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, value.title);
};
...
async function find(type, term, limit = 100) {
  ...
  const {
    data
  } = await fetch.get(`/api/v1/${type}/search?fields=${type === 'deals' ? 'title' : 'name'}`, {
    queryParams: {
      term,
      limit: String(limit)
    }
...
async function searchResults(fieldType, fieldKey, term, limit = 100) {
  ...
  const {
    data
  } = await fetch.get('/v1/itemSearch/field', {
    queryParams: {
      term,
      limit: String(limit),
      fieldType,
...
async function updateCategory(fieldId, propOptions) {
  const res = await fetch.put(`/api/v1/productFields/${fieldId}`, {
    field_type: 'enum',
    options: propOptions
  });
  const {
...
async function getCategoryOptions(fieldId) {
  const res = await fetch.get(`/api/v1/productFields/${fieldId}`);
  const {
    options
  } = res.data;
  return options || [];
...
const Autocomplete = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(InputSelect, { ...getValue$3({
      value
    }),
...
const getMoment = (date, format) => {
  ...
  const defaultFormat = moment__default['default'](date, DATE_FORMAT$1); // SQL date format
...
const renderPopperContainer = ({
  ...
  return /*#__PURE__*/ReactDOM__default['default'].createPortal(children, typeof element === 'boolean' ? document.body : element);
};
...
const parseSelectedDate = (selectedDate, format) => {
  if (moment__default['default'].isMoment(selectedDate)) {
    return moment__default['default'](selectedDate).format(format);
  }
...
const getInitDate = value => {
  return value ? moment__default['default'](new Date(value)) : undefined;
};

const moment = momentRange.extendMoment(moment__default['default']);
...
const DateRangeRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, getDateReadValue(localeStartDate, localeEndDate));
};
...
var css_248z$v = ".ff_v4361__DatePicker-header__wrapper__1mA{\n\tdisplay:flex;\n\tjustify-content:space-between;\n}\n.ff_v4361__DatePicker-header__month__11b, .ff_v4361__DatePicker-header__year__3pb{\n\tdisplay:inline-block;\n\tcursor:pointer;\n\tposition:absolute;\n\tmargin:0;\n\tleft:0;\n\ttop:0;\n\tright:0;\n\tbottom:0;\n\topacity:0;\n}\n.ff_v4361__DatePicker-header__selects__3Lp{\n\tdisplay:flex;\n\tline-height:normal;\n\tmargin-bottom:6px;\n}\n.ff_v4361__DatePicker-header__selects__3Lp .ff_v4361__DatePicker-header__label__1Bu{\n\t\tdisplay:inline-block;\n\t\tposition:relative;\n\t\toverflow:hidden;\n\t\tmargin:8px 2px;\n\t\tfont-size:15px;\n\t\tfont-weight:600;\n\t\tbackground-color:#ffffff;\n\t\tcolor:#317ae2;\n\t\tcursor:pointer;\n\t}\n.ff_v4361__DatePicker-header__month__11b{\n\ttext-align-last:center;\n}\n.ff_v4361__DatePicker-header__prev__3jO{\n\tmargin-left:8px;\n}\n.ff_v4361__DatePicker-header__next__2TS{\n\tmargin-right:8px;\n}\n";
var styles$u = {
  "wrapper": "ff_v4361__DatePicker-header__wrapper__1mA",
  "month": "ff_v4361__DatePicker-header__month__11b",
  "year": "ff_v4361__DatePicker-header__year__3pb",
  "selects": "ff_v4361__DatePicker-header__selects__3Lp",
  "label": "ff_v4361__DatePicker-header__label__1Bu",
  "prev": "ff_v4361__DatePicker-header__prev__3jO",
  "next": "ff_v4361__DatePicker-header__next__2TS"
};
...
const DatePickerHeader = ({
  ...
  const years = lodash.range(currentYear - 10, currentYear + 11, 1);
  const months = moment__default['default'].months();

  const isPrevMonthButtonDisabled = () => {
    if (selectsEnd && minEndDate) {
      const formattedDate = date && date.format(DATE_FORMAT);
      const formattedMinDate = minEndDate && moment__default['default'](minEndDate).format(DATE_FORMAT);
      const isSame = moment__default['default'](formattedDate).isSame(formattedMinDate, 'month');
      const isBefore = moment__default['default'](formattedDate).isBefore(formattedMinDate);
  ...
  }, months[date.month()], /*#__PURE__*/React__default['default'].createElement("select", {
    className: styles$u.month,
    value: months[date.month()],
    onChange: changeMonthHandler
  }, months.map(option => /*#__PURE__*/React__default['default'].createElement("option", {
    key: option,
    value: option
  }, option)))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$u.label
  }, currentYear, /*#__PURE__*/React__default['default'].createElement("select", {
    className: styles$u.year,
    value: currentYear,
    onChange: changeYearHandler
  }, years.map(option => /*#__PURE__*/React__default['default'].createElement("option", {
    key: option,
    value: option
  }, option))))), /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
...
const DatePickerInput = /*#__PURE__*/React.forwardRef(({
  onChange,
  error,
  inputProps,
  inputValue,
  ...
  return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, { ...restProps,
    ref: ref,
...
var css_248z$u = ".ff_v4361__DatePicker__popper__3KT[data-placement^='bottom']{\n\t\tmargin-top:0;\n\t}\n\t.ff_v4361__DatePicker__popper__3KT[data-placement]{\n\t\tz-index:6001;\n\t}\n\t.ff_v4361__DatePicker__wrapper__2Tw .react-datepicker-wrapper, .ff_v4361__DatePicker__wrapper__2Tw .react-datepicker__input-container{\n\t\t\twidth:100%;\n\t\t}\n\t.ff_v4361__DatePicker__wrapper__2Tw .react-datepicker__close-icon::after{\n\t\t\t\tcolor:#747678;\n\t\t\t\tbackground-color:transparent;\n\t\t\t\tfont-size:23px;\n\t\t\t\theight:auto;\n\t\t\t\twidth:auto;\n\t\t\t\ttop:3px;\n\t\t\t\tright:2px;\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker\\--time-only{\n\t\t\tborder:0 !important;\n\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__header{\n\t\t\theight:69px;\n\t\t\tbackground-color:#ffffff;\n\t\t\tborder:0;\n\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__header\\--time{\n\t\t\t\tdisplay:none;\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__header\\--time-box{\n\t\t\t\t\twidth:100px;\n\t\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day{\n\t\t\tmargin:2px;\n\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day:hover{\n\t\t\t\tcolor:rgb(49,122,226);\n\t\t\t\tbackground-color:rgba(49,122,226,.32);\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day-names{\n\t\t\t\tborder-bottom:1px solid #e5e5e5;\n\t\t\t\tborder-top:1px solid #e5e5e5;\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day-name{\n\t\t\t\tcolor:rgba(38,41,44,.64);\n\t\t\t\tfont-size:11px;\n\t\t\t\tline-height:16px;\n\t\t\t\tfont-weight:400;\n\t\t\t\ttext-align:center;\n\t\t\t\tvertical-align:middle;\n\t\t\t\tpadding:4px 0;\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--today:not(.ff_v4361__DatePicker__react-datepicker--time-only--in-selecting-range__1Z0){\n\t\t\t\t\tcolor:rgba(38,41,44,.64);\n\t\t\t\t\tbackground-color:#f7f7f7;\n\t\t\t\t\tfont-weight:600;\n\t\t\t\t\tborder-radius:3px;\n\t\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--outside-month{\n\t\t\t\tcolor:rgba(38,41,44,.32);\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--selected, .ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--keyboard-selected, .ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--range-start, .ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--range-end{\n\t\t\t\tcolor:#ffffff !important;\n\t\t\t\tbackground-color:#317ae2 !important;\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--in-selecting-range:not(.ff_v4361__DatePicker__react-datepicker__day--in-range__1TC){\n\t\t\t\t\tcolor:rgb(49,122,226);\n\t\t\t\t\tbackground-color:rgba(49,122,226,.32);\n\t\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--in-selecting-range:not(.ff_v4361__DatePicker__react-datepicker__day--selecting-range-start__Cya):not(.ff_v4361__DatePicker__react-datepicker__day--today__1nV):not(.ff_v4361__DatePicker__react-datepicker__day--in-range__1TC){\n\t\t\t\t\tcolor:#26292c;\n\t\t\t\t\tbackground-color:transparent;\n\t\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--selecting-range-start, .ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--in-range:not(.ff_v4361__DatePicker__react-datepicker__day--range-start__1JD):not(.ff_v4361__DatePicker__react-datepicker__day--range-end__2Ip){\n\t\t\t\t\tcolor:rgb(49,122,226);\n\t\t\t\t\tbackground-color:rgba(49,122,226,.32);\n\t\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--disabled{\n\t\t\t\tpointer-events:none;\n\t\t\t\tbackground-color:transparent;\n\t\t\t}\n\t.ff_v4361__DatePicker__datepicker__3hq .react-datepicker__day\\--disabled:hover{\n\t\t\t\t\tbackground-color:transparent;\n\t\t\t\t}\n";
var styles$t = {
  "popper": "ff_v4361__DatePicker__popper__3KT",
  "wrapper": "ff_v4361__DatePicker__wrapper__2Tw",
  "datepicker": "ff_v4361__DatePicker__datepicker__3hq",
  "react-datepicker--time-only--in-selecting-range": "ff_v4361__DatePicker__react-datepicker--time-only--in-selecting-range__1Z0",
  "react-datepicker__day--in-range": "ff_v4361__DatePicker__react-datepicker__day--in-range__1TC",
  "react-datepicker__day--selecting-range-start": "ff_v4361__DatePicker__react-datepicker__day--selecting-range-start__Cya",
  "react-datepicker__day--today": "ff_v4361__DatePicker__react-datepicker__day--today__1nV",
  "react-datepicker__day--range-start": "ff_v4361__DatePicker__react-datepicker__day--range-start__1JD",
  "react-datepicker__day--range-end": "ff_v4361__DatePicker__react-datepicker__day--range-end__2Ip"
};
...
const validator = ({
  ...
  validate__default['default'].extend(validate__default['default'].validators.datetime, {
    parse: currentValue => +moment__default['default'].utc(currentValue, dateFormat),
    format: () => moment__default['default'].utc(value).format(dateFormat)
  });
  return validate__default['default']({
    datePicker: lodash.trimStart(value)
  }, dateConstraints);
};

const DatePicker = /*#__PURE__*/React__default['default'].forwardRef(({
  value,
  className = '',
  calendarClassName = '',
  popperClassName = '',
  ...
  if (selected && !(selected !== null && selected !== void 0 && selected.isSame(selectedDateState))) {
    ...
    setInputValueState(moment__default['default'](selected).format(format));
  }
  ...
  const renderCustomHeader = renderProps => {
    return /*#__PURE__*/React__default['default'].createElement(DatePickerHeader, { ...renderProps,
  ...
  const dateFormat = lodash.flatMap([withoutLeadingZeroFormat, format], getAllSeparators);
  const dateRangeProps = getDateRangeProps(minEndDate);
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default'](className, styles$t.wrapper)
  }, /*#__PURE__*/React__default['default'].createElement(Calendar__default['default'], {
    popperClassName: classNames__default['default'](popperClassName, styles$t.popper, styles$t.datepicker),
    ref: ref,
    ...
    customInput: /*#__PURE__*/React__default['default'].createElement(DatePickerInput, {
...
const DatePickerRead = props => {
  ...
  const format = localeMomentFormat(locale, 'LL');
  const dateValue = moment__default['default'](value).format(format);
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, dateValue);
};

var css_248z$t = ".ff_v4361__Error__error__YlD{\n\tcolor:#f94839;\n\tmargin-top:4px;\n\tfont-size:13px;\n}\n.ff_v4361__Error__select__1Mm .cui4-select__box{\n\t\tborder:1px solid #f94839;\n\t}\n";
var errorStyles = {
  "error": "ff_v4361__Error__error__YlD",
  "select": "ff_v4361__Error__select__1Mm"
};
...
var css_248z$s = ".ff_v4361__DateRange__wrapper__2_m{\n\tdisplay:flex;\n\tjustify-content:flex-start;\n\talign-items:flex-end;\n}\n\n\t.ff_v4361__DateRange__wrapper__2_m .ff_v4361__DateRange__separator__1eA{\n\t\tdisplay:flex;\n\t\talign-items:center;\n\t\theight:32px;\n\t\tpadding:0 8px;\n\t}\n";
var styles$s = {
  "wrapper": "ff_v4361__DateRange__wrapper__2_m",
  "separator": "ff_v4361__DateRange__separator__1eA"
};
...
const DateRange = ({
  ...
  const datePickerRefObj = React.useRef(null);
  const {
    locale
  } = parseContext(React.useContext(FormFieldsContext));
  ...
  const [startDateState, setStartDate] = React.useState();
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    ...lodash.omit(rest, ['onComponentChange'])
  }), /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    ...lodash.omit(rest, ['onComponentChange'])
  })), /*#__PURE__*/React__default['default'].createElement(Error$1, {
    message: error
  }));
};

var css_248z$r = ".ff_v4361__Link__link__26_{\n\ttext-decoration:none;\n\tcolor:#317ae2;\n\tpadding-right:4px;\n}\n\n\t.ff_v4361__Link__link__26_:hover{\n\t\ttext-decoration:underline;\n\t}\n";
var styles$r = {
  "link": "ff_v4361__Link__link__26_"
};
...
const Link = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("a", { ...(openLinksInNewTab ? {
      target: '_blank'
    } : {}),
    href: onClick ? '#' : href,
...
var css_248z$q = ".ff_v4361__DealOrLead__popoverContent__1lH{\n\tmax-height:240px;\n}\n";
var styles$q = {
  "popoverContent": "ff_v4361__DealOrLead__popoverContent__1lH"
};
...
const useValueWithCurrency = () => {
  ...
  return (value, currency) => {
    ...
    const selected = lodash.find(currencies, {
      code: currency
    });
...
var css_248z$p = ".ff_v4361__ResultItem__dealStatus__1ue{\n\ttext-transform:capitalize;\n}\n.ff_v4361__ResultItem__resultDetails__POn{\n\tmargin-top:4px;\n\tfont-size:13px;\n\tmax-width:100%;\n\twhite-space:nowrap;\n\toverflow:hidden;\n\ttext-overflow:ellipsis;\n}\n.ff_v4361__ResultItem__resultDetails__POn span:not(:last-child)::after{\n\t\tcontent:' \\B7  ';\n\t\tcolor:#26292c;\n\t}\n.ff_v4361__ResultItem__option__RTx{\n\tpadding:8px 4px;\n\tdisplay:flex;\n\talign-items:center;\n}\n.ff_v4361__ResultItem__option__RTx:hover .ff_v4361__ResultItem__dealStatus__1ue, .ff_v4361__ResultItem__option__RTx.ff_v4361__ResultItem__optionHighlighted__3dF .ff_v4361__ResultItem__dealStatus__1ue, .ff_v4361__ResultItem__option__RTx:hover .ff_v4361__ResultItem__resultDetails__POn span::after, .ff_v4361__ResultItem__option__RTx.ff_v4361__ResultItem__optionHighlighted__3dF .ff_v4361__ResultItem__resultDetails__POn span::after{\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4361__ResultItem__resultIcon__1cj{\n\tmargin:8px;\n}\n.ff_v4361__ResultItem__dealStatusWon__Q7b{\n\tcolor:#08a742;\n}\n.ff_v4361__ResultItem__dealStatusLost__gWg{\n\tcolor:#f94839;\n}\n.ff_v4361__ResultItem__resultWrapper__-jM{\n\tmax-width:100%;\n}\n.ff_v4361__ResultItem__resultBody__QYE{\n\tmax-width:calc(100% - 65px);\n}\n.ff_v4361__ResultItem__resultTitle__xI3{\n\tdisplay:block;\n\tmax-width:100%;\n\twhite-space:nowrap;\n\toverflow:hidden;\n\ttext-overflow:ellipsis;\n}\n";
var styles$p = {
  "dealStatus": "ff_v4361__ResultItem__dealStatus__1ue",
  "resultDetails": "ff_v4361__ResultItem__resultDetails__POn",
  "option": "ff_v4361__ResultItem__option__RTx",
  "optionHighlighted": "ff_v4361__ResultItem__optionHighlighted__3dF",
  "resultIcon": "ff_v4361__ResultItem__resultIcon__1cj",
  "dealStatusWon": "ff_v4361__ResultItem__dealStatusWon__Q7b",
  "dealStatusLost": "ff_v4361__ResultItem__dealStatusLost__gWg",
  "resultWrapper": "ff_v4361__ResultItem__resultWrapper__-jM",
  "resultBody": "ff_v4361__ResultItem__resultBody__QYE",
  "resultTitle": "ff_v4361__ResultItem__resultTitle__xI3"
};
...
const ResultItem = ({
  ...
  const renderDealStatus = status => {
    return /*#__PURE__*/React__default['default'].createElement("span", {
      className: classNames__default['default']({
        [styles$p.dealStatus]: true,
        [styles$p.dealStatusLost]: status === 'lost',
        [styles$p.dealStatusWon]: status === 'won'
      }),
  ...
  const renderValueWithCurrency = () => {
    return /*#__PURE__*/React__default['default'].createElement("span", null, getValueWithCurrency(value, currency));
  };

  return /*#__PURE__*/React__default['default'].createElement("div", {
    key: id,
    ...additionalRootElementProps,
    className: styles$p.resultWrapper
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Option, {
    "data-testid": "option",
    className: classNames__default['default']({
      [styles$p.option]: true,
      [styles$p.optionHighlighted]: highlightedIndex === index
    }),
    onMouseEnter: onMouseEnter,
    highlighted: highlightedIndex === index
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
    className: styles$p.resultIcon,
    icon: type,
    size: "s",
    color: "black-64",
    "data-testid": "option-icon"
  }), /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$p.resultBody
  }, /*#__PURE__*/React__default['default'].createElement("span", {
    className: styles$p.resultTitle
  }, item.title), /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$p.resultDetails
  }, item.type === TypeName.DEAL && item.status && renderDealStatus(item.status), value && currency && renderValueWithCurrency(), personName && /*#__PURE__*/React__default['default'].createElement("span", null, personName), orgName && /*#__PURE__*/React__default['default'].createElement("span", null, orgName)))));
};
...
const DealOrLead = ({
  ...
  const renderSuggestions = searchResults => (getItemProps, highlightedIndex, setHighlightedIndex) => {
    return /*#__PURE__*/React__default['default'].createElement("div", {
      className: styles$q.popoverContent
    }, searchResults.map((item, index) => {
      return /*#__PURE__*/React__default['default'].createElement(ResultItem, {
        index: index,
        item: item,
        key: item.id,
...
var css_248z$o = ".ff_v4361__Phone__phoneIcon__iJn{\n\tpadding:0 6px 0 4px;\n\theight:16px;\n\twidth:16px;\n}\n.ff_v4361__Phone__arrow__2ut{\n\tdisplay:flex;\n}\n.ff_v4361__Phone__phoneButton__1tJ{\n\ttext-align:left;\n\twhite-space:nowrap;\n\twidth:100%;\n}\n.ff_v4361__Phone__phoneButton__1tJ:not(:first-child){\n\t\tmargin-top:4px;\n\t}\n.ff_v4361__Phone__phoneLabel__1JE{\n\tcolor:#b9babb !important;\n\tmargin:0 6px;\n}\n.ff_v4361__Phone__phoneValue__1AS{\n\tdisplay:flex;\n\twidth:100%;\n\tfont-size:13px;\n\toverflow:hidden;\n}\n.ff_v4361__Phone__phoneValue__1AS a{\n\t\tcolor:#26292c;\n\t\ttext-decoration:none;\n\t\ttext-overflow:ellipsis;\n\t\toverflow:hidden;\n\t}\n";
var styles$o = {
  "phoneIcon": "ff_v4361__Phone__phoneIcon__iJn",
  "arrow": "ff_v4361__Phone__arrow__2ut",
  "phoneButton": "ff_v4361__Phone__phoneButton__1tJ",
  "phoneLabel": "ff_v4361__Phone__phoneLabel__1JE",
  "phoneValue": "ff_v4361__Phone__phoneValue__1AS"
};
...
const Caller = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
  ...
  }, formatPhoneNumber(value.value, locale, format)), value.label && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$o.phoneLabel
  }, "(", value.label, ")")), /*#__PURE__*/React__default['default'].createElement("div", {
...
const getInitialValue = (value = [], options, primary) => {
  if (lodash.isArray(value) && value.length && options[0]) {
...
const getTranslatedLabel = (options, label) => {
  ...
  return lodash.capitalize(translatedLabel);
};

var css_248z$n = ".ff_v4361__DefaultPhone__readValue__kUt{\n\tdisplay:flex;\n}\n.ff_v4361__DefaultPhone__readLabel__Unf{\n\tcolor:#747678;\n\tword-break:normal;\n}\n";
var styles$n = {
  "readValue": "ff_v4361__DefaultPhone__readValue__kUt",
  "readLabel": "ff_v4361__DefaultPhone__readLabel__Unf"
};
...
const DefaultPhoneRead$1 = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, arrayValue.map(({
    value: labelValue,
    label
  }, i) => {
    if (caller) {
      return /*#__PURE__*/React__default['default'].createElement(Caller, {
        value: {
          value: labelValue,
          label
        },
    ...
    }, formatPhoneNumber(labelValue, locale, formatNumber)), /*#__PURE__*/React__default['default'].createElement("div", {
      className: styles$n.readLabel
    }, `(${getTranslatedLabel(options, label)})`));
  }));
};

var css_248z$m = ".ff_v4361__InputSelectCompound__inputWrap__1_R{\n\tposition:relative;\n\tflex:1;\n}\n\n.ff_v4361__InputSelectCompound__input__1kd{\n\twidth:100% !important;\n}\n\n.ff_v4361__InputSelectCompound__select__1hE{\n\tflex:1;\n\tmargin-left:8px;\n\theight:32px;\n\tmax-width:50%;\n}\n\n.ff_v4361__InputSelectCompound__select__1hE .cui4-input{\n\t\twidth:100%;\n\t}\n\n.ff_v4361__InputSelectCompound__compoundComponent__3mN{\n\tdisplay:flex;\n\tflex-direction:row;\n}\n";
var styles$m = {
  "inputWrap": "ff_v4361__InputSelectCompound__inputWrap__1_R",
  "input": "ff_v4361__InputSelectCompound__input__1kd",
  "select": "ff_v4361__InputSelectCompound__select__1hE",
  "compoundComponent": "ff_v4361__InputSelectCompound__compoundComponent__3mN"
};
...
const InputSelectCompound = ({
  ...
  const selectRef = /*#__PURE__*/React__default['default'].createRef();
  const [label, setLabel] = React.useState(selectedLabel);
  const [stateValue, setValue] = React.useState(inputValue);
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default'](className, styles$m.compoundComponent)
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$m.inputWrap
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, {
    className: classNames__default['default'](inputClassName, styles$m.input),
    autoFocus: autofocus,
    ...
    placeholder: placeholder,
    ...restCuiInputProps
  }), primary && actionIcon), /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select, {
    className: classNames__default['default'](selectClassName, styles$m.select),
    filter: filter,
...
var css_248z$l = ".ff_v4361__InputSelectAddMore__wrapper__1sY{\n\tdisplay:flex;\n\tflex-direction:column;\n}\n.ff_v4361__InputSelectAddMore__itemWrap__w4T{\n\tdisplay:flex;\n}\n.ff_v4361__InputSelectAddMore__item__3jk{\n\tpadding-bottom:5px;\n\twidth:100%;\n}\n.ff_v4361__InputSelectAddMore__link__fxh{\n\tcursor:pointer;\n}\n.ff_v4361__InputSelectAddMore__disabled__3f1 a{\n\t\tcolor:#747678;\n\t\tcursor:not-allowed;\n\t}\n.ff_v4361__InputSelectAddMore__remove__340{\n\tmargin-left:5px;\n}\n";
var styles$l = {
  "wrapper": "ff_v4361__InputSelectAddMore__wrapper__1sY",
  "itemWrap": "ff_v4361__InputSelectAddMore__itemWrap__w4T",
  "item": "ff_v4361__InputSelectAddMore__item__3jk",
  "link": "ff_v4361__InputSelectAddMore__link__fxh",
  "disabled": "ff_v4361__InputSelectAddMore__disabled__3f1",
  "remove": "ff_v4361__InputSelectAddMore__remove__340"
};
...
const InputSelectItem = ({
  ...
  }, /*#__PURE__*/React__default['default'].createElement(InputSelectCompound, {
...
const InputSelectAddMore = ({
  ...
  const [items, setItems] = React.useState(() => getInitialValue(value, options, true));
  React.useEffect(() => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, /*#__PURE__*/React__default['default'].createElement("section", null, items.map(({
    value: labelValue,
    label,
    primary
  }, i) => {
    return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(InputSelectItem, {
      selectedLabel: label,
      options: options,
      value: labelValue,
      validate: validate,
      ...
      ...rest
    }), items.length > 1 && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
      color: "ghost",
  ...
  })), !single && !disableAdd && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Text, {
    className: classNames__default['default']({
    ...
    onClick: disabled ? lodash.noop : addMore
  }, "+ ", addMoreText)));
};
...
const DefaultPhone = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(InputSelectAddMore, {
    single: single,
    onComponentChange: onComponentChange,
    validate: getValidation,
    options: options,
...
var css_248z$k = ".ff_v4361__Email__readValue__3v6{\n\tdisplay:flex;\n}\n.ff_v4361__Email__readLabel__12q{\n\tcolor:#747678;\n\tword-break:normal;\n}\n";
var styles$k = {
  "readValue": "ff_v4361__Email__readValue__3v6",
  "readLabel": "ff_v4361__Email__readLabel__12q"
};
...
const getTrimmedValue = items => {
  return [items].flat().map(({
    ...
    value: lodash.isString(value) ? value.trim() : value
  }));
};
...
const EmailRead = ({
  ...
  const arrayValue = lodash.isArray(value) ? value : [value];
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, arrayValue.map(({
    value: labelValue,
    label
  }, i) => {
    return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      value: labelValue
    }, labelValue), /*#__PURE__*/React__default['default'].createElement("div", {
...
var css_248z$j = ".ff_v4361__InstantMessage__readValue__3an{\n\tdisplay:flex;\n}\n\n.ff_v4361__InstantMessage__readIM__1WR{\n\tpadding-right:4px;\n\tvertical-align:top;\n}\n";
var styles$j = {
  "readValue": "ff_v4361__InstantMessage__readValue__3an",
  "readIM": "ff_v4361__InstantMessage__readIM__1WR"
};
...
const InstantMessageRead = ({
  ...
  const arrayValues = lodash.isArray(value) ? value : [value];
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, arrayValues.map(({
    value: labelValue,
    label
  }, i) => {
    ...
    }, labelValue), /*#__PURE__*/React__default['default'].createElement("div", null, `(${lodash.capitalize(selectedLabel)})`));
  }));
};
...
var css_248z$i = ".ff_v4361__Label__label__3Dv{\n\twidth:100%;\n}\n";
var styles$i = {
  "label": "ff_v4361__Label__label__3Dv"
};
...
const Label = ({
  ...
  const [selected, setSelected] = React.useState(getValue$1(value));
  const {
    translator,
    fields
  } = parseContext(React.useContext(FormFieldsContext));
  const [optionsState, setOptionsState] = React.useState(() => initOptions(fields, options, fieldType, fieldKey));
  React.useEffect(() => {
    setSelected(getValue$1(value));
  }, [value]);
  React.useEffect(() => setOptionsState(getOptions$1(optionsState, translator)), []);
  ...
  const className = `${styles$i.label} ${error ? errorStyles.select : ''}`;
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select, {
    popperProps: popperProps,
    value: selected,
    disabled: disabled,
    placeholder: placeholder,
    ...
    return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select.Option, {
      key: id,
      value: id
    }, id ? /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Badge, {
      color: color
    }, label) : label);
  })), /*#__PURE__*/React__default['default'].createElement(Error$1, {
    message: error
...
const MonetaryRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, formattedValue);
};
...
const getValue = (value, defaultValue) => {
  if (!lodash.isUndefined(value) && !lodash.isUndefined(value === null || value === void 0 ? void 0 : value.value)) {
    return String(value.value);
  }

  if (!lodash.isUndefined(defaultValue) && !lodash.isUndefined(defaultValue === null || defaultValue === void 0 ? void 0 : defaultValue.value)) {
...
const MonetaryComponent = ({
  ...
  delete rest.options;
  const isDefault = !!lodash.isUndefined(defaultValue) && lodash.isUndefined(value);
  const {
    translator,
    defaultCurrency,
    currencies = [],
  ...
  const [labelState, setLabel] = React.useState(getLabel(options, defaultCurrency, (value === null || value === void 0 ? void 0 : value.label) || (defaultValue === null || defaultValue === void 0 ? void 0 : defaultValue.label)));
  ...
  return /*#__PURE__*/React__default['default'].createElement(InputSelectCompound, {
...
const MultipleContactsRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("span", null, value.map((person, i) => {
    const separator = i === value.length - 1 ? '' : ', ';
    const content = person.is_hidden ? `(${translator.gettext('hidden')})` : /*#__PURE__*/React__default['default'].createElement(Link, {
      openLinksInNewTab: openLinksInNewTab,
  ...
  React__default['default'].useEffect(() => {
    const fetchQuickInfoCard = async () => {
      if (webappApi && webappApi.componentLoader) {
        ...
        setQuickInfoCard(() => props => /*#__PURE__*/React__default['default'].createElement(QuickInfoCardComponent, {
          webappApi: webappApi,
          ...props
        }));
      }
...
var css_248z$h = ".ff_v4361__EntitySuggestions__duplicatesOptionslist__1tb{\n\tmax-height:364px;\n\toverflow:auto;\n}\n.ff_v4361__EntitySuggestions__option__2gG .cui4-option-check{\n\tright:12px;\n}\n.ff_v4361__EntitySuggestions__optionIcon__22k{\n\tposition:absolute;\n\tright:12px;\n\tdisplay:none;\n\ttop:calc(50% - 16px);\n}\n.ff_v4361__EntitySuggestions__optionIcon__22k .cui4-icon{\n\t\tdisplay:block;\n\t\tfill:#ffffff;\n\t}\n.ff_v4361__EntitySuggestions__optionIcon__22k .cui4-icon:hover{\n\t\t\tfill:#ffffff;\n\t\t}\n.ff_v4361__EntitySuggestions__optionIcon__22k:hover .cui4-icon{\n\t\t\tfill:#ffffff !important;\n\t\t}\n.ff_v4361__EntitySuggestions__option__2gG{\n\tpadding:8px 40px 8px 16px;\n\tbox-sizing:border-box;\n\tcursor:pointer;\n\tposition:relative;\n\tcolor:#26292c;\n}\n.ff_v4361__EntitySuggestions__option__2gG .ff_v4361__EntitySuggestions__name__2S5{\n\t\twhite-space:nowrap;\n\t\toverflow:hidden;\n\t\ttext-overflow:ellipsis;\n\t}\n.ff_v4361__EntitySuggestions__option__2gG .ff_v4361__EntitySuggestions__details__24V{\n\t\tcolor:#747678;\n\t\tfont-size:13px;\n\t}\n.ff_v4361__EntitySuggestions__option__2gG:hover, .ff_v4361__EntitySuggestions__option__2gG.ff_v4361__EntitySuggestions__optionHighlighted__3Ew{\n\t\tbackground:#317ae2;\n\t\tcolor:#ffffff;\n\t}\n.ff_v4361__EntitySuggestions__option__2gG:hover .ff_v4361__EntitySuggestions__optionIcon__22k, .ff_v4361__EntitySuggestions__option__2gG.ff_v4361__EntitySuggestions__optionHighlighted__3Ew .ff_v4361__EntitySuggestions__optionIcon__22k{\n\t\t\tdisplay:block;\n\t\t\tcursor:pointer;\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4361__EntitySuggestions__option__2gG:hover .ff_v4361__EntitySuggestions__details__24V, .ff_v4361__EntitySuggestions__option__2gG.ff_v4361__EntitySuggestions__optionHighlighted__3Ew .ff_v4361__EntitySuggestions__details__24V{\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4361__EntitySuggestions__option__2gG:hover .cui4-option-check, .ff_v4361__EntitySuggestions__option__2gG.ff_v4361__EntitySuggestions__optionHighlighted__3Ew .cui4-option-check{\n\t\t\tdisplay:none;\n\t\t}\n.ff_v4361__EntitySuggestions__addNew__2Gf{\n\tpadding:8px 16px;\n\tdisplay:flex;\n\talign-items:center;\n\tmargin-top:4px;\n\tcursor:pointer;\n}\n.ff_v4361__EntitySuggestions__addNew__2Gf span{\n\t\tmargin-left:8px;\n\t\tfont-weight:600;\n\t\tcolor:#317ae2;\n\t}\n.ff_v4361__EntitySuggestions__addNew__2Gf svg{\n\t\tfill:#317ae2;\n\t}\n.ff_v4361__EntitySuggestions__tooltip__2Tg{\n\tz-index:6001;\n}\n.ff_v4361__EntitySuggestions__tooltipContent__6X7{\n\tmax-width:200px;\n}\n";
var styles$h = {
  "duplicatesOptionslist": "ff_v4361__EntitySuggestions__duplicatesOptionslist__1tb",
  "option": "ff_v4361__EntitySuggestions__option__2gG",
  "optionIcon": "ff_v4361__EntitySuggestions__optionIcon__22k",
  "name": "ff_v4361__EntitySuggestions__name__2S5",
  "details": "ff_v4361__EntitySuggestions__details__24V",
  "optionHighlighted": "ff_v4361__EntitySuggestions__optionHighlighted__3Ew",
  "addNew": "ff_v4361__EntitySuggestions__addNew__2Gf",
  "tooltip": "ff_v4361__EntitySuggestions__tooltip__2Tg",
  "tooltipContent": "ff_v4361__EntitySuggestions__tooltipContent__6X7"
};
...
const DetailsIcon = ({
  ...
  const renderButton = () => /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
    color: "ghost-alternative",
    href: `/${type}/${contact.id}`,
    target: "_blank",
  ...
  if (QuickInfoCard) {
    return /*#__PURE__*/React__default['default'].createElement(QuickInfoCard, {
      type: type,
      id: contact.id,
      popoverProps: {
...
const EntitySuggestions = ({
  ...
  const renderAddNewOption = () => {
    ...
    const item = lodash.isString(suggestionValueKey) ? {
    ...
    const onClick = () => onClickAddNew ? onClickAddNew(inputValue) : lodash.noop;

    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, filteredContacts.length > 0 && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Separator, null), /*#__PURE__*/React__default['default'].createElement("div", { ...elementProps
    }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Option, {
      ...
      size: "s",
      icon: "plus"
    }), /*#__PURE__*/React__default['default'].createElement("span", null, texts.addNew))));
  };

  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$h.duplicatesOptionslist
  }, filteredContacts.map((contact, index) => {
    const onClick = () => onClickOption ? onClickOption(contact) : lodash.noop;
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      "data-testid": "option",
      className: classNames__default['default']({
        [styles$h.option]: true,
        [styles$h.optionHighlighted]: highlightedIndex === index
      }),
      onMouseEnter: onMouseEnter
    }, /*#__PURE__*/React__default['default'].createElement("div", {
      className: styles$h.name
    }, contact.formattedName || contact.name), contact.details && /*#__PURE__*/React__default['default'].createElement("div", {
      className: styles$h.details
    }, contact.details), /*#__PURE__*/React__default['default'].createElement("div", {
      className: styles$h.optionIcon
    }, /*#__PURE__*/React__default['default'].createElement(DetailsIcon, {
...
var css_248z$g = ".ff_v4361__InputMultiSelect__wrapper__2ay{\n\tdisplay:flex;\n\tposition:relative;\n\tborder:1px solid #cbcccd;\n\tborder-radius:2px;\n\tbackground:#ffffff;\n\tbox-shadow:inset 0 1px 2px #eeeeee;\n\tflex-wrap:wrap;\n\talign-items:center;\n\twidth:unset;\n}\n\n\t.ff_v4361__InputMultiSelect__wrapper__2ay > .ff_v4361__InputMultiSelect__selectedTag__9LT{\n\t\tmargin:4px 0 4px 8px;\n\t}\n\n\t.ff_v4361__InputMultiSelect__wrapper__2ay > .ff_v4361__InputMultiSelect__selectedTag__9LT .cui4-tag__content{\n\t\t\tcolor:#26292c;\n\t\t\tdisplay:flex;\n\t\t\talign-items:center;\n\t\t}\n\n\t.ff_v4361__InputMultiSelect__wrapper__2ay > .ff_v4361__InputMultiSelect__selectedTag__9LT ~ .ff_v4361__InputMultiSelect__selectedTag__9LT{\n\t\tmargin-left:4px;\n\t}\n\n\t.ff_v4361__InputMultiSelect__wrapper__2ay:focus-within{\n\t\tborder-color:#317ae2;\n\t}\n\n\t.ff_v4361__InputMultiSelect__wrapper__2ay.ff_v4361__InputMultiSelect__errorWrapper__15O{\n\t\tborder:1px solid #f94839;\n\t}\n\n\t.ff_v4361__InputMultiSelect__disabledInputWrapper__TGK{\n\tbackground-color:#f7f7f7;\n}\n\n\t.ff_v4361__InputMultiSelect__inputIcon__3-i{\n\tmargin-left:8px;\n}\n\n\t.ff_v4361__InputMultiSelect__input__ZAT{\n\tmin-width:150px;\n\tflex:1;\n}\n\n\t.ff_v4361__InputMultiSelect__input__ZAT input[type='text']{\n\t\tborder:none;\n\t\tbox-shadow:none;\n\t\tmin-width:150px;\n\t\tflex:1;\n\t\tbackground:transparent;\n\t}\n\n\t.ff_v4361__InputMultiSelect__input__ZAT input[type='text']:focus{\n\t\t\toutline:none;\n\t\t\tborder:none;\n\t\t\tbox-shadow:none;\n\t\t}\n\n\t.ff_v4361__InputMultiSelect__tagWarning__3Zy{\n\tmargin:0 2px 0 4px;\n}\n\n\t.ff_v4361__InputMultiSelect__newBadge__3ZK, .ff_v4361__InputMultiSelect__loadingSpinner__2KZ{\n\tposition:absolute;\n\tright:6px;\n\ttop:calc(50% - 8px);\n}\n\n\t.ff_v4361__InputMultiSelect__popover__jfH{\n\tz-index:6001;\n}\n";
var styles$g = {
  "wrapper": "ff_v4361__InputMultiSelect__wrapper__2ay",
  "selectedTag": "ff_v4361__InputMultiSelect__selectedTag__9LT",
  "errorWrapper": "ff_v4361__InputMultiSelect__errorWrapper__15O",
  "disabledInputWrapper": "ff_v4361__InputMultiSelect__disabledInputWrapper__TGK",
  "inputIcon": "ff_v4361__InputMultiSelect__inputIcon__3-i",
  "input": "ff_v4361__InputMultiSelect__input__ZAT",
  "tagWarning": "ff_v4361__InputMultiSelect__tagWarning__3Zy",
  "newBadge": "ff_v4361__InputMultiSelect__newBadge__3ZK",
  "loadingSpinner": "ff_v4361__InputMultiSelect__loadingSpinner__2KZ",
  "popover": "ff_v4361__InputMultiSelect__popover__jfH"
};
...
function InputMultiSelect({
  ...
  const onInputValueChange = async (inputValue, {
    ...
    try {
      const results = await getSuggestions(inputValue);
      const uniqueResults = lodash.differenceWith(results, selectedItems, lodash.isEqual);
      setIsLoading(false);
  ...
  const onSelect = (selectedItem, {
    ...
    const itemAlreadySelected = lodash.find(selectedItems, item => lodash.isEqual(item, selectedItem));
  ...
  const renderSelectedItems = () => {
    return selectedItems.map((item, index) => {
      ...
      return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Tag, {
        dismissable: !disabled,
        key: `${item}${index}`,
        onDismiss: () => removeItem(index),
        className: styles$g.selectedTag,
        ...tagProps
      }, getSuggestionValue(item), warning && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Tooltip, {
        placement: "top",
        content: /*#__PURE__*/React__default['default'].createElement("span", null, warning)
      }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
        size: "s",
        icon: "warning-outline",
        color: "yellow",
        className: styles$g.tagWarning
      })), item.is_new && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Badge, {
        color: "blue"
      }, translator.gettext('new')));
    });
  };
  ...
  const renderDefaultSuggestions = (getItemProps, highlightedIndex) => {
    return (suggestions || []).map((item, index) => /*#__PURE__*/React__default['default'].createElement("div", { ...getItemProps({
        item,
        index
      }),
      key: `${item}${index}`
      ...
      highlighted: highlightedIndex === index,
      className: classNames__default['default'](styles$g.suggestion)
    }, suggestionIcon && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
      icon: getSuggestionIcon(item),
      size: "s",
      color: "black-64",
  ...
  const renderInput = state => {
    ...
    const isDisabled = lodash.isNumber(maxSelectedItems) && selectedItems.length >= maxSelectedItems || disabled;
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      className: classNames__default['default']('cui4-input', styles$g.input, inputClassName)
    }, /*#__PURE__*/React__default['default'].createElement("div", {
      className: classNames__default['default'](styles$g.wrapper, isDisabled && styles$g.disabledInputWrapper, error && styles$g.errorWrapper),
      ref: inputRef
    }, !!icon && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
      icon: icon,
      size: "s",
      className: styles$g.inputIcon
    }), renderSelectedItems(), /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, {
      className: classNames__default['default'](inputClassName, styles$g.input),
      style: {
    ...
    })), /*#__PURE__*/React__default['default'].createElement(ClearIcon, {
      isLoading: isLoading,
      allowClear: allowClear,
    ...
    }), isLoading && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Spinner, {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Downshift__default['default'], {
    onInputValueChange: React.useCallback(lodash.debounce(onInputValueChange, searchDelay), []),
    stateReducer: stateReducer,
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", null, renderDropMenu(state, renderInput(state)));
  });
}

var css_248z$f = ".ff_v4361__MultipleContacts__squeezedInput__3ot input{\n\tmax-height:30px;\n}\n";
var styles$f = {
  "squeezedInput": "ff_v4361__MultipleContacts__squeezedInput__3ot"
};
...
const MultipleContacts = ({
  ...
  const renderContactSuggestions = persons => (getItemProps, highlightedIndex, setHighlightedIndex, inputValue) => {
    return /*#__PURE__*/React__default['default'].createElement(EntitySuggestions, {
  ...
  return /*#__PURE__*/React__default['default'].createElement(InputMultiSelect, {
    getSuggestionValue: getSuggestionValue,
    suggestionValueKey: "name",
...
var css_248z$e = ".ff_v4361__MultipleOptions__container__M1Q{\n\twidth:100%;\n}\n\n.ff_v4361__MultipleOptions__tag__3yR{\n\tmargin-left:5px;\n\tmargin-top:5px;\n}\n\n.ff_v4361__MultipleOptions__row__26w{\n\tdisplay:flex;\n\tflex-wrap:wrap;\n}\n\n.ff_v4361__MultipleOptions__readWrapper__11P{\n\tdisplay:flex;\n\tflex-wrap:wrap;\n\tmargin:0;\n}\n\n.ff_v4361__MultipleOptions__readWrapper__11P li{\n\t\tmargin-right:4px;\n\t\tmargin-bottom:4px;\n\t}\n";
var styles$e = {
  "container": "ff_v4361__MultipleOptions__container__M1Q",
  "tag": "ff_v4361__MultipleOptions__tag__3yR",
  "row": "ff_v4361__MultipleOptions__row__26w",
  "readWrapper": "ff_v4361__MultipleOptions__readWrapper__11P"
};
...
function getInitValues(value) {
  ...
  if (lodash.isArray(value) && lodash.isObject(value[0])) {
    return value.map(({
      id
    }) => String(id));
  }
...
const getSelectedOptions = (values, options) => {
  if (lodash.isArray(values) && options) {
    return lodash.filter(options, option => values.includes(String(option.id))) || [];
  }
...
const MultipleOptionsRead = ({
  ...
  const [optionsState] = React.useState(() => initOptions(fields, options, fieldType, fieldKey));
  ...
  const selectedTags = selectedOptions.map((tag, index) => /*#__PURE__*/React__default['default'].createElement("li", {
    key: index,
    className: styles$e.choiceItem
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Tag, null, tag.label)));
...
const MultipleOptions = ({
  ...
  const initTags = () => {
    if (value && optionsState) {
      ...
      const initValues = lodash.filter(optionsState, option => {
  ...
  const [tagsState, setTags] = React.useState(initTags);
  React.useEffect(() => {
    setTags(initTags());
  }, [value]);
  ...
  const autocompleteRenderInput = ({
    ...
    return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select, {
      disabled: disabled,
      popperProps: popperProps,
      portalTo: portalTo,
      className: className,
      ...
      ...selectProps
    }, optionsState.map(el => /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select.Option, {
      key: el.id,
      value: el.id
    }, el.label)));
  };
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(TagsInput__default['default'], {
    value: tagsState,
...
const NumberRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, numberValue);
};
...
const NumberComponent = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, { ...getValue$3({
      value,
      defaultValue
    }),
    autoFocus: autofocus,
...
const OrganizationRead = ({
  ...
  if (value.is_hidden) {
    return /*#__PURE__*/React__default['default'].createElement("span", null, "(", translator.gettext('hidden'), ")");
  }
...
const Organization = ({
  ...
  const getIsOrgNew = orgValue => {
    if (lodash.isObject(orgValue)) {
      return !orgValue.id;
    }

    if (lodash.isString(orgValue)) {
      return true;
    }
...
var css_248z$d = ".ff_v4361__Percentage__percentage__1V0 input::-webkit-outer-spin-button, .ff_v4361__Percentage__percentage__1V0 input::-webkit-inner-spin-button{\n\t\t-webkit-appearance:none;\n\t\tmargin:0;\n\t}\n";
var styles$d = {
  "percentage": "ff_v4361__Percentage__percentage__1V0"
};
...
const PercentageComponent = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default']('ff_editMode', styles$d.percentage)
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, { ...getValue$3({
      value,
      defaultValue,
      callback: lodash.toString
    }),
    message: error || validationError,
    disabled: disabled,
    color: error || validationError ? 'red' : undefined,
...
const Person = ({
  ...
  const getIsPersonNew = personValue => {
    if (lodash.isObject(personValue)) {
      return !personValue.id;
    }

    if (lodash.isString(personValue)) {
      return true;
    }
...
const Phone = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, {
...
var css_248z$c = ".ff_v4361__Pipelines__select__3hr{\n\twidth:100%;\n}\n";
var styles$c = {
  "select": "ff_v4361__Pipelines__select__3hr"
};
...
var css_248z$b = ".ff_v4361__PipelinesAndStages__label__3h1{\n\tmargin-bottom:4px;\n\tcolor:#747678;\n}\n.ff_v4361__PipelinesAndStages__noStagesMessage__3Vr{\n\twidth:100%;\n\theight:20px;\n\tpadding:4px;\n\tpadding-left:0;\n}\n.ff_v4361__PipelinesAndStages__noStagesErrorMessage__3CH{\n\tborder:1px solid #f94839;\n\tcolor:#f94839;\n\tpadding-left:4px;\n\tmargin-bottom:4px;\n}\n";
var styles$b = {
  "label": "ff_v4361__PipelinesAndStages__label__3h1",
  "noStagesMessage": "ff_v4361__PipelinesAndStages__noStagesMessage__3Vr",
  "noStagesErrorMessage": "ff_v4361__PipelinesAndStages__noStagesErrorMessage__3CH"
};
...
const PipelinesAndStages = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(Pipelines, {
    onComponentChange: onPipelineUpdate,
    selectedId: localState.pipelineId
  }), /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Spacing, {
    top: "s"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$b.label
  }, translator.gettext('Pipeline stage')), stagesForPipeline.length > 0 ? /*#__PURE__*/React__default['default'].createElement(conventionUiReact.StageSelector, {
  ...
  React__default['default'].createElement(conventionUiReact.StageSelector.Stage, {
    key: stage.id,
    id: stage.id,
    tooltip: stage.name,
  ...
  }, translator.gettext('This pipeline has no stages.')), error && /*#__PURE__*/React__default['default'].createElement(Error$1, {
    message: error
  })));
};

var css_248z$a = ".ff_v4361__RadioGroup__wrapper__1pr{\n\tborder:none;\n}\n\n\t.ff_v4361__RadioGroup__wrapper__1pr legend{\n\t\tfont:400 15px/20px 'Source Sans Pro',sans-serif;\n\t\tpadding:0;\n\t\tmargin:0 0 4px;\n\t\tcolor:#26292c;\n\t}\n\n\t.ff_v4361__RadioGroup__wrapper__1pr label{\n\t\tmargin-right:8px;\n\t}\n";
var styles$a = {
  "wrapper": "ff_v4361__RadioGroup__wrapper__1pr"
};
...
const RadioGroup = ({
  ...
  }, legend && /*#__PURE__*/React__default['default'].createElement("legend", null, legend), options.map(({
    label,
    disabled: singleDisabledRadio,
    value
  }) => /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Radio, {
    key: value,
    name: name,
    value: value,
  ...
  }, label)), /*#__PURE__*/React__default['default'].createElement(Error$1, {
    message: error
  }));
};

var css_248z$9 = ".ff_v4361__CheckboxGroup__wrapper__cK0{\n\tborder:none;\n}\n\n\t.ff_v4361__CheckboxGroup__wrapper__cK0 legend{\n\t\tfont:400 15px/20px 'Source Sans Pro',sans-serif;\n\t\tpadding:0;\n\t\tmargin:0 0 4px;\n\t\tcolor:#26292c;\n\t}\n\n\t.ff_v4361__CheckboxGroup__wrapper__cK0 label{\n\t\tmargin-right:8px;\n\t}\n";
var styles$9 = {
  "wrapper": "ff_v4361__CheckboxGroup__wrapper__cK0"
};
...
function CheckboxGroup({
  ...
  return /*#__PURE__*/React__default['default'].createElement("fieldset", {
    ...
    value,
    type
  }) => /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Checkbox, {
    key: label,
...
const initValue = value => {
  if (typeof value === 'object') {
    ...
    if (!lodash.isNil(value) && !isNaN(+value)) {
      value = Number(value);
    }
...
const SingleOptionRead = ({
  ...
  if (!(optionsState !== null && optionsState !== void 0 && optionsState.length)) {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, newValue.label);
  }

  const selectedOption = optionsState.find(option => option.id === Number(newValue.id));
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, selectedOption && selectedOption.label);
};

var css_248z$8 = ".ff_v4361__SingleOption__wrapper__2z1{\n\twidth:100%;\n}\n.ff_v4361__SingleOption__error__2-J{\n\tborder:1px solid #f94839;\n\tborder-right:none;\n\tbox-shadow:none !important;\n}\n.ff_v4361__SingleOption__error__2-J:last-of-type{\n\t\tborder-right:1px solid #f94839;\n\t}\n.ff_v4361__SingleOption__error__2-J > span{\n\t\tbox-shadow:none;\n\t}\n.ff_v4361__SingleOption__button__2Uw span{\n\t\tpadding:0;\n\t\tcolor:rgba(38,41,44,.64);\n\t}\n.ff_v4361__SingleOption__button__2Uw span:last-child{\n\t\tpadding-right:0;\n\t}\n.ff_v4361__SingleOption__button__2Uw span:first-child{\n\t\tpadding-left:0;\n\t}\n";
var styles$8 = {
  "wrapper": "ff_v4361__SingleOption__wrapper__2z1",
  "error": "ff_v4361__SingleOption__error__2-J",
  "button": "ff_v4361__SingleOption__button__2Uw"
};
...
const SingleOption = ({
  ...
  const [valueState, setValueState] = React.useState(initValue(value) || null);
  const [optionsState, setOptionsState] = React.useState(() => initOptions(fields, options, fieldType, fieldKey));
  ...
  const renderButtonGroup = () => {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.ButtonGroup, { ...buttonGroupProps
    }, buttons), /*#__PURE__*/React__default['default'].createElement(Error$1, {
      message: error
    }));
  };
  ...
  const renderSelectMenu = () => {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select, {
      ...
      ...selectProps
    }, selectOptions), /*#__PURE__*/React__default['default'].createElement(Error$1, {
      message: error
    }));
  };
...
const TextAreaLineBreaker = props => {
  ...
  const htmlBreakElement = /*#__PURE__*/React__default['default'].createElement("br", null);
  ...
  const handleLineBreak = lines.map((line, index) => {
    return /*#__PURE__*/React__default['default'].createElement(Linkify__default['default'], {
      key: index,
      properties: {
        target: '_blank'
      }
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, handleLineBreak);
};
...
const TextAreaRead = ({
  ...
  }, /*#__PURE__*/React__default['default'].createElement(TextAreaLineBreaker, {
    value: value
  }));
};
...
const TextAreaComponent = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Textarea, { ...getValue$3({
      value,
      defaultValue,
      callback
    }),
...
const TextField = ({
  ...
  const parsedValue = lodash.isNull(value) ? '' : value;
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, {
    autoFocus: autofocus,
    className: "ff_editMode",
    type: "text",
    ...getValue$3({
...
class TimeFormatter {
  ...
  formatMomentTime(selectedTime) {
    if (selectedTime) {
      return moment__default['default'](selectedTime, this.format);
    }
...
const TimePickerRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, timeFormatter.formatTime(value));
};

const TimePickerInput = /*#__PURE__*/React.forwardRef(({
  onChange,
  error,
  inputProps,
  inputValue,
...
var css_248z$7 = ".ff_v4361__TimePicker__popper__hlr[data-placement^='bottom']{\n\t\tmargin-top:0;\n\t}\n\t.ff_v4361__TimePicker__popper__hlr[data-placement]{\n\t\tz-index:6001;\n\t}\n\t.ff_v4361__TimePicker__errorWrapper__1Tv{\n\tborder:1px solid;\n\tborder-color:#f94839 !important;\n}\n\t.ff_v4361__TimePicker__errorMsg__K-k{\n\tcolor:#f94839;\n\tmargin-top:4px;\n\tfont-size:13px;\n}\n\t.ff_v4361__TimePicker__input__9pn .react-datepicker-wrapper, .ff_v4361__TimePicker__input__9pn .react-datepicker__input-container{\n\t\t\twidth:100%;\n\t\t}\n\t.ff_v4361__TimePicker__input__9pn .react-datepicker-wrapper input:disabled, .ff_v4361__TimePicker__input__9pn .react-datepicker__input-container input:disabled{\n\t\t\t\tbackground-color:#f7f7f7;\n\t\t\t}\n\t.ff_v4361__TimePicker__input__9pn .react-datepicker__close-icon::after{\n\t\t\t\tcolor:#747678;\n\t\t\t\tbackground-color:transparent;\n\t\t\t\tfont-size:23px;\n\t\t\t\theight:auto;\n\t\t\t\twidth:auto;\n\t\t\t\ttop:3px;\n\t\t\t\tright:2px;\n\t\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker\\--time-only{\n\t\t\tborder:0 !important;\n\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__header{\n\t\t\theight:69px;\n\t\t\tbackground-color:#ffffff;\n\t\t\tborder:0;\n\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__header\\--time{\n\t\t\t\tdisplay:none;\n\t\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__header\\--time-box{\n\t\t\t\t\twidth:100px;\n\t\t\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__triangle{\n\t\t\tdisplay:none;\n\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__time{\n\t\t\twidth:100px !important;\n\t\t\tborder-radius:0;\n\t\t\tborder:1px solid #b9babb;\n\t\t\tbox-shadow:0 5px 15px -5px #747678;\n\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__time-container{\n\t\t\t\tborder:0;\n\t\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__time-box{\n\t\t\t\tborder-radius:0;\n\t\t\t\twidth:100px !important;\n\t\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__time-list-item{\n\t\t\t\theight:auto !important;\n\t\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__time-list-item\\--selected{\n\t\t\t\t\tbackground-color:#317ae2 !important;\n\t\t\t\t}\n\t.ff_v4361__TimePicker__timepicker__98G .react-datepicker__time-list-item:hover{\n\t\t\t\t\tbackground-color:#317ae2 !important;\n\t\t\t\t\tcolor:#ffffff;\n\t\t\t\t}\n";
var styles$7 = {
  "popper": "ff_v4361__TimePicker__popper__hlr",
  "errorWrapper": "ff_v4361__TimePicker__errorWrapper__1Tv",
  "errorMsg": "ff_v4361__TimePicker__errorMsg__K-k",
  "input": "ff_v4361__TimePicker__input__9pn",
  "timepicker": "ff_v4361__TimePicker__timepicker__98G"
};
...
const TimePicker = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default'](styles$7.input, className)
  }, /*#__PURE__*/React__default['default'].createElement(Calendar__default['default'], {
    selected: startTime,
    popperClassName: classNames__default['default'](styles$7.timepicker, styles$7.popper),
    onChange: onSelectChange,
    showTimeSelect: true,
    ...
    timeFormat: format,
    startOpen: startOpen,
    className: classNames__default['default'](error && styles$7.errorWrapper),
    placeholderText: placeholder || format,
    isClearable: allowClear,
    customInput: /*#__PURE__*/React__default['default'].createElement(TimePickerInput, {
...
const TimeRangeRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, getTimeReadValue(formattedStartTime, formattedEndTime));
};
...
const TimeRange = ({
  ...
  const [startTimeState, setStartTime] = React.useState();
  const [endTimeState, setEndTime] = React.useState();
  const timeFormatter = new TimeFormatter(locale);
  React.useEffect(() => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: styles$s.wrapper
  }, /*#__PURE__*/React__default['default'].createElement(TimePicker, {
    selectsStart: true,
    placeholder: placeholderTextStart,
    startOpen: startOpen,
...
const DefaultPhoneRead = ({
  ...
  const arrayValue = lodash.isArray(value) ? value : [value];
  return /*#__PURE__*/React__default['default'].createElement("div", null, arrayValue.map((price, i) => {
    const {
      label,
      value: labelValue = ''
    } = price;
...
const UnitPrices = ({
  ...
  const [valueState] = React.useState(value ? lodash.isArray(value) ? value : [value] : [{
    value: '',
...
var css_248z$6 = ".ff_v4361__User__user__1u1{\n\twidth:100%;\n}\n\n.ff_v4361__User__selectPopup__11D{\n\tz-index:6001;\n}\n";
var styles$6 = {
  "user": "ff_v4361__User__user__1u1",
  "selectPopup": "ff_v4361__User__selectPopup__11D"
};
...
const getDefaultHighlightedIndex = (children, usersCollection, value, isUserOwner) => {
  ...
  if (children) {
    return lodash.findIndex(React__default['default'].Children.toArray(children), child => child.props.value === initialValue);
  }

  if (usersCollection) {
    return lodash.findIndex(usersCollection, user => user.id === initialValue);
  }
...
const User = ({
  ...
  const isUserOwner = React.useMemo(() => getIsUserOwner(isOwner, usersCollection), [usersCollection]);
  ...
  const renderUsers = () => {
    ...
    return usersCollection.map(user => {
      ...
      }, /*#__PURE__*/React__default['default'].createElement("div", null, userData.name, " ", userData.isYou ? translator.gettext('(You)') : null));
    });
  };

  const className = `${styles$6.user} ${error ? errorStyles.select : ''}`;
  const userValue = getValue$3({
    value: lodash.isObject(value) ? value.id : value,
    defaultValue: lodash.isObject(defaultValue) ? defaultValue.id : defaultValue,
    callback: val => val || isUserOwner,
    defaultReturn: {
      defaultValue: isUserOwner || ''
    }
  });
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select, { ...userValue,
    popperProps: popperProps,
    portalTo: portalTo,
    ...
    ...selectProps
  }, renderUsers()), /*#__PURE__*/React__default['default'].createElement(Error$1, {
    message: error
  }));
};
...
const VisibilitySwitchRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, role);
};

var css_248z$5 = ".ff_v4361__VisibilityIcon__title__2UT{\n\tfont-weight:bold;\n}\n.ff_v4361__VisibilityIcon__svg__3nk{\n\twidth:14px;\n\tmin-width:14px;\n\theight:14px;\n\tmin-height:14px;\n}\n.ff_v4361__VisibilityIcon__fill__3Fd{\n\tfill:rgb(47, 108, 197);\n}\n.ff_v4361__VisibilityIcon__empty__32_{\n\tfill:rgba(38, 41, 44, .24);\n}\n";
var styles$5 = {
  "title": "ff_v4361__VisibilityIcon__title__2UT",
  "svg": "ff_v4361__VisibilityIcon__svg__3nk",
  "fill": "ff_v4361__VisibilityIcon__fill__3Fd",
  "empty": "ff_v4361__VisibilityIcon__empty__32_"
};
...
const VisibilityIcon = ({
  ...
  for (let i = 0; i < w; i = i + 1) {
    for (let j = 0; j < h; j = j + 1) {
      rectangles.push( /*#__PURE__*/React__default['default'].createElement("rect", {
  ...
  return /*#__PURE__*/React__default['default'].createElement("svg", {
    className: classNames__default['default'](className, styles$5.svg)
  }, /*#__PURE__*/React__default['default'].createElement("g", {
    id: "vg_icons"
  }, rectangles));
};

var css_248z$4 = ".ff_v4361__VisibilityOptions__title__3IN:hover{\n\t\tcolor:#ffffff;\n\t}\n.ff_v4361__VisibilityOptions__selected__1xF{\n\tfont-weight:600;\n}\n.ff_v4361__VisibilityOptions__subTitle__1Nw{\n\tfont-size:13px;\n\tcolor:#747678;\n}\n.ff_v4361__VisibilityOptions__option__1Z4{\n\tcursor:pointer;\n\tdisplay:flex;\n}\n.ff_v4361__VisibilityOptions__option__1Z4:hover .ff_v4361__VisibilityOptions__title__3IN, .ff_v4361__VisibilityOptions__option__1Z4:hover .ff_v4361__VisibilityOptions__subTitle__1Nw{\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4361__VisibilityOptions__option__1Z4:hover .vg__icon--fill{\n\t\t\tfill:rgb(255, 255, 255) !important;\n\t\t}\n.ff_v4361__VisibilityOptions__option__1Z4:hover .vg__icon--empty{\n\t\t\tfill:rgba(38, 41, 44, .32);\n\t\t}\n.ff_v4361__VisibilityOptions__textWrap__2s8{\n\tdisplay:flex;\n\tflex-direction:column;\n\tpadding-left:12px;\n\ttext-align:left;\n}\n.ff_v4361__VisibilityOptions__icon__2PQ{\n\tdisplay:flex;\n\tpadding-top:4px;\n}\n";
var styles$4 = {
  "title": "ff_v4361__VisibilityOptions__title__3IN",
  "selected": "ff_v4361__VisibilityOptions__selected__1xF",
  "subTitle": "ff_v4361__VisibilityOptions__subTitle__1Nw",
  "option": "ff_v4361__VisibilityOptions__option__1Z4",
  "textWrap": "ff_v4361__VisibilityOptions__textWrap__2s8",
  "icon": "ff_v4361__VisibilityOptions__icon__2PQ"
};
...
const VisibilityOptions = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, Object.keys(roles).map(role => {
    const isSelected = selectedVisibility === Number(role);
    return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Option, {
      key: role,
      className: styles$4.option,
      onClick: onClickHandler(role),
      selected: isSelected
    }, children && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    }, roles[Number(role)].title), /*#__PURE__*/React__default['default'].createElement("span", {
      className: `${styles$4.subTitle} vs__subtext`
    }, roles[Number(role)].subTitle))));
  }));
};

var css_248z$3 = ".ff_v4361__VisibilitySwitch__select__2r7{\n\twidth:100%;\n\talign-items:center;\n\tpadding-left:10px;\n}\n.ff_v4361__VisibilitySwitch__select__2r7 span{\n\t\ttext-align:left;\n\t\tfont-weight:400;\n\t}\n.ff_v4361__VisibilitySwitch__icon__1TH{\n\tpadding-right:8px;\n}\n";
var styles$3 = {
  "select": "ff_v4361__VisibilitySwitch__select__2r7",
  "icon": "ff_v4361__VisibilitySwitch__icon__1TH"
};
...
const VisibilitySwitchComponent = ({
  ...
  const [selectedVisibilityState, setSelectedVisibility] = React.useState(value);
  React.useEffect(() => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Dropmenu, {
    ...
    content: /*#__PURE__*/React__default['default'].createElement(VisibilityOptions, {
      roles: roles,
      selectedVisibility: selectedVisibilityState,
      handleChange: handleVisibilityChange,
      advancedPermissions: advancedPermissions
    }, /*#__PURE__*/React__default['default'].createElement(VisibilityIcon, {
      className: styles$3.icon
    }))
  }, lodash.isFunction(children) ? children(currentRole) : children || /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
    className: styles$3.select,
    disabled: disabled
  }, /*#__PURE__*/React__default['default'].createElement(VisibilityIcon, {
    className: styles$3.icon,
    filledSquare: currentRole.squares
  }), currentRole.title, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
    size: "s",
    icon: "triangle-down"
  })));
};
...
var css_248z$2 = ".ff_v4361__ActionFooter__footerWrapper__2mX{\n\tmargin-top:8px;\n\talign-self:flex-end;\n}\n\n\t.ff_v4361__ActionFooter__footerWrapper__2mX .ff_v4361__ActionFooter__saveButton__2Ix{\n\t\tmargin-left:4px;\n\t}\n";
var styles$2 = {
  "footerWrapper": "ff_v4361__ActionFooter__footerWrapper__2mX",
  "saveButton": "ff_v4361__ActionFooter__saveButton__2Ix"
};
...
var css_248z$1 = ".ff_v4361__ComponentState__wrapperAdd__1hg .ff_v4361__ComponentState__addValue__1BG{\n\tfont:600 15px/20px 'Source Sans Pro', sans-serif;\n\tcolor:#317ae2;\n\ttext-decoration:none;\n}\n.ff_v4361__ComponentState__wrapperEdit__2hf{\n\tposition:relative;\n\tdisplay:flex;\n\talign-items:center;\n\twidth:100%;\n\tjustify-content:space-between;\n}\n.ff_v4361__ComponentState__wrapperEdit__2hf .ff_v4361__ComponentState__edit__30n{\n\t\tvisibility:hidden;\n\t}\n.ff_v4361__ComponentState__wrapperEdit__2hf .ff_v4361__ComponentState__cuiText__2C2{\n\t\twidth:100%;\n\t}\n.ff_v4361__ComponentState__wrapperEdit__2hf .ff_v4361__ComponentState__addValue__1BG{\n\t\tvisibility:hidden;\n\t\twidth:100%;\n\t\tdisplay:inline-block;\n\t}\n.ff_v4361__ComponentState__wrapperEdit__2hf .ff_v4361__ComponentState__valueText__13q{\n\t\tword-break:break-word;\n\t}\n.ff_v4361__ComponentState__wrapperEdit__2hf .ff_v4361__ComponentState__showValue__W4L{\n\t\twidth:100%;\n\t\tmargin-right:8px;\n\t}\n.ff_v4361__ComponentState__wrapperEdit__2hf:hover .ff_v4361__ComponentState__edit__30n{\n\t\t\tvisibility:visible;\n\t\t}\n.ff_v4361__ComponentState__wrapperEdit__2hf:hover .ff_v4361__ComponentState__icon__e8A{\n\t\t\tvisibility:hidden;\n\t\t}\n.ff_v4361__ComponentState__wrapperAdd__1hg{\n\tdisplay:flex;\n\talign-items:baseline;\n}\n.ff_v4361__ComponentState__wrapperAdd__1hg .ff_v4361__ComponentState__addValue__1BG{\n\t\tvisibility:hidden;\n\t\tcursor:pointer;\n\t}\n.ff_v4361__ComponentState__wrapperAdd__1hg .ff_v4361__ComponentState__placeholder__5aG{\n\t\tposition:absolute;\n\t\tcolor:#b9babb;\n\t}\n.ff_v4361__ComponentState__wrapperAdd__1hg:hover .ff_v4361__ComponentState__addValue__1BG{\n\t\t\tvisibility:visible;\n\t\t}\n.ff_v4361__ComponentState__wrapperAdd__1hg:hover .ff_v4361__ComponentState__placeholder__5aG{\n\t\t\tvisibility:hidden;\n\t\t}\n.ff_v4361__ComponentState__wrapperAdd__1hg:hover .ff_v4361__ComponentState__showValue__W4L{\n\t\t\tdisplay:none;\n\t\t}\n.ff_v4361__ComponentState__alignCenter__1AD{\n\tdisplay:flex;\n\talign-items:center;\n}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__name__31Y{\n\t\tflex:2;\n\t\tjustify-content:flex-end;\n\t\tmargin-right:8px;\n\t\tfont-size:13px;\n\t\tfont-weight:600;\n\t}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__field__3EV{\n\t\tflex:3;\n\t\tdisplay:flex;\n\t\tflex-direction:column;\n\t\tjustify-content:center;\n\t}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__fieldIcon__2sQ{\n\t\tmargin-right:8px;\n\t}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__dot__2Md{\n\t\tmargin-right:8px;\n\t\twidth:9px;\n\t\theight:9px;\n\t\tflex:none;\n\t}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__dot__2Md.ff_v4361__ComponentState__red__25L{\n\t\t\tbackground-color:#f94839;\n\t\t\tborder-radius:50%;\n\t\t}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__dot__2Md.ff_v4361__ComponentState__yellow__32Y{\n\t\t\tbackground-color:#ffcc00;\n\t\t\tborder-radius:50%;\n\t\t}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__dndicon__3Wa{\n\t\topacity:0;\n\t\tmargin-left:16px;\n\t}\n.ff_v4361__ComponentState__sidebarField__usY .ff_v4361__ComponentState__leftSection__3T8{\n\t\theight:32px;\n\t\tdisplay:flex;\n\t\tmargin-bottom:auto;\n\t}\n.ff_v4361__ComponentState__sidebarField__usY:hover .ff_v4361__ComponentState__dndicon__3Wa{\n\t\t\topacity:1;\n\t\t\tcursor:pointer;\n\t\t}\n";
var styles$1 = {
  "wrapperEdit": "ff_v4361__ComponentState__wrapperEdit__2hf",
  "edit": "ff_v4361__ComponentState__edit__30n",
  "cuiText": "ff_v4361__ComponentState__cuiText__2C2",
  "addValue": "ff_v4361__ComponentState__addValue__1BG",
  "valueText": "ff_v4361__ComponentState__valueText__13q",
  "showValue": "ff_v4361__ComponentState__showValue__W4L",
  "icon": "ff_v4361__ComponentState__icon__e8A",
  "wrapperAdd": "ff_v4361__ComponentState__wrapperAdd__1hg",
  "placeholder": "ff_v4361__ComponentState__placeholder__5aG",
  "alignCenter": "ff_v4361__ComponentState__alignCenter__1AD",
  "sidebarField": "ff_v4361__ComponentState__sidebarField__usY",
  "name": "ff_v4361__ComponentState__name__31Y",
  "field": "ff_v4361__ComponentState__field__3EV",
  "fieldIcon": "ff_v4361__ComponentState__fieldIcon__2sQ",
  "dot": "ff_v4361__ComponentState__dot__2Md",
  "red": "ff_v4361__ComponentState__red__25L",
  "yellow": "ff_v4361__ComponentState__yellow__32Y",
  "dndicon": "ff_v4361__ComponentState__dndicon__3Wa",
  "leftSection": "ff_v4361__ComponentState__leftSection__3T8"
};
...
const AddButton = ({
  ...
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Text, {
...
const SidebarField = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default'](styles$1.sidebarField, styles$1.alignCenter, className),
    onClick: onClick
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default'](styles$1.leftSection, styles$1.alignCenter, name && styles$1.name)
  }, dot && /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default'](styles$1.dot, styles$1[dot])
  }), icon && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
    icon: icon,
    size: "s",
    className: styles$1.fieldIcon
  }), avatar && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Avatar, {
    type: avatar,
    size: "s",
    className: styles$1.fieldIcon
  }), name && /*#__PURE__*/React__default['default'].createElement("span", null, name)), /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$1.field
  }, children), draggable && /*#__PURE__*/React__default['default'].createElement("div", {
    className: classNames__default['default'](styles$1.alignCenter, styles$1.dndicon)
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Icon, {
    icon: "drag-handle"
  })));
};
...
const format = (value, formatter, currency) => {
  if (formatter) {
    ...
    return formatter.formatNumber(lodash.toString(value));
  }
...
const Owner = props => {
  return /*#__PURE__*/React__default['default'].createElement(User, {
    isOwner: true,
    ...props
  });
};
...
const CategorySelectRead = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, value ? value.label : '');
};
...
const CategoryDialog = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
    ...
    icon: "trash"
  })), /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Dialog, {
...
var css_248z = ".ff_v4361__Category__wrapper__2Wj{\n\twidth:100%;\n}\n.ff_v4361__Category__editButton__21Z{\n\tdisplay:none;\n\tposition:absolute;\n\ttop:4px;\n\tright:12px;\n\tz-index:1;\n}\n.ff_v4361__Category__option__3D7{\n\tdisplay:flex;\n\tjustify-content:space-between;\n}\n.ff_v4361__Category__option__3D7:hover .ff_v4361__Category__editButton__21Z{\n\t\t\tdisplay:flex;\n\t\t}\n.ff_v4361__Category__section__eOG{\n\tdisplay:flex;\n\talign-items:center;\n\tjustify-content:space-between;\n\tflex:1;\n}\n.ff_v4361__Category__saveButton__3FH{\n\tmargin-left:8px;\n}\n";
var styles = {
  "wrapper": "ff_v4361__Category__wrapper__2Wj",
  "editButton": "ff_v4361__Category__editButton__21Z",
  "option": "ff_v4361__Category__option__3D7",
  "section": "ff_v4361__Category__section__eOG",
  "saveButton": "ff_v4361__Category__saveButton__3FH"
};
...
const categoryOptions = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, options.map(option => {
    return /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select.Option, {
    ...
    }, /*#__PURE__*/React__default['default'].createElement("span", null, option.label), isSelectedOptionNew(option) && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Pill, {
      color: "blue",
      size: "s"
    }, translator.gettext('new'))), canCreateCategories && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Button, {
      size: "s",
  ...
  }), canCreateCategories && filter.length > 0 && isFilterTextCategoryUnique() && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select.Option, {
    value: 'new_category',
    itemToString: () => {
      return filter;
    }
...
const Category = ({
  ...
  const focusCategoryInput = /*#__PURE__*/React__default['default'].createRef();
  React.useEffect(() => {
    if (!optionsProp) {
      (async () => {
  ...
  const onSelect = async id => {
    if (id === 'new_category') {
      ...
      const sortedById = lodash.sortBy(newOptions, 'id');
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select, {
    ...
    value,
    translator
  })), /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Modal, {
    visible: !!modal,
    ...
    footer: [/*#__PURE__*/React__default['default'].createElement(CategoryDialog, {
      key: 'category-dialog',
...
const TextAndOptionsFieldRead = ({
  ...
  return value ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, value) : null;
};
...
const TextAndOptionsField = ({
  ...
  const [selected, setSelected] = React.useState(getValue(value));
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, hasOptions && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select, {
    value: selected,
    onChange: onSelectChange,
    ...
    disabled: disabled,
    ...selectProps
  }, optionsState.map((option, _index) => /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Select.Option, {
    key: option.id,
    value: option.id
  }, option.label))), inputVisible && /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Spacing, {
    top: "xs"
  }, /*#__PURE__*/React__default['default'].createElement(conventionUiReact.Input, {
    autoFocus: autofocus,
    type: "text",
...
exports.AddressRead = AddressRead;
exports.Autocomplete = Autocomplete;
exports.AutocompleteRead = AutocompleteRead;
exports.Category = Category;
exports.CategoryRead = CategorySelectRead;
exports.CheckboxGroup = CheckboxGroup;
exports.DatePicker = DatePicker;
exports.DatePickerRead = DatePickerRead;
exports.DateRange = DateRange;
exports.DateRangeRead = DateRangeRead;
exports.Deal = Deal;
exports.DealOrLead = DealOrLead;
exports.DealOrLeadRead = DealOrLeadRead;
exports.DealRead = DealRead;
exports.DefaultPhone = DefaultPhone;
exports.DefaultPhoneRead = DefaultPhoneRead$1;
exports.Duration = Duration;
exports.DurationRead = DurationRead;
exports.Email = Email;
...
exports.InstantMessageRead = InstantMessageRead;
exports.Label = Label;
exports.LabelRead = LabelRead;
exports.Link = Link;
exports.Monetary = MonetaryComponent;
exports.MonetaryRead = MonetaryRead;
exports.MultipleContacts = MultipleContacts;
exports.MultipleContactsRead = MultipleContactsRead;
exports.MultipleOptions = MultipleOptions;
exports.MultipleOptionsRead = MultipleOptionsRead;
exports.NumberRead = NumberRead;
exports.Numeric = NumberComponent;
exports.Organization = Organization;
exports.OrganizationRead = OrganizationRead;
exports.Percentage = PercentageComponent;
exports.PercentageRead = PercentageRead;
exports.Person = Person;
exports.PersonRead = PersonRead;
exports.Phone = Phone;
exports.PhoneRead = PhoneRead;
exports.PipelinesAndStages = PipelinesAndStages;
exports.RadioGroup = RadioGroup;
exports.SidebarField = SidebarField;
exports.SingleOption = SingleOption;
exports.SingleOptionRead = SingleOptionRead;
exports.TextAndOptionsField = TextAndOptionsField;
exports.TextAndOptionsFieldRead = TextAndOptionsFieldRead;
exports.TextArea = TextAreaComponent;
exports.TextAreaRead = TextAreaRead;
exports.TextField = TextField;
exports.TextFieldRead = TextFieldRead;
exports.TimePicker = TimePicker;
exports.TimePickerRead = TimePickerRead;
exports.TimeRange = TimeRange;
exports.TimeRangeRead = TimeRangeRead;
exports.UnitPrices = UnitPrices;
exports.UnitPricesRead = DefaultPhoneRead;
exports.User = User;
exports.UserRead = UserRead;
exports.VisibilitySwitch = VisibilitySwitch;
exports.VisibilitySwitchRead = VisibilitySwitchRead;
exports.WithEditButton = WithEditButton;
exports.getComponent = getComponent;
exports.getFFContextData = getFFContextData;
exports.getFormValueIsEmpty = isEmpty;
exports.getSQLmapping = getSQLmapping;
exports.mapFieldType = mapFieldType;
exports.useDataMapping = useDataMapping;
