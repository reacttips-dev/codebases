...
export type BulkArchiveButtonArchiveAllMutationVariables = {
    filter: LeadsFilter;
    status: LeadStatus;
...
export type BulkArchiveButtonArchiveAllMutationResponse = {
    readonly archiveAllLeadsBulk: ({
...
export type BulkArchiveButtonArchiveAllMutation = {
    readonly response: BulkArchiveButtonArchiveAllMutationResponse;
    readonly variables: BulkArchiveButtonArchiveAllMutationVariables;
};
...
mutation BulkArchiveButtonArchiveAllMutation(
  ...
  archiveAllLeadsBulk(filter: $filter, status: $status, legacySort: $legacySort, sort: $sort, excludeIds: $excludeIds) {
    __typename
...
const node: ConcreteRequest = (function () {
    ...
    return {
        "fragment": {
            ...
            "kind": "Fragment",
            "metadata": null,
            "name": "BulkArchiveButtonArchiveAllMutation",
            "selections": [
                {
                    "alias": null,
                    "args": (v5 /*: any*/),
        ...
        "params": {
            "cacheID": "0ab16b5e4fd4c299fff036b476cca455",
            "id": null,
            "metadata": {},
            "name": "BulkArchiveButtonArchiveAllMutation",
            "operationKind": "mutation",
            "text": "mutation BulkArchiveButtonArchiveAllMutation(\n  $filter: LeadsFilter!\n  $status: LeadStatus!\n  $legacySort: LeadsLegacySort\n  $sort: [LeadsSort!]\n  $excludeIds: [ID!]!\n) {\n  archiveAllLeadsBulk(filter: $filter, status: $status, legacySort: $legacySort, sort: $sort, excludeIds: $excludeIds) {\n    __typename\n    ... on BulkSuccessResult {\n      changedRecordsCount\n      ...bulkArchived_tracking_data\n    }\n  }\n}\n\nfragment bulkArchived_tracking_data on BulkSuccessResult {\n  changedRecordsCount\n}\n"
        }
    } as any;
})();
(node as any).hash = 'ce20f0e29e5f9de22a40490a6c706c57';
export default node;
