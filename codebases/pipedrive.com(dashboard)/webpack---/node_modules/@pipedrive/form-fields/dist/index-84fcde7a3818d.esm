import { Modal, Button, Spinner, Badge, Input, Dropmenu, Option, Icon, Spacing, Select, Text, Tooltip, Separator, Tag, StageSelector, Radio, Checkbox, ButtonGroup, Textarea, Avatar, Dialog, Pill } from '@pipedrive/convention-ui-react';
import { isString, isNil, isNumber, isEmpty as isEmpty$1, trim as trim$3, isUndefined, replace, isNaN as isNaN$1, trimStart, range, flatMap, omit, defer as defer$1, noop, find as find$4, capitalize, isArray as isArray$6, debounce, isEqual, differenceWith, isObject as isObject$e, filter as filter$3, toString as toString$c, isNull, findIndex, isFunction, sortBy } from 'lodash';
...
var getBuiltIn$9 = function (namespace, method) {
  return arguments.length < 2 ? aFunction$7(path$9[namespace]) || aFunction$7(global$i[namespace]) : path$9[namespace] && path$9[namespace][method] || global$i[namespace] && global$i[namespace][method];
};
...
var document$3 = global$d.document; // typeof document.createElement is 'object' in old IE
...
var _export = function (options, source) {
  ...
  var target = GLOBAL ? path$8 : path$8[TARGET] || createNonEnumerableProperty$8(path$8, TARGET, {})[TARGET];
  ...
  for (key in source) {
    ...
    if (options.bind && USE_NATIVE) resultProperty = bind$6(sourceProperty, global$c); // wrap global constructors for prevent changs in this version
    ...
    if (PROTO) {
      ...
      if (!has$7(path$8, VIRTUAL_PROTOTYPE)) {
        createNonEnumerableProperty$8(path$8, VIRTUAL_PROTOTYPE, {});
      } // export virtual prototype methods


      createNonEnumerableProperty$8(path$8[VIRTUAL_PROTOTYPE], key, sourceProperty); // export real prototype methods
...
var SPECIES$5 = wellKnownSymbol$j('species'); // a part of `ArraySpeciesCreate` abstract operation
...
objectGetOwnPropertyNamesExternal.f = function getOwnPropertyNames(it) {
  return windowNames && toString$9.call(it) == '[object Window]' ? getWindowNames(it) : $getOwnPropertyNames$1(toIndexedObject$5(it));
};
...
var ownKeys$I = getBuiltIn$4('Reflect', 'ownKeys') || function ownKeys(it) {
...
var $AggregateError = function AggregateError(errors, message) {
  ...
  if (message !== undefined) createNonEnumerableProperty$3(that, 'message', toString$7(message));
  var errorsArray = [];
...
if ((NEW_ITERATOR_PROTOTYPE) && !has(IteratorPrototype$2, ITERATOR$2)) {
...
if (!set || !clear) {
  ...
  } else if (global$6.addEventListener && typeof postMessage == 'function' && !global$6.importScripts && location && location.protocol !== 'file:' && !fails$3(post)) {
    defer = post;
...
var engineIsIosPebble = /ipad|iphone|ipod/i.test(userAgent$2) && global$5.Pebble !== undefined;
...
var requireObjectCoercible$5 = requireObjectCoercible$8; // `String.prototype.codePointAt` methods implementation
...
var _excluded$p = ["webappApi", "ffContextData"];
...
var parseContext = function parseContext(_ref) {
  ...
  if (ffContextData) {
    return _objectSpread$G({}, ffContextData);
  }
...
var css_248z$x = ".ff_v4340__InputSelect__wrapper__3As{\n\tdisplay:flex;\n\tposition:relative;\n}\n.ff_v4340__InputSelect__suggestion__1y6{\n\tdisplay:flex;\n\talign-items:center;\n\twhite-space:pre;\n}\n.ff_v4340__InputSelect__suggestion__1y6 span{\n\t\tdisplay:block;\n\t\toverflow:hidden;\n\t\twhite-space:nowrap;\n\t\ttext-overflow:ellipsis;\n\t}\n.ff_v4340__InputSelect__suggestionIcon__3bT{\n\tmargin-right:10px;\n}\n.ff_v4340__InputSelect__highlight__3rw{\n\tbackground-color:#fff570;\n\tcolor:#26292c;\n}\n.ff_v4340__InputSelect__noMatchFound__1Gv{\n\tpointer-events:none;\n}\n.ff_v4340__InputSelect__noMatchFound__1Gv span{\n\t\tcolor:#747678;\n\t}\n.ff_v4340__InputSelect__input__2jq{\n\twidth:100%;\n\tflex:1;\n}\n.ff_v4340__InputSelect__popover__bUo{\n\tz-index:6001;\n}\n.ff_v4340__InputSelect__popover__bUo .cui4-popover__inner{\n\t\tmax-width:none;\n\t}\n.ff_v4340__InputSelect__content__1mH{\n\tposition:absolute;\n\tright:0;\n\tdisplay:flex;\n\talign-items:center;\n\tpadding:0 10px;\n\ttext-transform:uppercase;\n\theight:32px;\n}\n.ff_v4340__InputSelect__defaultSuggestions__PUG{\n\tmax-height:416px;\n}\n.ff_v4340__InputSelect__popverRoot__jrA{\n\twidth:100%;\n}\n.ff_v4340__InputSelect__warning__2f3{\n\tdisplay:flex;\n\talign-items:center;\n\tmargin-top:4px;\n\tfont:400 13px/16px 'Source Sans Pro',sans-serif;\n}\n.ff_v4340__InputSelect__warning__2f3 .ff_v4340__InputSelect__warningLink__1l2{\n\t\tpadding-left:8px;\n\t}\n.ff_v4340__InputSelect__warning__2f3 .ff_v4340__InputSelect__warningIcon__1_v{\n\t\tmargin-right:8px;\n\t}\n";
var styles$v = {
  "wrapper": "ff_v4340__InputSelect__wrapper__3As",
  "suggestion": "ff_v4340__InputSelect__suggestion__1y6",
  "suggestionIcon": "ff_v4340__InputSelect__suggestionIcon__3bT",
  "highlight": "ff_v4340__InputSelect__highlight__3rw",
  "noMatchFound": "ff_v4340__InputSelect__noMatchFound__1Gv",
  "input": "ff_v4340__InputSelect__input__2jq",
  "popover": "ff_v4340__InputSelect__popover__bUo",
  "content": "ff_v4340__InputSelect__content__1mH",
  "defaultSuggestions": "ff_v4340__InputSelect__defaultSuggestions__PUG",
  "popverRoot": "ff_v4340__InputSelect__popverRoot__jrA",
  "warning": "ff_v4340__InputSelect__warning__2f3",
  "warningLink": "ff_v4340__InputSelect__warningLink__1l2",
  "warningIcon": "ff_v4340__InputSelect__warningIcon__1_v"
};
...
function InputSelect(_ref) {
  ...
  var renderInput = function renderInput(_ref5) {
    ...
    var _getInputProps = getInputProps(),
        ...
        restDownshiftInputProps = _objectWithoutProperties(_getInputProps, _excluded$o);
    ...
    }, /*#__PURE__*/React.createElement(Input, _objectSpread$F(_objectSpread$F({
      forwardRef: inputRef,
  ...
  var renderDefaultSuggestions = function renderDefaultSuggestions(getItemProps, highlightedIndex) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", _objectSpread$F(_objectSpread$F({}, getItemProps({
        item: item,
        index: index
      })), {}, {
  ...
  var renderDropMenu = function renderDropMenu(_ref6, children) {
    ...
    return /*#__PURE__*/React.createElement(Dropmenu, _objectSpread$F({
  ...
  var stateReducer = function stateReducer(_ref7, changes) {
    ...
    switch (changes.type) {
      case Downshift.stateChangeTypes.changeInput:
        ...
        return _objectSpread$F(_objectSpread$F({}, changes), {}, {
  ...
  return /*#__PURE__*/React.createElement(Downshift, _objectSpread$F({
...
var useValidation = function useValidation(translator) {
  ...
  return {
    ...
    getNumberValidation: function getNumberValidation(_ref3) {
      ...
      if (formatter) {
        var validateValue = value.toString(); // @ts-expect-error TODO: fix to use `getLocaleConvention` but type definitions are not provided
...
var _excluded$n = ["actionIcon", "portalTo", "disabled", "onComponentChange", "onValidation", "error", "value"];
...
var Address = function Address(_ref) {
  ...
  var getGeocodedData = function getGeocodedData(suggestion) {
    ...
    new window.google.maps.Geocoder().geocode({
      ...
      return onComponentChange(_objectSpread$E(_objectSpread$E({}, suggestion), {}, {
        geocoded: result
      }));
    });
  };
  ...
  return /*#__PURE__*/React.createElement(InputSelect, _objectSpread$E(_objectSpread$E({
...
function itemSearch(_x6, _x7, _x8) {
  return _itemSearch.apply(this, arguments);
}

function _itemSearch() {
  _itemSearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(itemTypes, fields, term) {
    var limit,
        _yield$get3,
        data,
        _args3 = arguments;
    ...
    return _regeneratorRuntime.wrap(function _callee3$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            limit = _args3.length > 3 && _args3[3] !== undefined ? _args3[3] : 100;
...
function _updateCategory() {
  _updateCategory = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(fieldId, propOptions) {
    var res, options;
...
function getCategoryOptions(_x11) {
  return _getCategoryOptions.apply(this, arguments);
}

function _getCategoryOptions() {
  _getCategoryOptions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(fieldId) {
    var res, options;
...
var _excluded$m = ["fieldType", "fieldKey", "error", "value", "onValidation"];
...
var Autocomplete = function Autocomplete(_ref) {
  ...
  return /*#__PURE__*/React.createElement(InputSelect, _objectSpread$D(_objectSpread$D({}, getValue$3({
    value: value
  })), {}, {
...
var DateRangeRead = function DateRangeRead(_ref) {
  ...
  var format = localeMomentFormat(locale, 'LL');
...
var css_248z$v = ".ff_v4340__DatePicker-header__wrapper__1mA{\n\tdisplay:flex;\n\tjustify-content:space-between;\n}\n.ff_v4340__DatePicker-header__month__11b, .ff_v4340__DatePicker-header__year__3pb{\n\tdisplay:inline-block;\n\tcursor:pointer;\n\tposition:absolute;\n\tmargin:0;\n\tleft:0;\n\ttop:0;\n\tright:0;\n\tbottom:0;\n\topacity:0;\n}\n.ff_v4340__DatePicker-header__selects__3Lp{\n\tdisplay:flex;\n\tline-height:normal;\n\tmargin-bottom:6px;\n}\n.ff_v4340__DatePicker-header__selects__3Lp .ff_v4340__DatePicker-header__label__1Bu{\n\t\tdisplay:inline-block;\n\t\tposition:relative;\n\t\toverflow:hidden;\n\t\tmargin:8px 2px;\n\t\tfont-size:15px;\n\t\tfont-weight:600;\n\t\tbackground-color:#ffffff;\n\t\tcolor:#317ae2;\n\t\tcursor:pointer;\n\t}\n.ff_v4340__DatePicker-header__month__11b{\n\t-moz-text-align-last:center;\n\t     text-align-last:center;\n}\n.ff_v4340__DatePicker-header__prev__3jO{\n\tmargin-left:8px;\n}\n.ff_v4340__DatePicker-header__next__2TS{\n\tmargin-right:8px;\n}\n";
var styles$u = {
  "wrapper": "ff_v4340__DatePicker-header__wrapper__1mA",
  "month": "ff_v4340__DatePicker-header__month__11b",
  "year": "ff_v4340__DatePicker-header__year__3pb",
  "selects": "ff_v4340__DatePicker-header__selects__3Lp",
  "label": "ff_v4340__DatePicker-header__label__1Bu",
  "prev": "ff_v4340__DatePicker-header__prev__3jO",
  "next": "ff_v4340__DatePicker-header__next__2TS"
};
...
var _excluded$l = ["onChange", "error", "inputProps", "inputValue", "datePickerPlaceholder"];
...
var DatePickerInput = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(Input, _objectSpread$C(_objectSpread$C({}, restProps), {}, {
    ref: ref,
...
var css_248z$u = ".ff_v4340__DatePicker__popper__3KT[data-placement^='bottom']{\n\t\tmargin-top:0;\n\t}\n\t.ff_v4340__DatePicker__popper__3KT[data-placement]{\n\t\tz-index:6001;\n\t}\n\t.ff_v4340__DatePicker__wrapper__2Tw .react-datepicker-wrapper, .ff_v4340__DatePicker__wrapper__2Tw .react-datepicker__input-container{\n\t\t\twidth:100%;\n\t\t}\n\t.ff_v4340__DatePicker__wrapper__2Tw .react-datepicker__close-icon::after{\n\t\t\t\tcolor:#747678;\n\t\t\t\tbackground-color:transparent;\n\t\t\t\tfont-size:23px;\n\t\t\t\theight:auto;\n\t\t\t\twidth:auto;\n\t\t\t\ttop:3px;\n\t\t\t\tright:2px;\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker\\--time-only{\n\t\t\tborder:0 !important;\n\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__header{\n\t\t\theight:69px;\n\t\t\tbackground-color:#ffffff;\n\t\t\tborder:0;\n\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__header\\--time{\n\t\t\t\tdisplay:none;\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__header\\--time-box{\n\t\t\t\t\twidth:100px;\n\t\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day{\n\t\t\tmargin:2px;\n\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day:hover{\n\t\t\t\tcolor:rgb(49,122,226);\n\t\t\t\tbackground-color:rgba(49,122,226,.32);\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day-names{\n\t\t\t\tborder-bottom:1px solid #e5e5e5;\n\t\t\t\tborder-top:1px solid #e5e5e5;\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day-name{\n\t\t\t\tcolor:rgba(38,41,44,.64);\n\t\t\t\tfont-size:11px;\n\t\t\t\tline-height:16px;\n\t\t\t\tfont-weight:400;\n\t\t\t\ttext-align:center;\n\t\t\t\tvertical-align:middle;\n\t\t\t\tpadding:4px 0;\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--today:not(.ff_v4340__DatePicker__react-datepicker--time-only--in-selecting-range__1Z0){\n\t\t\t\t\tcolor:rgba(38,41,44,.64);\n\t\t\t\t\tbackground-color:#f7f7f7;\n\t\t\t\t\tfont-weight:600;\n\t\t\t\t\tborder-radius:3px;\n\t\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--outside-month{\n\t\t\t\tcolor:rgba(38,41,44,.32);\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--selected, .ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--keyboard-selected, .ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--range-start, .ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--range-end{\n\t\t\t\tcolor:#ffffff !important;\n\t\t\t\tbackground-color:#317ae2 !important;\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--in-selecting-range:not(.ff_v4340__DatePicker__react-datepicker__day--in-range__1TC){\n\t\t\t\t\tcolor:rgb(49,122,226);\n\t\t\t\t\tbackground-color:rgba(49,122,226,.32);\n\t\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--in-selecting-range:not(.ff_v4340__DatePicker__react-datepicker__day--selecting-range-start__Cya):not(.ff_v4340__DatePicker__react-datepicker__day--today__1nV):not(.ff_v4340__DatePicker__react-datepicker__day--in-range__1TC){\n\t\t\t\t\tcolor:#26292c;\n\t\t\t\t\tbackground-color:transparent;\n\t\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--selecting-range-start, .ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--in-range:not(.ff_v4340__DatePicker__react-datepicker__day--range-start__1JD):not(.ff_v4340__DatePicker__react-datepicker__day--range-end__2Ip){\n\t\t\t\t\tcolor:rgb(49,122,226);\n\t\t\t\t\tbackground-color:rgba(49,122,226,.32);\n\t\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--disabled{\n\t\t\t\tpointer-events:none;\n\t\t\t\tbackground-color:transparent;\n\t\t\t}\n\t.ff_v4340__DatePicker__datepicker__3hq .react-datepicker__day\\--disabled:hover{\n\t\t\t\t\tbackground-color:transparent;\n\t\t\t\t}\n";
var styles$t = {
  "popper": "ff_v4340__DatePicker__popper__3KT",
  "wrapper": "ff_v4340__DatePicker__wrapper__2Tw",
  "datepicker": "ff_v4340__DatePicker__datepicker__3hq",
  "react-datepicker--time-only--in-selecting-range": "ff_v4340__DatePicker__react-datepicker--time-only--in-selecting-range__1Z0",
  "react-datepicker__day--in-range": "ff_v4340__DatePicker__react-datepicker__day--in-range__1TC",
  "react-datepicker__day--selecting-range-start": "ff_v4340__DatePicker__react-datepicker__day--selecting-range-start__Cya",
  "react-datepicker__day--today": "ff_v4340__DatePicker__react-datepicker__day--today__1nV",
  "react-datepicker__day--range-start": "ff_v4340__DatePicker__react-datepicker__day--range-start__1JD",
  "react-datepicker__day--range-end": "ff_v4340__DatePicker__react-datepicker__day--range-end__2Ip"
};
...
var _excluded$k = ["value", "className", "calendarClassName", "popperClassName", "showTimeSelect", "showTimeSelectOnly", "portalTo", "disabled", "minEndDate", "onRawChange", "selectsEnd", "onComponentChange", "selected", "error", "placeholder", "allowClear", "startDate", "endDate", "onValidation"];
...
var DatePicker = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var renderCustomHeader = function renderCustomHeader(renderProps) {
    return /*#__PURE__*/React.createElement(DatePickerHeader, _objectSpread$B(_objectSpread$B({}, renderProps), {}, {
  ...
  }, /*#__PURE__*/React.createElement(Calendar, _objectSpread$B(_objectSpread$B(_objectSpread$B({
...
var css_248z$t = ".ff_v4340__Error__error__YlD{\n\tcolor:#f94839;\n\tmargin-top:4px;\n\tfont-size:13px;\n}\n.ff_v4340__Error__select__1Mm .cui4-select__box{\n\t\tborder:1px solid #f94839;\n\t}\n";
var errorStyles = {
  "error": "ff_v4340__Error__error__YlD",
  "select": "ff_v4340__Error__select__1Mm"
};
...
var css_248z$s = ".ff_v4340__DateRange__wrapper__2_m{\n\tdisplay:flex;\n\tjustify-content:flex-start;\n\talign-items:flex-end;\n}\n\n\t.ff_v4340__DateRange__wrapper__2_m .ff_v4340__DateRange__separator__1eA{\n\t\tdisplay:flex;\n\t\talign-items:center;\n\t\theight:32px;\n\t\tpadding:0 8px;\n\t}\n";
var styles$s = {
  "wrapper": "ff_v4340__DateRange__wrapper__2_m",
  "separator": "ff_v4340__DateRange__separator__1eA"
};
styleInject(css_248z$s);

var _excluded$j = ["placeholderTextStart", "placeholderTextEnd", "startOpen", "value", "onComponentChange", "openNextAfterSelection", "error", "className", "allowClear", "allowClearStart", "allowClearEnd"];
...
var DateRange = function DateRange(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(DatePicker, _objectSpread$A({
...
var css_248z$r = ".ff_v4340__Link__link__26_{\n\ttext-decoration:none;\n\tcolor:#317ae2;\n\tpadding-right:4px;\n}\n";
var styles$r = {
  "link": "ff_v4340__Link__link__26_"
};
styleInject(css_248z$r);

var _excluded$i = ["openLinksInNewTab", "href", "value", "onClick", "children"];
...
var Link = function Link(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _objectSpread$z(_objectSpread$z({}, openLinksInNewTab ? {
    target: '_blank'
  } : {}), {}, {
    href: onClick ? '#' : href,
...
var _excluded$h = ["error", "allowNewItem", "showDealRelatedOrg", "onBlur", "onValidation"];
...
var Deal = function Deal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(InputSelect, _objectSpread$y({
    inputProps: {
      icon: 'deal',
...
var DealOrLeadRead = function DealOrLeadRead(_ref) {
  var value = _ref.value,
      openLinksInNewTab = _ref.openLinksInNewTab;
  ...
  var getLink = function getLink(type, id) {
    switch (type) {
      case TypeName.LEAD:
        return "/leads/".concat(id);

      case TypeName.DEAL:
      default:
        return "/deal/".concat(id);
    }
  };
...
var css_248z$q = ".ff_v4340__DealOrLead__popoverContent__1lH{\n\tmax-height:240px;\n}\n";
var styles$q = {
  "popoverContent": "ff_v4340__DealOrLead__popoverContent__1lH"
};
styleInject(css_248z$q);

var useValueWithCurrency = function useValueWithCurrency() {
  var _parseContext = parseContext(useContext(FormFieldsContext)),
  ...
  return function (value, currency) {
    ...
    var code = currencies ? (_currencies$ = currencies[0]) === null || _currencies$ === void 0 ? void 0 : _currencies$.code : 'EUR';
...
var css_248z$p = ".ff_v4340__ResultItem__dealStatus__1ue{\n\ttext-transform:capitalize;\n}\n.ff_v4340__ResultItem__resultDetails__POn{\n\tmargin-top:4px;\n\tfont-size:13px;\n\tmax-width:100%;\n\twhite-space:nowrap;\n\toverflow:hidden;\n\ttext-overflow:ellipsis;\n}\n.ff_v4340__ResultItem__resultDetails__POn span:not(:last-child)::after{\n\t\tcontent:' \\B7  ';\n\t\tcolor:#26292c;\n\t}\n.ff_v4340__ResultItem__option__RTx{\n\tpadding:8px 4px;\n\tdisplay:flex;\n\talign-items:center;\n}\n.ff_v4340__ResultItem__option__RTx:hover .ff_v4340__ResultItem__dealStatus__1ue, .ff_v4340__ResultItem__option__RTx.ff_v4340__ResultItem__optionHighlighted__3dF .ff_v4340__ResultItem__dealStatus__1ue, .ff_v4340__ResultItem__option__RTx:hover .ff_v4340__ResultItem__resultDetails__POn span::after, .ff_v4340__ResultItem__option__RTx.ff_v4340__ResultItem__optionHighlighted__3dF .ff_v4340__ResultItem__resultDetails__POn span::after{\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4340__ResultItem__resultIcon__1cj{\n\tmargin:8px;\n}\n.ff_v4340__ResultItem__dealStatusWon__Q7b{\n\tcolor:#08a742;\n}\n.ff_v4340__ResultItem__dealStatusLost__gWg{\n\tcolor:#f94839;\n}\n.ff_v4340__ResultItem__resultWrapper__-jM{\n\tmax-width:100%;\n}\n.ff_v4340__ResultItem__resultBody__QYE{\n\tmax-width:calc(100% - 65px);\n}\n.ff_v4340__ResultItem__resultTitle__xI3{\n\tdisplay:block;\n\tmax-width:100%;\n\twhite-space:nowrap;\n\toverflow:hidden;\n\ttext-overflow:ellipsis;\n}\n";
var styles$p = {
  "dealStatus": "ff_v4340__ResultItem__dealStatus__1ue",
  "resultDetails": "ff_v4340__ResultItem__resultDetails__POn",
  "option": "ff_v4340__ResultItem__option__RTx",
  "optionHighlighted": "ff_v4340__ResultItem__optionHighlighted__3dF",
  "resultIcon": "ff_v4340__ResultItem__resultIcon__1cj",
  "dealStatusWon": "ff_v4340__ResultItem__dealStatusWon__Q7b",
  "dealStatusLost": "ff_v4340__ResultItem__dealStatusLost__gWg",
  "resultWrapper": "ff_v4340__ResultItem__resultWrapper__-jM",
  "resultBody": "ff_v4340__ResultItem__resultBody__QYE",
  "resultTitle": "ff_v4340__ResultItem__resultTitle__xI3"
};
...
var ResultItem = function ResultItem(_ref) {
  ...
  var getValueWithCurrency = useValueWithCurrency();
  var id = item.id,
      type = item.type,
  ...
  var renderDealStatus = function renderDealStatus(status) {
    var _classNames;

    return /*#__PURE__*/React.createElement("span", {
      className: classNames((_classNames = {}, _defineProperty(_classNames, styles$p.dealStatus, true), _defineProperty(_classNames, styles$p.dealStatusLost, status === 'lost'), _defineProperty(_classNames, styles$p.dealStatusWon, status === 'won'), _classNames)),
      "data-testid": "option-status"
    }, status);
  };

  var renderValueWithCurrency = function renderValueWithCurrency() {
    return /*#__PURE__*/React.createElement("span", null, getValueWithCurrency(value, currency));
  };

  return /*#__PURE__*/React.createElement("div", _objectSpread$x(_objectSpread$x({
    key: id
  }, additionalRootElementProps), {}, {
    className: styles$p.resultWrapper
  }), /*#__PURE__*/React.createElement(Option, {
    "data-testid": "option",
    className: classNames((_classNames2 = {}, _defineProperty(_classNames2, styles$p.option, true), _defineProperty(_classNames2, styles$p.optionHighlighted, highlightedIndex === index), _classNames2)),
...
var _excluded$g = ["disabled", "value", "error", "onBlur", "onValidation", "allowClear"];
...
var DealOrLead = function DealOrLead(_ref) {
  ...
  var renderSuggestions = function renderSuggestions(searchResults) {
    return function (getItemProps, highlightedIndex, setHighlightedIndex) {
      return /*#__PURE__*/React.createElement("div", {
        className: styles$q.popoverContent
      }, map(searchResults).call(searchResults, function (item, index) {
  ...
  var mapApiResultsToEntity = function mapApiResultsToEntity(item) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              setLoading(true);
              _context.next = 3;
              return itemSearch(['deal', 'lead'], ['title'], searchValue);

            case 3:
              searchResponse = _context.sent;
              setLoading(false);
              return _context.abrupt("return", map(searchResponse).call(searchResponse, function (_ref3) {
                var item = _ref3.item;
                return mapApiResultsToEntity(item);
              }));
...
var css_248z$o = ".ff_v4340__Phone__phoneIcon__iJn{\n\tpadding:0 6px 0 4px;\n\theight:16px;\n\twidth:16px;\n}\n.ff_v4340__Phone__arrow__2ut{\n\tdisplay:flex;\n}\n.ff_v4340__Phone__phoneButton__1tJ{\n\ttext-align:left;\n\twhite-space:nowrap;\n\twidth:100%;\n}\n.ff_v4340__Phone__phoneButton__1tJ:not(:first-child){\n\t\tmargin-top:4px;\n\t}\n.ff_v4340__Phone__phoneLabel__1JE{\n\tcolor:#b9babb !important;\n\tmargin:0 6px;\n}\n.ff_v4340__Phone__phoneValue__1AS{\n\tdisplay:flex;\n\twidth:100%;\n\tfont-size:13px;\n\toverflow:hidden;\n}\n.ff_v4340__Phone__phoneValue__1AS a{\n\t\tcolor:#26292c;\n\t\ttext-decoration:none;\n\t\ttext-overflow:ellipsis;\n\t\toverflow:hidden;\n\t}\n";
var styles$o = {
  "phoneIcon": "ff_v4340__Phone__phoneIcon__iJn",
  "arrow": "ff_v4340__Phone__arrow__2ut",
  "phoneButton": "ff_v4340__Phone__phoneButton__1tJ",
  "phoneLabel": "ff_v4340__Phone__phoneLabel__1JE",
  "phoneValue": "ff_v4340__Phone__phoneValue__1AS"
};
...
var css_248z$n = ".ff_v4340__DefaultPhone__readValue__kUt{\n\tdisplay:flex;\n}\n.ff_v4340__DefaultPhone__readLabel__Unf{\n\tcolor:#747678;\n\tword-break:normal;\n}\n";
var styles$n = {
  "readValue": "ff_v4340__DefaultPhone__readValue__kUt",
  "readLabel": "ff_v4340__DefaultPhone__readLabel__Unf"
};
...
var css_248z$m = ".ff_v4340__InputSelectCompound__inputWrap__1_R{\n\tposition:relative;\n\tflex:1;\n}\n\n.ff_v4340__InputSelectCompound__input__1kd{\n\twidth:100% !important;\n}\n\n.ff_v4340__InputSelectCompound__select__1hE{\n\tflex:1;\n\tmargin-left:8px;\n\theight:32px;\n\tmax-width:50%;\n}\n\n.ff_v4340__InputSelectCompound__select__1hE .cui4-input{\n\t\twidth:100%;\n\t}\n\n.ff_v4340__InputSelectCompound__compoundComponent__3mN{\n\tdisplay:flex;\n\tflex-direction:row;\n}\n";
var styles$m = {
  "inputWrap": "ff_v4340__InputSelectCompound__inputWrap__1_R",
  "input": "ff_v4340__InputSelectCompound__input__1kd",
  "select": "ff_v4340__InputSelectCompound__select__1hE",
  "compoundComponent": "ff_v4340__InputSelectCompound__compoundComponent__3mN"
};
...
var css_248z$l = ".ff_v4340__InputSelectAddMore__wrapper__1sY{\n\tdisplay:flex;\n\tflex-direction:column;\n}\n.ff_v4340__InputSelectAddMore__itemWrap__w4T{\n\tdisplay:flex;\n}\n.ff_v4340__InputSelectAddMore__item__3jk{\n\tpadding-bottom:5px;\n\twidth:100%;\n}\n.ff_v4340__InputSelectAddMore__link__fxh{\n\tcursor:pointer;\n}\n.ff_v4340__InputSelectAddMore__disabled__3f1 a{\n\t\tcolor:#747678;\n\t\tcursor:not-allowed;\n\t}\n.ff_v4340__InputSelectAddMore__remove__340{\n\tmargin-left:5px;\n}\n";
var styles$l = {
  "wrapper": "ff_v4340__InputSelectAddMore__wrapper__1sY",
  "itemWrap": "ff_v4340__InputSelectAddMore__itemWrap__w4T",
  "item": "ff_v4340__InputSelectAddMore__item__3jk",
  "link": "ff_v4340__InputSelectAddMore__link__fxh",
  "disabled": "ff_v4340__InputSelectAddMore__disabled__3f1",
  "remove": "ff_v4340__InputSelectAddMore__remove__340"
};
...
var css_248z$k = ".ff_v4340__Email__readValue__3v6{\n\tdisplay:flex;\n}\n.ff_v4340__Email__readLabel__12q{\n\tcolor:#747678;\n\tword-break:normal;\n}\n";
var styles$k = {
  "readValue": "ff_v4340__Email__readValue__3v6",
  "readLabel": "ff_v4340__Email__readLabel__12q"
};
...
var css_248z$j = ".ff_v4340__InstantMessage__readValue__3an{\n\tdisplay:flex;\n}\n\n.ff_v4340__InstantMessage__readIM__1WR{\n\tpadding-right:4px;\n\tvertical-align:top;\n}\n";
var styles$j = {
  "readValue": "ff_v4340__InstantMessage__readValue__3an",
  "readIM": "ff_v4340__InstantMessage__readIM__1WR"
};
...
var css_248z$i = ".ff_v4340__Label__label__3Dv{\n\twidth:100%;\n}\n";
var styles$i = {
  "label": "ff_v4340__Label__label__3Dv"
};
...
var css_248z$h = ".ff_v4340__EntitySuggestions__duplicatesOptionslist__1tb{\n\tmax-height:364px;\n\toverflow:auto;\n}\n.ff_v4340__EntitySuggestions__option__2gG .cui4-option-check{\n\tright:12px;\n}\n.ff_v4340__EntitySuggestions__optionIcon__22k{\n\tposition:absolute;\n\tright:12px;\n\tdisplay:none;\n\ttop:calc(50% - 16px);\n}\n.ff_v4340__EntitySuggestions__optionIcon__22k .cui4-icon{\n\t\tdisplay:block;\n\t\tfill:#ffffff;\n\t}\n.ff_v4340__EntitySuggestions__optionIcon__22k .cui4-icon:hover{\n\t\t\tfill:#ffffff;\n\t\t}\n.ff_v4340__EntitySuggestions__optionIcon__22k:hover .cui4-icon{\n\t\t\tfill:#ffffff !important;\n\t\t}\n.ff_v4340__EntitySuggestions__option__2gG{\n\tpadding:8px 40px 8px 16px;\n\tbox-sizing:border-box;\n\tcursor:pointer;\n\tposition:relative;\n\tcolor:#26292c;\n}\n.ff_v4340__EntitySuggestions__option__2gG .ff_v4340__EntitySuggestions__name__2S5{\n\t\twhite-space:nowrap;\n\t\toverflow:hidden;\n\t\ttext-overflow:ellipsis;\n\t}\n.ff_v4340__EntitySuggestions__option__2gG .ff_v4340__EntitySuggestions__details__24V{\n\t\tcolor:#747678;\n\t\tfont-size:13px;\n\t}\n.ff_v4340__EntitySuggestions__option__2gG:hover, .ff_v4340__EntitySuggestions__option__2gG.ff_v4340__EntitySuggestions__optionHighlighted__3Ew{\n\t\tbackground:#317ae2;\n\t\tcolor:#ffffff;\n\t}\n.ff_v4340__EntitySuggestions__option__2gG:hover .ff_v4340__EntitySuggestions__optionIcon__22k, .ff_v4340__EntitySuggestions__option__2gG.ff_v4340__EntitySuggestions__optionHighlighted__3Ew .ff_v4340__EntitySuggestions__optionIcon__22k{\n\t\t\tdisplay:block;\n\t\t\tcursor:pointer;\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4340__EntitySuggestions__option__2gG:hover .ff_v4340__EntitySuggestions__details__24V, .ff_v4340__EntitySuggestions__option__2gG.ff_v4340__EntitySuggestions__optionHighlighted__3Ew .ff_v4340__EntitySuggestions__details__24V{\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4340__EntitySuggestions__option__2gG:hover .cui4-option-check, .ff_v4340__EntitySuggestions__option__2gG.ff_v4340__EntitySuggestions__optionHighlighted__3Ew .cui4-option-check{\n\t\t\tdisplay:none;\n\t\t}\n.ff_v4340__EntitySuggestions__addNew__2Gf{\n\tpadding:8px 16px;\n\tdisplay:flex;\n\talign-items:center;\n\tmargin-top:4px;\n\tcursor:pointer;\n}\n.ff_v4340__EntitySuggestions__addNew__2Gf span{\n\t\tmargin-left:8px;\n\t\tfont-weight:600;\n\t\tcolor:#317ae2;\n\t}\n.ff_v4340__EntitySuggestions__addNew__2Gf svg{\n\t\tfill:#317ae2;\n\t}\n.ff_v4340__EntitySuggestions__tooltip__2Tg{\n\tz-index:6001;\n}\n.ff_v4340__EntitySuggestions__tooltipContent__6X7{\n\tmax-width:200px;\n}\n";
var styles$h = {
  "duplicatesOptionslist": "ff_v4340__EntitySuggestions__duplicatesOptionslist__1tb",
  "option": "ff_v4340__EntitySuggestions__option__2gG",
  "optionIcon": "ff_v4340__EntitySuggestions__optionIcon__22k",
  "name": "ff_v4340__EntitySuggestions__name__2S5",
  "details": "ff_v4340__EntitySuggestions__details__24V",
  "optionHighlighted": "ff_v4340__EntitySuggestions__optionHighlighted__3Ew",
  "addNew": "ff_v4340__EntitySuggestions__addNew__2Gf",
  "tooltip": "ff_v4340__EntitySuggestions__tooltip__2Tg",
  "tooltipContent": "ff_v4340__EntitySuggestions__tooltipContent__6X7"
};
...
var EntitySuggestions = function EntitySuggestions(_ref) {
  var contacts = _ref.contacts,
      ...
      texts = _ref.texts,
      inputValue = _ref.inputValue,
      suggestionValueKey = _ref.suggestionValueKey;
  ...
  var renderAddNewOption = function renderAddNewOption() {
    ...
    var item = isString(suggestionValueKey) ? (_ref2 = {}, _defineProperty(_ref2, suggestionValueKey, inputValue), _defineProperty(_ref2, "is_new", true), _ref2) : inputValue;
...
var css_248z$g = ".ff_v4340__InputMultiSelect__wrapper__2ay{\n\tdisplay:flex;\n\tposition:relative;\n\tborder:1px solid #cbcccd;\n\tborder-radius:2px;\n\tbackground:#ffffff;\n\tbox-shadow:inset 0 1px 2px #eeeeee;\n\tflex-wrap:wrap;\n\talign-items:center;\n\twidth:unset;\n}\n\n\t.ff_v4340__InputMultiSelect__wrapper__2ay > .ff_v4340__InputMultiSelect__selectedTag__9LT{\n\t\tmargin:4px 0 4px 8px;\n\t}\n\n\t.ff_v4340__InputMultiSelect__wrapper__2ay > .ff_v4340__InputMultiSelect__selectedTag__9LT .cui4-tag__content{\n\t\t\tcolor:#26292c;\n\t\t\tdisplay:flex;\n\t\t\talign-items:center;\n\t\t}\n\n\t.ff_v4340__InputMultiSelect__wrapper__2ay > .ff_v4340__InputMultiSelect__selectedTag__9LT ~ .ff_v4340__InputMultiSelect__selectedTag__9LT{\n\t\tmargin-left:4px;\n\t}\n\n\t.ff_v4340__InputMultiSelect__wrapper__2ay:focus-within{\n\t\tborder-color:#317ae2;\n\t}\n\n\t.ff_v4340__InputMultiSelect__wrapper__2ay.ff_v4340__InputMultiSelect__errorWrapper__15O{\n\t\tborder:1px solid #f94839;\n\t}\n\n\t.ff_v4340__InputMultiSelect__disabledInputWrapper__TGK{\n\tbackground-color:#f7f7f7;\n}\n\n\t.ff_v4340__InputMultiSelect__inputIcon__3-i{\n\tmargin-left:8px;\n}\n\n\t.ff_v4340__InputMultiSelect__input__ZAT{\n\tmin-width:150px;\n\tflex:1;\n}\n\n\t.ff_v4340__InputMultiSelect__input__ZAT input[type='text']{\n\t\tborder:none;\n\t\tbox-shadow:none;\n\t\tmin-width:150px;\n\t\tflex:1;\n\t\tbackground:transparent;\n\t}\n\n\t.ff_v4340__InputMultiSelect__input__ZAT input[type='text']:focus{\n\t\t\toutline:none;\n\t\t\tborder:none;\n\t\t\tbox-shadow:none;\n\t\t}\n\n\t.ff_v4340__InputMultiSelect__tagWarning__3Zy{\n\tmargin:0 2px 0 4px;\n}\n\n\t.ff_v4340__InputMultiSelect__newBadge__3ZK, .ff_v4340__InputMultiSelect__loadingSpinner__2KZ{\n\tposition:absolute;\n\tright:6px;\n\ttop:calc(50% - 8px);\n}\n\n\t.ff_v4340__InputMultiSelect__popover__jfH{\n\tz-index:6001;\n}\n";
var styles$g = {
  "wrapper": "ff_v4340__InputMultiSelect__wrapper__2ay",
  "selectedTag": "ff_v4340__InputMultiSelect__selectedTag__9LT",
  "errorWrapper": "ff_v4340__InputMultiSelect__errorWrapper__15O",
  "disabledInputWrapper": "ff_v4340__InputMultiSelect__disabledInputWrapper__TGK",
  "inputIcon": "ff_v4340__InputMultiSelect__inputIcon__3-i",
  "input": "ff_v4340__InputMultiSelect__input__ZAT",
  "tagWarning": "ff_v4340__InputMultiSelect__tagWarning__3Zy",
  "newBadge": "ff_v4340__InputMultiSelect__newBadge__3ZK",
  "loadingSpinner": "ff_v4340__InputMultiSelect__loadingSpinner__2KZ",
  "popover": "ff_v4340__InputMultiSelect__popover__jfH"
};
...
function InputMultiSelect(_ref) {
  var _ref$getSuggestions = _ref.getSuggestions,
    ...
    return promise.resolve([]);
      ...
      passedGetSuggestionValue = _ref.getSuggestionValue,
  ...
  var addNewItem = function addNewItem(newValue, state) {
    var _newItem;

    var newItem = (_newItem = {}, _defineProperty(_newItem, suggestionValueKey, newValue), _defineProperty(_newItem, "is_new", true), _newItem);
  ...
  var renderDefaultSuggestions = function renderDefaultSuggestions(getItemProps, highlightedIndex) {
    ...
    return map(_context5 = suggestions || []).call(_context5, function (item, index) {
      var _context6;
      ...
      return /*#__PURE__*/React.createElement("div", _objectSpread$j(_objectSpread$j({}, getItemProps({
        ...
        key: concat(_context6 = "".concat(item)).call(_context6, index)
      }), /*#__PURE__*/React.createElement(Option, {
        highlighted: highlightedIndex === index,
  ...
  var renderInput = function renderInput(state) {
    var getInputProps = state.getInputProps,
  ...
  var renderDropMenu = function renderDropMenu(state, children) {
    var isOpen = state.isOpen,
        highlightedIndex = state.highlightedIndex,
        getItemProps = state.getItemProps,
...
var css_248z$f = ".ff_v4340__MultipleContacts__squeezedInput__3ot input{\n\tmax-height:30px;\n}\n";
var styles$f = {
  "squeezedInput": "ff_v4340__MultipleContacts__squeezedInput__3ot"
};
...
$$2({
  ...
  /* , position = 0 */
    ...
    return !!~toString$2(requireObjectCoercible$2(this)).indexOf(toString$2(notARegExp(searchString)), arguments.length > 1 ? arguments[1] : undefined);
  }
});
...
var css_248z$e = ".ff_v4340__MultipleOptions__container__M1Q{\n\twidth:100%;\n}\n\n.ff_v4340__MultipleOptions__tag__3yR{\n\tmargin-left:5px;\n\tmargin-top:5px;\n}\n\n.ff_v4340__MultipleOptions__row__26w{\n\tdisplay:flex;\n\tflex-wrap:wrap;\n}\n\n.ff_v4340__MultipleOptions__readWrapper__11P{\n\tdisplay:flex;\n\tflex-wrap:wrap;\n\tmargin:0;\n}\n\n.ff_v4340__MultipleOptions__readWrapper__11P li{\n\t\tmargin-right:4px;\n\t\tmargin-bottom:4px;\n\t}\n";
var styles$e = {
  "container": "ff_v4340__MultipleOptions__container__M1Q",
  "tag": "ff_v4340__MultipleOptions__tag__3yR",
  "row": "ff_v4340__MultipleOptions__row__26w",
  "readWrapper": "ff_v4340__MultipleOptions__readWrapper__11P"
};
...
function getInitValues(value) {
  ...
  if (isArray$6(value) && isObject$e(value[0])) {
...
var css_248z$d = ".ff_v4340__Percentage__percentage__1V0 input::-webkit-outer-spin-button, .ff_v4340__Percentage__percentage__1V0 input::-webkit-inner-spin-button{\n\t\t-webkit-appearance:none;\n\t\tmargin:0;\n\t}\n";
var styles$d = {
  "percentage": "ff_v4340__Percentage__percentage__1V0"
};
...
var css_248z$c = ".ff_v4340__Pipelines__select__3hr{\n\twidth:100%;\n}\n";
var styles$c = {
  "select": "ff_v4340__Pipelines__select__3hr"
};
...
var css_248z$b = ".ff_v4340__PipelinesAndStages__label__3h1{\n\tmargin-bottom:4px;\n\tcolor:#747678;\n}\n.ff_v4340__PipelinesAndStages__noStagesMessage__3Vr{\n\twidth:100%;\n\theight:20px;\n\tpadding:4px;\n\tpadding-left:0;\n}\n.ff_v4340__PipelinesAndStages__noStagesErrorMessage__3CH{\n\tborder:1px solid #f94839;\n\tcolor:#f94839;\n\tpadding-left:4px;\n\tmargin-bottom:4px;\n}\n";
var styles$b = {
  "label": "ff_v4340__PipelinesAndStages__label__3h1",
  "noStagesMessage": "ff_v4340__PipelinesAndStages__noStagesMessage__3Vr",
  "noStagesErrorMessage": "ff_v4340__PipelinesAndStages__noStagesErrorMessage__3CH"
};
...
var isPipelinesOrStagesEmpty = function isPipelinesOrStagesEmpty(value) {
...
var css_248z$a = ".ff_v4340__RadioGroup__wrapper__1pr{\n\tborder:none;\n}\n\n\t.ff_v4340__RadioGroup__wrapper__1pr legend{\n\t\tfont:400 15px/20px 'Source Sans Pro',sans-serif;\n\t\tpadding:0;\n\t\tmargin:0 0 4px;\n\t\tcolor:#26292c;\n\t}\n\n\t.ff_v4340__RadioGroup__wrapper__1pr label{\n\t\tmargin-right:8px;\n\t}\n";
var styles$a = {
  "wrapper": "ff_v4340__RadioGroup__wrapper__1pr"
};
...
var css_248z$9 = ".ff_v4340__CheckboxGroup__wrapper__cK0{\n\tborder:none;\n}\n\n\t.ff_v4340__CheckboxGroup__wrapper__cK0 legend{\n\t\tfont:400 15px/20px 'Source Sans Pro',sans-serif;\n\t\tpadding:0;\n\t\tmargin:0 0 4px;\n\t\tcolor:#26292c;\n\t}\n\n\t.ff_v4340__CheckboxGroup__wrapper__cK0 label{\n\t\tmargin-right:8px;\n\t}\n";
var styles$9 = {
  "wrapper": "ff_v4340__CheckboxGroup__wrapper__cK0"
};
...
var css_248z$8 = ".ff_v4340__SingleOption__wrapper__2z1{\n\twidth:100%;\n}\n.ff_v4340__SingleOption__error__2-J{\n\tborder:1px solid #f94839;\n\tborder-right:none;\n\tbox-shadow:none !important;\n}\n.ff_v4340__SingleOption__error__2-J:last-of-type{\n\t\tborder-right:1px solid #f94839;\n\t}\n.ff_v4340__SingleOption__error__2-J > span{\n\t\tbox-shadow:none;\n\t}\n.ff_v4340__SingleOption__button__2Uw span{\n\t\tpadding:0;\n\t\tcolor:rgba(38,41,44,.64);\n\t}\n.ff_v4340__SingleOption__button__2Uw span:last-child{\n\t\tpadding-right:0;\n\t}\n.ff_v4340__SingleOption__button__2Uw span:first-child{\n\t\tpadding-left:0;\n\t}\n";
var styles$8 = {
  "wrapper": "ff_v4340__SingleOption__wrapper__2z1",
  "error": "ff_v4340__SingleOption__error__2-J",
  "button": "ff_v4340__SingleOption__button__2Uw"
};
...
var css_248z$7 = ".ff_v4340__TimePicker__popper__hlr[data-placement^='bottom']{\n\t\tmargin-top:0;\n\t}\n\t.ff_v4340__TimePicker__popper__hlr[data-placement]{\n\t\tz-index:6001;\n\t}\n\t.ff_v4340__TimePicker__errorWrapper__1Tv{\n\tborder:1px solid;\n\tborder-color:#f94839 !important;\n}\n\t.ff_v4340__TimePicker__errorMsg__K-k{\n\tcolor:#f94839;\n\tmargin-top:4px;\n\tfont-size:13px;\n}\n\t.ff_v4340__TimePicker__input__9pn .react-datepicker-wrapper, .ff_v4340__TimePicker__input__9pn .react-datepicker__input-container{\n\t\t\twidth:100%;\n\t\t}\n\t.ff_v4340__TimePicker__input__9pn .react-datepicker-wrapper input:disabled, .ff_v4340__TimePicker__input__9pn .react-datepicker__input-container input:disabled{\n\t\t\t\tbackground-color:#f7f7f7;\n\t\t\t}\n\t.ff_v4340__TimePicker__input__9pn .react-datepicker__close-icon::after{\n\t\t\t\tcolor:#747678;\n\t\t\t\tbackground-color:transparent;\n\t\t\t\tfont-size:23px;\n\t\t\t\theight:auto;\n\t\t\t\twidth:auto;\n\t\t\t\ttop:3px;\n\t\t\t\tright:2px;\n\t\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker\\--time-only{\n\t\t\tborder:0 !important;\n\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__header{\n\t\t\theight:69px;\n\t\t\tbackground-color:#ffffff;\n\t\t\tborder:0;\n\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__header\\--time{\n\t\t\t\tdisplay:none;\n\t\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__header\\--time-box{\n\t\t\t\t\twidth:100px;\n\t\t\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__triangle{\n\t\t\tdisplay:none;\n\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__time{\n\t\t\twidth:100px !important;\n\t\t\tborder-radius:0;\n\t\t\tborder:1px solid #b9babb;\n\t\t\tbox-shadow:0 5px 15px -5px #747678;\n\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__time-container{\n\t\t\t\tborder:0;\n\t\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__time-box{\n\t\t\t\tborder-radius:0;\n\t\t\t\twidth:100px !important;\n\t\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__time-list-item{\n\t\t\t\theight:auto !important;\n\t\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__time-list-item\\--selected{\n\t\t\t\t\tbackground-color:#317ae2 !important;\n\t\t\t\t}\n\t.ff_v4340__TimePicker__timepicker__98G .react-datepicker__time-list-item:hover{\n\t\t\t\t\tbackground-color:#317ae2 !important;\n\t\t\t\t\tcolor:#ffffff;\n\t\t\t\t}\n";
var styles$7 = {
  "popper": "ff_v4340__TimePicker__popper__hlr",
  "errorWrapper": "ff_v4340__TimePicker__errorWrapper__1Tv",
  "errorMsg": "ff_v4340__TimePicker__errorMsg__K-k",
  "input": "ff_v4340__TimePicker__input__9pn",
  "timepicker": "ff_v4340__TimePicker__timepicker__98G"
};
...
var css_248z$6 = ".ff_v4340__User__user__1u1{\n\twidth:100%;\n}\n\n.ff_v4340__User__selectPopup__11D{\n\tz-index:6001;\n}\n";
var styles$6 = {
  "user": "ff_v4340__User__user__1u1",
  "selectPopup": "ff_v4340__User__selectPopup__11D"
};
...
var User = function User(_ref) {
  ...
  var userValue = getValue$3({
    value: isObject$e(value) ? value.id : value,
    defaultValue: isObject$e(defaultValue) ? defaultValue.id : defaultValue,
...
var css_248z$5 = ".ff_v4340__VisibilityIcon__title__2UT{\n\tfont-weight:bold;\n}\n.ff_v4340__VisibilityIcon__svg__3nk{\n\twidth:14px;\n\tmin-width:14px;\n\theight:14px;\n\tmin-height:14px;\n}\n.ff_v4340__VisibilityIcon__fill__3Fd{\n\tfill:rgb(47, 108, 197);\n}\n.ff_v4340__VisibilityIcon__empty__32_{\n\tfill:rgba(38, 41, 44, .24);\n}\n";
var styles$5 = {
  "title": "ff_v4340__VisibilityIcon__title__2UT",
  "svg": "ff_v4340__VisibilityIcon__svg__3nk",
  "fill": "ff_v4340__VisibilityIcon__fill__3Fd",
  "empty": "ff_v4340__VisibilityIcon__empty__32_"
};
...
var css_248z$4 = ".ff_v4340__VisibilityOptions__title__3IN:hover{\n\t\tcolor:#ffffff;\n\t}\n.ff_v4340__VisibilityOptions__selected__1xF{\n\tfont-weight:600;\n}\n.ff_v4340__VisibilityOptions__subTitle__1Nw{\n\tfont-size:13px;\n\tcolor:#747678;\n}\n.ff_v4340__VisibilityOptions__option__1Z4{\n\tcursor:pointer;\n\tdisplay:flex;\n}\n.ff_v4340__VisibilityOptions__option__1Z4:hover .ff_v4340__VisibilityOptions__title__3IN, .ff_v4340__VisibilityOptions__option__1Z4:hover .ff_v4340__VisibilityOptions__subTitle__1Nw{\n\t\t\tcolor:#ffffff;\n\t\t}\n.ff_v4340__VisibilityOptions__option__1Z4:hover .vg__icon--fill{\n\t\t\tfill:rgb(255, 255, 255) !important;\n\t\t}\n.ff_v4340__VisibilityOptions__option__1Z4:hover .vg__icon--empty{\n\t\t\tfill:rgba(38, 41, 44, .32);\n\t\t}\n.ff_v4340__VisibilityOptions__textWrap__2s8{\n\tdisplay:flex;\n\tflex-direction:column;\n\tpadding-left:12px;\n\ttext-align:left;\n}\n.ff_v4340__VisibilityOptions__icon__2PQ{\n\tdisplay:flex;\n\tpadding-top:4px;\n}\n";
var styles$4 = {
  "title": "ff_v4340__VisibilityOptions__title__3IN",
  "selected": "ff_v4340__VisibilityOptions__selected__1xF",
  "subTitle": "ff_v4340__VisibilityOptions__subTitle__1Nw",
  "option": "ff_v4340__VisibilityOptions__option__1Z4",
  "textWrap": "ff_v4340__VisibilityOptions__textWrap__2s8",
  "icon": "ff_v4340__VisibilityOptions__icon__2PQ"
};
...
var css_248z$3 = ".ff_v4340__VisibilitySwitch__select__2r7{\n\twidth:100%;\n\talign-items:center;\n\tpadding-left:10px;\n}\n.ff_v4340__VisibilitySwitch__select__2r7 span{\n\t\ttext-align:left;\n\t\tfont-weight:400;\n\t}\n.ff_v4340__VisibilitySwitch__icon__1TH{\n\tpadding-right:8px;\n}\n";
var styles$3 = {
  "select": "ff_v4340__VisibilitySwitch__select__2r7",
  "icon": "ff_v4340__VisibilitySwitch__icon__1TH"
};
...
var css_248z$2 = ".ff_v4340__ActionFooter__footerWrapper__2mX{\n\tmargin-top:8px;\n\talign-self:flex-end;\n}\n\n\t.ff_v4340__ActionFooter__footerWrapper__2mX .ff_v4340__ActionFooter__saveButton__2Ix{\n\t\tmargin-left:4px;\n\t}\n";
var styles$2 = {
  "footerWrapper": "ff_v4340__ActionFooter__footerWrapper__2mX",
  "saveButton": "ff_v4340__ActionFooter__saveButton__2Ix"
};
...
var css_248z$1 = ".ff_v4340__ComponentState__wrapperAdd__1hg .ff_v4340__ComponentState__addValue__1BG{\n\tfont:600 15px/20px 'Source Sans Pro', sans-serif;\n\tcolor:#317ae2;\n\ttext-decoration:none;\n}\n.ff_v4340__ComponentState__wrapperEdit__2hf{\n\tposition:relative;\n\tdisplay:flex;\n\talign-items:center;\n\twidth:100%;\n\tjustify-content:space-between;\n}\n.ff_v4340__ComponentState__wrapperEdit__2hf .ff_v4340__ComponentState__edit__30n{\n\t\tvisibility:hidden;\n\t}\n.ff_v4340__ComponentState__wrapperEdit__2hf .ff_v4340__ComponentState__cuiText__2C2{\n\t\twidth:100%;\n\t}\n.ff_v4340__ComponentState__wrapperEdit__2hf .ff_v4340__ComponentState__addValue__1BG{\n\t\tvisibility:hidden;\n\t\twidth:100%;\n\t\tdisplay:inline-block;\n\t}\n.ff_v4340__ComponentState__wrapperEdit__2hf .ff_v4340__ComponentState__valueText__13q{\n\t\tword-break:break-word;\n\t}\n.ff_v4340__ComponentState__wrapperEdit__2hf .ff_v4340__ComponentState__showValue__W4L{\n\t\twidth:100%;\n\t\tmargin-right:8px;\n\t}\n.ff_v4340__ComponentState__wrapperEdit__2hf:hover .ff_v4340__ComponentState__edit__30n{\n\t\t\tvisibility:visible;\n\t\t}\n.ff_v4340__ComponentState__wrapperEdit__2hf:hover .ff_v4340__ComponentState__icon__e8A{\n\t\t\tvisibility:hidden;\n\t\t}\n.ff_v4340__ComponentState__wrapperAdd__1hg{\n\tdisplay:flex;\n\talign-items:baseline;\n}\n.ff_v4340__ComponentState__wrapperAdd__1hg .ff_v4340__ComponentState__addValue__1BG{\n\t\tvisibility:hidden;\n\t\tcursor:pointer;\n\t}\n.ff_v4340__ComponentState__wrapperAdd__1hg .ff_v4340__ComponentState__placeholder__5aG{\n\t\tposition:absolute;\n\t\tcolor:#b9babb;\n\t}\n.ff_v4340__ComponentState__wrapperAdd__1hg:hover .ff_v4340__ComponentState__addValue__1BG{\n\t\t\tvisibility:visible;\n\t\t}\n.ff_v4340__ComponentState__wrapperAdd__1hg:hover .ff_v4340__ComponentState__placeholder__5aG{\n\t\t\tvisibility:hidden;\n\t\t}\n.ff_v4340__ComponentState__wrapperAdd__1hg:hover .ff_v4340__ComponentState__showValue__W4L{\n\t\t\tdisplay:none;\n\t\t}\n.ff_v4340__ComponentState__alignCenter__1AD{\n\tdisplay:flex;\n\talign-items:center;\n}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__name__31Y{\n\t\tflex:2;\n\t\tjustify-content:flex-end;\n\t\tmargin-right:8px;\n\t\tfont-size:13px;\n\t\tfont-weight:600;\n\t}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__field__3EV{\n\t\tflex:3;\n\t\tdisplay:flex;\n\t\tflex-direction:column;\n\t\tjustify-content:center;\n\t}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__fieldIcon__2sQ{\n\t\tmargin-right:8px;\n\t}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__dot__2Md{\n\t\tmargin-right:8px;\n\t\twidth:9px;\n\t\theight:9px;\n\t\tflex:none;\n\t}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__dot__2Md.ff_v4340__ComponentState__red__25L{\n\t\t\tbackground-color:#f94839;\n\t\t\tborder-radius:50%;\n\t\t}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__dot__2Md.ff_v4340__ComponentState__yellow__32Y{\n\t\t\tbackground-color:#ffcc00;\n\t\t\tborder-radius:50%;\n\t\t}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__dndicon__3Wa{\n\t\topacity:0;\n\t\tmargin-left:16px;\n\t}\n.ff_v4340__ComponentState__sidebarField__usY .ff_v4340__ComponentState__leftSection__3T8{\n\t\theight:32px;\n\t\tdisplay:flex;\n\t\tmargin-bottom:auto;\n\t}\n.ff_v4340__ComponentState__sidebarField__usY:hover .ff_v4340__ComponentState__dndicon__3Wa{\n\t\t\topacity:1;\n\t\t\tcursor:pointer;\n\t\t}\n";
var styles$1 = {
  "wrapperEdit": "ff_v4340__ComponentState__wrapperEdit__2hf",
  "edit": "ff_v4340__ComponentState__edit__30n",
  "cuiText": "ff_v4340__ComponentState__cuiText__2C2",
  "addValue": "ff_v4340__ComponentState__addValue__1BG",
  "valueText": "ff_v4340__ComponentState__valueText__13q",
  "showValue": "ff_v4340__ComponentState__showValue__W4L",
  "icon": "ff_v4340__ComponentState__icon__e8A",
  "wrapperAdd": "ff_v4340__ComponentState__wrapperAdd__1hg",
  "placeholder": "ff_v4340__ComponentState__placeholder__5aG",
  "alignCenter": "ff_v4340__ComponentState__alignCenter__1AD",
  "sidebarField": "ff_v4340__ComponentState__sidebarField__usY",
  "name": "ff_v4340__ComponentState__name__31Y",
  "field": "ff_v4340__ComponentState__field__3EV",
  "fieldIcon": "ff_v4340__ComponentState__fieldIcon__2sQ",
  "dot": "ff_v4340__ComponentState__dot__2Md",
  "red": "ff_v4340__ComponentState__red__25L",
  "yellow": "ff_v4340__ComponentState__yellow__32Y",
  "dndicon": "ff_v4340__ComponentState__dndicon__3Wa",
  "leftSection": "ff_v4340__ComponentState__leftSection__3T8"
};
...
var SidebarField = function SidebarField(_ref2) {
  var name = _ref2.name,
      icon = _ref2.icon,
      dot = _ref2.dot,
...
var format = function format(value, formatter, currency) {
  if (formatter) {
    ...
    return formatter.formatNumber(toString$c(value));
  }
...
var css_248z = ".ff_v4340__Category__wrapper__2Wj{\n\twidth:100%;\n}\n.ff_v4340__Category__editButton__21Z{\n\tdisplay:none;\n\tposition:absolute;\n\ttop:4px;\n\tright:12px;\n\tz-index:1;\n}\n.ff_v4340__Category__option__3D7{\n\tdisplay:flex;\n\tjustify-content:space-between;\n}\n.ff_v4340__Category__option__3D7:hover .ff_v4340__Category__editButton__21Z{\n\t\t\tdisplay:flex;\n\t\t}\n.ff_v4340__Category__section__eOG{\n\tdisplay:flex;\n\talign-items:center;\n\tjustify-content:space-between;\n\tflex:1;\n}\n.ff_v4340__Category__saveButton__3FH{\n\tmargin-left:8px;\n}\n";
var styles = {
  "wrapper": "ff_v4340__Category__wrapper__2Wj",
  "editButton": "ff_v4340__Category__editButton__21Z",
  "option": "ff_v4340__Category__option__3D7",
  "section": "ff_v4340__Category__section__eOG",
  "saveButton": "ff_v4340__Category__saveButton__3FH"
};
