...
export function VerticalPricingAddOnCard({
  addOnPricingModal,
  banner,
  closeModal,
  cta,
  ...
  return (
    <>
      ...
      <div className="addon-card">
        ...
        {/* Header w/ Icon & Headline */}
        <div className="addon-card__header">
          <div>{image && <img src={image} alt="" className="addon-card__icon" />}</div>
          <h3 className="addon-card__headline">
