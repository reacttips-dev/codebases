...
var LanguageServiceDefaultsImpl = /** @class */ (function () {
    function LanguageServiceDefaultsImpl(compilerOptions, diagnosticsOptions) {
        ...
        this._onDidInstanceLibsChange = new Emitter();
        this._extraLibs = Object.create(null);
        this._instanceLibs = new Map();
    ...
    Object.defineProperty(LanguageServiceDefaultsImpl.prototype, "onDidInstanceLibsChange", {
        get: function () {
    ...
    LanguageServiceDefaultsImpl.prototype.setInstanceLibs = function (id, instanceLibs) {
        var _this = this;
        this._instanceLibs.set(id, instanceLibs);
        this._fireOnDidInstanceLibsChangeSoon();
        return {
            dispose: function () {
                if (!_this._instanceLibs.has(id)) {
                    return;
                }
                _this._instanceLibs.delete(id);
                _this._fireOnDidInstanceLibsChangeSoon();
            }
        };
    };
    LanguageServiceDefaultsImpl.prototype.getAllInstanceLibs = function () {
    ...
    LanguageServiceDefaultsImpl.prototype._fireOnDidInstanceLibsChangeSoon = function () {
        var _this = this;
        if (this._onDidInstanceLibsChangeTimeout !== -1) {
            // already scheduled
            return;
        }
        this._onDidInstanceLibsChangeTimeout = setTimeout(function () {
            _this._onDidInstanceLibsChangeTimeout = -1;
            _this._onDidInstanceLibsChange.fire(undefined);
        }, 0);
    };
