...
var WorkerManager = /** @class */ (function () {
    function WorkerManager(modeId, defaults) {
        ...
        this._instanceLibsChangeListener = this._defaults.onDidInstanceLibsChange(function () { return _this._updateInstanceLibs(); });
    }
    ...
    WorkerManager.prototype._updateInstanceLibs = function () {
        return __awaiter(this, void 0, void 0, function () {
            var myToken, proxy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        myToken = ++this._updateInstanceLibsToken;
                        return [4 /*yield*/, this._worker.getProxy()];
                    case 1:
                        proxy = _a.sent();
