...
var View = /** @class */ (function (_super) {
    ...
    function View(commandDelegate, configuration, themeService, model, cursor, outgoingEvents, overflowWidgetsDomNode) {
        ...
        // Postman Changelog - 03-09-2020
        // Add content widgets to the supplied dom node or else append to the view itself
        if (overflowWidgetsDomNode) {
            overflowWidgetsDomNode.appendChild(_this.contentWidgets.overflowingContentWidgetsDomNode.domNode);
        }
        else {
    ...
    View.prototype.dispose = function () {
        ...
        this.contentWidgets.overflowingContentWidgetsDomNode.domNode.remove();
