...
var LanguageServiceDefaultsImpl = /** @class */ (function () {
    function LanguageServiceDefaultsImpl(languageId, diagnosticsOptions, modeConfiguration, instanceSettings) {
...
var instanceSettingsJsonDefault = {
    settings: {}
};
var instanceSettingsPostmanJsonDefault = {
    settings: {}
};
var postmanJsonDefaults = new LanguageServiceDefaultsImpl('postman_json', diagnosticDefault, modeConfigurationDefault, instanceSettingsPostmanJsonDefault);
var jsonDefaults = new LanguageServiceDefaultsImpl('json', diagnosticDefault, modeConfigurationDefault, instanceSettingsJsonDefault);
// Export API
function createAPI() {
    return {
        jsonDefaults: jsonDefaults,
        postmanJsonDefaults: postmanJsonDefaults
    };
}
monaco.languages.postman_json = createAPI();
...
monaco.languages.onLanguage('postman_json', function () {
    getMode().then(function (mode) { return mode.setupMode(postmanJsonDefaults); });
});
