...
export class TopReferralsDashboardTableWidgetFilters extends InjectableComponent {
    protected i18n;
    ...
    constructor(props) {
        ...
        this.getSelectedFilters("fromState") &&
            props.changeFilter(this.getSelectedFilters("fromState"));
    }
