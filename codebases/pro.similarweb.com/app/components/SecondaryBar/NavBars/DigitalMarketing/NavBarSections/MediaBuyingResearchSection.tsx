...
import { navObj } from "pages/digital-marketing/config/navigation/mediaBuyingResearchNavObj";
...
const MEDIA_BUYING_RESEARCH_STATE_ID = "mediabuyingresearch_home";

interface IMediaBuyingResearchSectionProps {
    currentPage: string;
...
export const MediaBuyingResearchSection: FC<IMediaBuyingResearchSectionProps> = ({
    currentPage,
    navigator,
    rootScope,
    onSectionClick,
    ...
    useEffect(() => {
        currentSection &&
            currentSection !== MEDIA_BUYING_RESEARCH_STATE_ID &&
    ...
    return sectionItems?.length > 0 ? (
        <NavBarHomepageItem
            id={MEDIA_BUYING_RESEARCH_STATE_ID}
            text={i18n("aquisitionintelligence.navbar.mediabuyingresearch.header")}
