...
class GooglePlayFormNumericPromptController extends GooglePlayFormBase {
...
class GooglePlayFormNumericPromptComponent implements angular.IComponentOptions {
    public bindings: any;
    ...
    constructor() {
        ...
        this.templateUrl =
            "/app/components/google-play-wizard/google-play-form/google-play-form-numeric-prompt-template.html";
        this.controller = "googlePlayFormNumericPromptController";
    }
}
angular
    .module("sw.common")
    .component("googlePlayFormNumericPrompt", new GooglePlayFormNumericPromptComponent());
angular
    .module("sw.common")
    .controller(
        "googlePlayFormNumericPromptController",
        GooglePlayFormNumericPromptController as ng.Injectable<ng.IControllerConstructor>,
    );
