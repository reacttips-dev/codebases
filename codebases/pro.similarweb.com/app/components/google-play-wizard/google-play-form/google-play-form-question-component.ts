...
class GooglePlayFormQuestionController extends GooglePlayFormBase {
...
class GooglePlayFormQuestionComponent implements angular.IComponentOptions {
    public bindings: any;
    ...
    constructor() {
        ...
        this.templateUrl =
            "/app/components/google-play-wizard/google-play-form/google-play-form-question-template.html";
        this.controller = "googlePlayFormQuestionController";
    }
}
angular
    .module("sw.common")
    .component("googlePlayFormQuestion", new GooglePlayFormQuestionComponent());
angular
    .module("sw.common")
    .controller(
        "googlePlayFormQuestionController",
        GooglePlayFormQuestionController as ng.Injectable<ng.IControllerConstructor>,
    );
