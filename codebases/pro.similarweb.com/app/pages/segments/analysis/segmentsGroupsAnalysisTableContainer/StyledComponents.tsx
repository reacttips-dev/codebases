...
export const SegmentCellContainer = styled.div<{ withSegment: boolean }>`
    margin-top: ${({ withSegment }) => (withSegment ? "-7px" : "-2px")};
`;
...
export const SegmentsAnalysisTableTopWrapper = styled.div`
    display: flex;
...
`;
SegmentsAnalysisTableTopWrapper.displayName = "SegmentsAnalysisTableTopWrapper";
