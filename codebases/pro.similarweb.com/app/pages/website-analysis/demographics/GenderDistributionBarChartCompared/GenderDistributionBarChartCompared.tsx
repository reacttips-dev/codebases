...
import { getBarChartConfig, multipleDomainsTooltipFormatter } from "./GenderBarChartComparedConfig";
...
interface IGenderDistributionBarChartComparedProps {
    data: any;
    keys: [];
    isLoading?: boolean;
}

export const GenderDistributionBarChartCompared: FunctionComponent<IGenderDistributionBarChartComparedProps> = (
    props,
) => {
    ...
    const lagendToggleHandler = useCallback((filterData) => {
            ...
            <ChartContainer ref={chartRef}>
                <TitleContainer>
                    <FlexColumn>
                        <StyledHeaderTitle>
                            <BoxTitle
                                tooltip={i18nFilter()("webdemographics.piechart.title.tooltip")}
                            >
                                {i18nFilter()(
