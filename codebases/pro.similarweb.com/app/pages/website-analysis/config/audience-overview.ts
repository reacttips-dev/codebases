...
let getWidgets = (mode, showBetaBranchData) => {
    ...
    var visitsTable = {
        type: "Table",
        ...(showBetaBranchData && { usingBetaBranchData: true }),
        properties: {
            metric: "EngagementVisits",
            type: "Table",
            width: "4",
            ...
            apiParams: addBetaBranchParam({}, showBetaBranchData, false),
            options: {
                showTitle: true,
                showTitleTooltip: true,
                titleType: "text",
                ...
                hideBorders: true,
                titleIcon: true,
                ...(showBetaBranchData && { canAddToDashboard: false }),
            },
            columns: [
                {
                    field: "Domain",
    ...
    const visitsOverviewWithBeta = {
        componentType: "swReact",
        componentName: "AudienceWidgetSingleWithBeta",
        ...
        tableDataColumns: [
            {
                field: "TotalVisits",
                displayName: "Visits",
                cellTemplate: "default-cell-right-align",
                headerCellTemplate: "default-cell-header-right-align",
                format: "minVisitsAbbr",
            },
        ],
    };

    const visitsShareWithBeta = {
        componentType: "swReact",
        componentName: "AudienceWidgetSingleWithBeta",
        apiController: "WebsiteOverview",
        apiWidgetType: "Table",
        tableDataColumns: [
            {
                ...
                headerCellTemplate: "desktop-mobile-header-cell",
                headerCellClass: "u-no-pointer-events",
                showTotalCount: false,
                cellClass: "no-ga-verified-icon",
                normalizeValueForComparison: (value) => value[0],
            },
        ],
    };
    ...
    const presets = {
        single: [
            showBetaBranchData
                ? {
                      ...visitsOverviewWithBeta,
                      original: visitsSingleMetric,
                  }
                : visitsSingleMetric,
            showBetaBranchData
                ? {
...
export const AudienceOverviewWidgets = getWidgets;
