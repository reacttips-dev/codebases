...
export const CreativesGallery = (props: IGalleryProps) => {
    const {
        initialTilesList,
        webSource,
        onSortChange,
    ...
    const getOrderButton = () => {
        const onOrderChange = (value) => {
            ...
            TrackWithGuidService.trackWithGuid(
                "websiteanalysis.trafficsources.ads.creatives.sort.direction.filter",
                "click",
                { direction: sortValue },
            );
        };
    ...
    const getDropdown = () => {
        const onDropdownChanged = (value) => {
            ...
            TrackWithGuidService.trackWithGuid(
                "websiteanalysis.trafficsources.ads.creatives.sort.filter",
                "click",
                { kind: value.children },
            );
        };
