...
import { IVideosOverview } from "pages/website-analysis/traffic-sources/display-ads/common/displayAdsTypes";
...
export const OnLoaded: React.FC<IVideosOverview> = ({
    totalCampaigns,
    totalVideos,
    isLoading,
    onExcelDownload,
    ...
    const items = [
        ...
        },
        {
            key: "videos",
            value: totalVideos,
            i18nKey: "traffic.sources.videos.overview.header.videos",
        },
    ];
...
export const VideosOverview: FC<IVideosOverview> = (props) => (
