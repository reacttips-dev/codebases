...
////////////   AdSpend Transformation Helper Functions //////////
...
export const transformAdSpendData = ({ isSingle, key, adSpendData }) =>
    isSingle
        ? fillNoValueInBreakDownInSingleMode(adSpendData)
        : fillNoValueForSitesInBreakDownInCompareMode(key, adSpendData);
