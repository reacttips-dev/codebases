...
const defaultAffiliatePageState = "affiliateanalysis_performanceoverview";
...
const PlaceholderComponent = (): JSX.Element => (
    <PlaceholderText>
        {translate("aquisitionintelligence.affiliateresearch.analyze.home.searchText")}{" "}
        <BoldPlaceholderText>
            {translate("aquisitionintelligence.affiliateresearch.analyze.home.searchItem")}
        </BoldPlaceholderText>
    </PlaceholderText>
);
...
export const AffiliateResearchAnalyzeAffiliateHomepage: React.SFC = () => {
    ...
    return (
        <UseCaseHomePage
            ...
            title={translate("aquisitionintelligence.affiliateresearch.analyze.home.title")}
            subtitle={translate("aquisitionintelligence.affiliateresearch.analyze.home.subtitle")}
            bodyText={translate("aquisitionintelligence.affiliateresearch.analyze.home.listTitle")}
...
SWReactRootComponent(
    AffiliateResearchAnalyzeAffiliateHomepage,
    "AffiliateResearchAnalyzeAffiliateHomepage",
);
