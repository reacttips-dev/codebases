...
const onItemClick = (keyword) => {
    TrackWithGuidService.trackWithGuid("monitor.keyword.list.page.keyword.click", "click", {
        keyword,
    });
};
export const MonitorKeywordsGroupTableSettings = {
