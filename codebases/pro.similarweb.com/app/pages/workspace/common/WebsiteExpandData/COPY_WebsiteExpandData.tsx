...
import { selectTab } from "../actions_creators/COPY_common_worksapce_action_creators";
import { ANALYSIS_TAB, DASHBOARDS_TAB, FEED_TAB, LIST_SETTING_FEED } from "../consts";
import { availableTab, ISelectedSite } from "../reducers/COPY_common_workspace_reducer";
import { selectActiveOpportunityList } from "../selectors";
import { IOpportunityListItem } from "../types";
import { Tab } from "./Tab";
import { AnalysisTab } from "./Tabs/COPY_AnalysisTab";
import { DashboardsTab } from "./Tabs/COPY_DashboardsTab";
...
interface IWebsiteExpandDataProps {
    ...
    getExcelTableRowHref(params: any): string;
...
> {
    ...
    public setRef = (el: any) => (this.el = el);
...
const mapStateToProps = ({ legacySalesWorkspace }: RootState) => ({
    ...
    selectedDomain: legacySalesWorkspace.selectedDomain,
    activeListId: legacySalesWorkspace.activeListId,
    activeWorkspaceId: legacySalesWorkspace.activeWorkspaceId,
    lastSnapshotDate: legacySalesWorkspace.lastSnapshotDate,
    selectedTab: legacySalesWorkspace.selectedTab,
    previouslySelectedTab: legacySalesWorkspace.previouslySelectedTab,
    unsupportedFeatures: legacySalesWorkspace.unsupportedFeatures,
});
