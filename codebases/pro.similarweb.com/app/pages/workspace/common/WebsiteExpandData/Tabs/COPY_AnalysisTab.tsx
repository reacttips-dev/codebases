...
const TopGeoSubtitle = styled.div`
    display: flex;
    align-items: center;
...
const Icon = styled(SWReactIcons)`
    ...
    margin-right: 4px;
`;
const WebSource = styled(FlexRow)`
    align-items: center;
    margin-left: 8px;
`;
...
const Ranks = ({ GlobalRank, Country, CountryRank, Category, CategoryRank }: any) => {
    let countryIcon = "";
...
const mapStateToProps = ({ legacySalesWorkspace }: RootState) => {
    ...
    return {
        isEnrichedDataLoading: legacySalesWorkspace.isEnrichedDataLoading,
        ...
        graphsData: _.get(legacySalesWorkspace, "selectedDomain.enrichedData.metrics", {}),
        isRanksDataLoading: legacySalesWorkspace.isRanksDataLoading,
        ranksData: _.get(legacySalesWorkspace, "selectedDomain.ranksData", {}),
