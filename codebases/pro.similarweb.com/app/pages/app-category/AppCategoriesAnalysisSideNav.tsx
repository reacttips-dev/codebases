...
import { navObj } from "./config/appCategoriesAnalysisNavObj";

class AppCategoriesAnalysisSideNav extends PureComponent<ISideNavProps, ISideNavState> {
    ...
    public render() {
        return (
            <SideNav>
                <SideNavList persistenceKey={"appcategory"} navItems={this.state.items}>
                    <SideNavListScrollSpace />
                </SideNavList>
            </SideNav>
        );
...
SWReactRootComponent(
    connect(mapStateToProps, mapDispatchToProps)(AppCategoriesAnalysisSideNav),
    "AppCategoriesAnalysisSideNav",
);

export default AppCategoriesAnalysisSideNav;
