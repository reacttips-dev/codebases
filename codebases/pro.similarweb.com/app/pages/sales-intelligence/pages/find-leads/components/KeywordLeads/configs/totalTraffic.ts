...
import { LinkCell } from "components/React/Table/cells/LinkCell";
import {
...
// TODO fix values
export const totalTrafficMetaData = {
    tableApi: `/widgetApi/KeywordAnalysisOP/KeywordAnalysisTotal/Table`,
    excelApi: `/widgetApi/KeywordAnalysisOP/KeywordAnalysisTotal/Excel`,
    i18nPrefix: `analysis.competitors.search.organic.table`,
    metric: `KeywordCompetitorsOrganicTable`,
    tableSelectionTracking: `Total Traffic`,
    tableSelectionKey: "KeywordCompetitorsOrganicTable",
    a2dMetric: `TopOrganicSearchCompetitors`,
    searchTypeFilterPlaceholder: "All Search Types",
    searchTypeParam: "organicSearchType",
    searchTypes: [],
    title: "",
};

export const totalTrafficFilters = {
