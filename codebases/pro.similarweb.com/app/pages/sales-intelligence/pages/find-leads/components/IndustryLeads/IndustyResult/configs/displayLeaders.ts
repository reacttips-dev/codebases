...
export const displayLeadersMetaData: TableMetaDataConfig = {
    tableApi: `/widgetApi/CategoryLeaders/CategoryLeadersAds/Table`,
    excelApi: `/widgetApi/CategoryLeaders/CategoryLeadersAds/Excel`,
