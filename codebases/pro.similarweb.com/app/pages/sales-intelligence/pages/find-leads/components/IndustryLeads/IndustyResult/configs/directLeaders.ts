...
export const directLeadersMetaData: TableMetaDataConfig = {
    tableApi: `/widgetApi/CategoryLeaders/CategoryLeadersDirect/Table`,
    excelApi: `/widgetApi/CategoryLeaders/CategoryLeadersDirect/Excel`,
...
export const directLeadersFilters = {
