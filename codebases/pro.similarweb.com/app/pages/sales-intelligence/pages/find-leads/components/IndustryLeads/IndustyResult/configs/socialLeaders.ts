...
export const socialLeadersMetaData: TableMetaDataConfig = {
    tableApi: `/widgetApi/CategoryLeaders/CategoryLeadersSocial/Table`,
    excelApi: `/widgetApi/CategoryLeaders/CategoryLeadersSocial/Excel`,
...
export const socialLeadersFilters = {
