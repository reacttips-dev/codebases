...
const TABLE_SELECTION_KEY = "keywordAnalysis.total.dri.traffic_KeywordAnalysisOrganic_Table";
const Total = ({ params, sites }) => {
    ...
    return (
        <>
            <RelatedSearchTerms
                params={commonProps.queryParams}
                isBannerVisible={!commonProps.isKeywordsGroup}
            />
            <HeaderComponents
...
export const KeywordAnalysisTotalPageDri = connect(mapStateToProps)(Total);

SWReactRootComponent(KeywordAnalysisTotalPageDri, "KeywordAnalysisTotalPageDri");
