...
import { KeywordsGeoTableStyle } from "./KeywordsGeoPageDri.styles";
        ...
        return (
            <>
                <RelatedSearchTerms
                    ...
                    isBannerVisible={!isKeywordGroup}
                />
...
SWReactRootComponent(connect(mapStateToProps)(KeywordsGeoPagePreLoad), "KeywordsGeoPageDri");
