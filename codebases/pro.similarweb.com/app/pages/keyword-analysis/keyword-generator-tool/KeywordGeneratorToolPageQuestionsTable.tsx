...
class KeywordGeneratorToolPageQuestionsTable extends KeywordGeneratorToolPageTableBase {
    protected tableSettings = CommonTableSettings;
    protected tableApiUrl = `/api/recommendations/keywords/similarQuestions/10`;
    protected tableApiExcelUrl = `/api/recommendations/keywords/similarQuestions/10/excel`;
    protected tableStorageKey = "KeywordGeneratorToolQuestionTable";
    protected dropdownAppendTo = ".fourthTab .swReactTable-header-wrapper";
