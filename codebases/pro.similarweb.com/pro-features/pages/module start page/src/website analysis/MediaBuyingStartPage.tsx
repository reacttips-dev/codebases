...
interface IMediaBuyingStartPageProps {
...
export const MediaBuyingStartPage: FunctionComponent<IMediaBuyingStartPageProps> = ({
    ...
    const onClickCategory = (category: ICategory) => {
        ...
        if (category.isCustomCategory) {
            TrackWithGuidService.trackWithGuid(
                "marketingintelligence.mediabuying.homepage.custom.industry.select",
                "click",
                { SelectedCustomIndustry: category.text },
            );
        } else {
            TrackWithGuidService.trackWithGuid(
                "marketingintelligence.mediabuying.homepage.industry.select",
                "click",
    ...
    const onMainSiteAdd = (item) => {
        if (item.allies) {
            ...
            TrackWithGuidService.trackWithGuid(
                "marketingintelligence.mediabuying.homepage.competition.first.competitors",
                "click",
            );
        } else {
            setMainSite(item);
            TrackWithGuidService.trackWithGuid(
                "marketingintelligence.mediabuying.homepage.competition.first.competitor",
                "click",
            );
        }
    };
    ...
    const onCompareSitesAdd = (item) => {
        ...
        TrackWithGuidService.trackWithGuid(
            "marketingintelligence.mediabuying.homepage.competition.competitors.button",
            "click",
        );
    };
    ...
    const onTabChange = (index) => {
        TrackWithGuidService.trackWithGuid(
            "marketingintelligence.mediaBuying.homepage.buttons",
            "click",
    ...
    const onFocusWebsite = () => {
        TrackWithGuidService.trackWithGuid(
            "marketingintelligence.mediabuying.homepage.competition.search",
            "open",
        );
    };
    const onFocusIndustry = () => {
        TrackWithGuidService.trackWithGuid(
            "marketingintelligence.mediabuying.homepage.industry.search",
            "open",
        );
    };
    return (
        <TabbedUseCaseHomepage
            title={i18n("aquisitionintelligence.mediaBuying.homepage.title")}
            subtitle={i18n("aquisitionintelligence.mediaBuying.homepage.subtitle")}
            subtitlePosition="centered"
            tabsTitle={i18n("aquisitionintelligence.mediaBuying.homepage.tabsTitle")}
            headerImageUrl={SecondaryHomePageHeaderImageUrl}
            onTabChange={onTabChange}
            tabs={[
                {
                    tabTitle: i18n("aquisitionintelligence.mediaBuying.homepage.market.tabTitle"),
                    tabComponent: (
                        <StartPageWrapper>
                            <StartPageInfoWrapper>
                                ...
                                <StartPageInfoText>
                                    {i18n(
                                        "aquisitionintelligence.mediaBuying.homepage.market.infoText",
                                    )}
                                </StartPageInfoText>
                            </StartPageInfoWrapper>
                            <StartPageAutoCompleteWrap>
                                <AutocompleteWebCategories
                                    ...
                                    autocompleteProps={{
                                        ...
                                        placeholder: i18n(
                                            "aquisitionintelligence.mediaBuying.homepage.market.searchPlaceHolder",
                                        ),
                                    }}
                            ...
                            {selectedCategory && (
                                <StartPageFooter>
                                    ...
                                    >
                                        {i18n(
                                            "aquisitionintelligence.mediaBuying.homepage.market.cta",
                                        )}
                                    </IconButton>
                                </StartPageFooter>
                            )}
                ...
                {
                    tabTitle: i18n(
                        "aquisitionintelligence.mediaBuying.homepage.competition.tabTitle",
                    ),
                    tabComponent: (
                        <StartPageWrapper>
                            <StartPageInfoWrapper>
                                ...
                                <StartPageInfoText>
                                    {i18n(
                                        "aquisitionintelligence.mediaBuying.homepage.competition.infoText",
                                    )}
                                </StartPageInfoText>
                            </StartPageInfoWrapper>
                            <StartPageAutoCompleteWrap>
                            ...
                            {mainSite && compareSites.length > 0 && (
                                <StartPageFooter>
                                    ...
                                    >
                                        {i18n(
                                            "aquisitionintelligence.mediaBuying.homepage.competition.cta",
                                        )}
                                    </IconButton>
                                </StartPageFooter>
                            )}
