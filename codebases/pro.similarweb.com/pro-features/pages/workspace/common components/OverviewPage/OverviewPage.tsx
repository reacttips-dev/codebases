...
export interface IQuickLinkData {
    ...
    linkToDashboardTemplate: (templateId, keys, country, opportunityListId, templateTitle) => void;
...
function mapStateToProps({ commonWorkspace }) {
    return {
        opportunityListsFromStore: commonWorkspace?.workspaces?.[0]?.opportunityLists,
    };
}
