...
var initLDClient = function initLDClient(clientSideID, user, reactOptions, options, targetFlags) {
  if (user === void 0) {
    user = {
      anonymous: true
    };
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      allOptions = __assign({
        ...
        wrapperVersion: package_json_1.version
      }, options);
      ...
      , new Promise(function (resolve) {
        ldClient.on('ready', function () {
          ...
          var flags = reactOptions.useCamelCaseFlagKeys ? utils_1.camelCaseKeys(rawFlags) : rawFlags;
          resolve({
            flags: flags,
            ldClient: ldClient
          });
