...
function asyncWithLDProvider(config) {
  return __awaiter(this, void 0, void 0, function () {
    var clientSideID, user, flags, options, userReactOptions, reactOptions, _a, fetchedFlags, ldClient, LDProvider;

    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          clientSideID = config.clientSideID, user = config.user, flags = config.flags, options = config.options, userReactOptions = config.reactOptions;
          reactOptions = __assign(__assign({}, types_1.defaultReactOptions), userReactOptions);
          return [4
          /*yield*/
          , initLDClient_1.default(clientSideID, user, reactOptions, options, flags)];

        case 1:
          _a = _b.sent(), fetchedFlags = _a.flags, ldClient = _a.ldClient;

          LDProvider = function LDProvider(_a) {
