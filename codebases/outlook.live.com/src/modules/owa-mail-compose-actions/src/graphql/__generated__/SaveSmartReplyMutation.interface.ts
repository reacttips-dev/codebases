...
export type SaveSmartReplyMutationVariables = Types.Exact<{
...
export type SaveSmartReplyMutation = (
  { __typename?: 'Mutation' }
  & { saveSmartReply: (
