...
export type SendSmartReplyMutationVariables = Types.Exact<{
...
export type SendSmartReplyMutation = (
  { __typename?: 'Mutation' }
  & { sendSmartReply: (
