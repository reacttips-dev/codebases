...
export type FolderCountsAndPermissionsQueryVariables = Types.Exact<{
  id: Types.Scalars['ID'];
  mailboxInfo: Types.MailboxInfoInput;
}>;


export type FolderCountsAndPermissionsQuery = (
  { __typename?: 'Query' }
  & { folder?: Types.Maybe<(
