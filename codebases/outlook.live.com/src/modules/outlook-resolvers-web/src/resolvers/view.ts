...
import { lazyEmptyViewMutationWeb } from 'empty-view-mutation-web';
import { lazyMarkViewAsReadMutationWeb } from 'mark-view-as-read-mutation-web';
...
export const webResolvers: Resolvers = {
     ...
     */
    Mutation: {
        emptyView: lazyEmptyViewMutationWeb,
        markViewAsRead: lazyMarkViewAsReadMutationWeb,
    },
