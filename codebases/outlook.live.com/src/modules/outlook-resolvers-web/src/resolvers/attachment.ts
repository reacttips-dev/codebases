import { lazyAddAttachmentToDraftWeb } from 'outlook-mail-compose-web';
import type { Resolvers } from 'owa-graph-schema';
import { lazyDeleteAttachmentMutationWeb } from 'deleteattachment-mutation-web';
...
export const webResolvers: Resolvers = {
     ...
     */
    Mutation: {
        addAttachmentToDraft: lazyAddAttachmentToDraftWeb,
        deleteAttachmentFromDraft: lazyDeleteAttachmentMutationWeb,
    },
