    ...
    signalR.fn = signalR.prototype = {
        init: function (url, qs, logging) {
            ...
            this._ = {
                ...
                lastNegotiateAFDRef: null, // AFD X-MS-Edge Ref header for the most recent /negotiate request
                lastNegotiateBEServer: null, // x-beserver header for the most recent /negotiate request
                lastNegotiateTime: null,
                lastNegotiateRequestId: null,
                initFailureTimes: 0, // Number of times that the channel has failed to connect in a row
                reportedInitFailureTimes: 0, // Number of times that we've logged OWA errors for SignalR initialization failures
            };
        ...
        start: function (options, callback) {
            ...
            connection._.negotiateRequest = signalR.transports._logic.ajax(connection, {
                ...
                success: function (result, _, request) {
                    var res,
                        keepAliveData,
                        protocolError,
                        transports = [],
                    ...
                    connection._.lastNegotiateAFDRef =
                        request.getResponseHeader('X-MSEdge-Ref') || 'NONE';
                    connection._.lastNegotiateBEServer = request.getResponseHeader('x-beserver');
                    connection._.lastNegotiateTime = request.getResponseHeader('x-backend-begin');
                    connection._.lastNegotiateRequestId = request.getResponseHeader('request-id');
    ...
    InitHandler.prototype = {
        start: function (transport, onSuccess, onFallback) {
            ...
            that.transportTimeoutHandle = window.setTimeout(function () {
                if (!failCalled) {
                    ...
                    connection._.initFailureTimes += 1;
                    if (
                        window.owaLogSignalRError &&
                        connection._.initFailureTimes > 2 &&
                        connection._.reportedInitFailureTimes < 1
                    ) {
                        window.owaLogSignalRError('connection init timed out', {
                            negotiateAfdRef: connection._.lastNegotiateAFDRef,
                            beServer: connection._.lastNegotiateBEServer,
                            beTime: connection._.lastNegotiateTime,
                            negotiateReqId: connection._.lastNegotiateRequestId,
        ...
        transportFailed: function (transport, error, onFallback) {
            ...
            if (!this.startRequested) {
                ...
                connection.log(
                    transport.name + ' transport failed to connect. Attempting to fall back.'
                );
                onFallback();
