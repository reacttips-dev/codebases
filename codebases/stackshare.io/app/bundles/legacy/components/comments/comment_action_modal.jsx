...
class CommentActionModal extends Component {
  ...
  render() {
    return (
      <div className="comment_action_modal">
        <div onClick={this.cancelFn} className="comment_action_modal__overlay" />
        <div className="comment_action_modal__dialog_wrapper modal-dialog">
