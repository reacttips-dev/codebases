...
//
// Forked from the official plugin here:
// https://github.com/codemirror/CodeMirror/blob/a173882ef0264d5d7b99d70acf42ec855eb4fba2/addon/lint/lint.js
//
// Changes:
// - Linting plugins that return a Promise resolving to a falsy value do not alter
//   existing lint markers (mirroring plugins that return a falsy value).
// - `setLintResults` can be used to manually set linting markers from outside of
//   a linting plugin.
...
(function(mod) {
    ...
    CodeMirror.defineExtension('setLintResults', function(annotations) {
        const cm = this;
        cm.operation(function() {
            updateLinting(cm, annotations);
        });
