...
@media (min-width: 768px) {
    .globalMessageContainer_1BWBm {
        font-size: 14px;
        line-height: 20px;
    }

    .globalMessageContainer_1BWBm p {
        font-size: 14px;
    }
}
...
.globalMessageContainer_1BWBm p,
.globalMessageContainer_1BWBm .contentContainer_oNo6b p {
    font-size: 14px;
    margin: 0 0 8px;
    padding: 0;
}

.globalMessageContainer_1BWBm p:last-child,
.globalMessageContainer_1BWBm .contentContainer_oNo6b p:last-child {
    margin-bottom: 0px;
}

.globalMessageContainer_1BWBm p.message_QjnMB {
    font-weight: 600;
    margin-bottom: 8px;
}

.contentContainer_oNo6b {
    background-color: #fff;
    padding: 16px;
}

.contentContainer_oNo6b a {
    font-size: 14px;
...
.globalMessageContainer_1BWBm :before {
        display: none;
    }
