.modalContainer_3MhuY.defaultTheme_2rsSh .modal {
            border-radius: 2px;
            max-width: 1280px;
            top: 50%;
...
.modalContainer_3MhuY.defaultTheme_2rsSh.visible_80LC6 .modal {
            opacity: 1;
...
.modalContainer_3MhuY.toaster_tclG6 .modal {
            position: fixed;
            top: auto;
            bottom: 0;
            margin: 0 auto;
...
.modalContainer_3MhuY.toaster_tclG6.visible_80LC6 .modal {
            opacity: 1;
            margin-bottom: 0;
            -webkit-transform: translateY(0) scale(1);
                    transform: translateY(0) scale(1);
}
.modalContainer_3MhuY.error-toaster_VlsQO .modal {
            position: fixed;
            top: auto;
            bottom: 0;
            margin: 0 auto;
...
.modalContainer_3MhuY.error-toaster_VlsQO .bgFade {
            background-color: rgba(0, 0, 0, 0);
        }
.modalContainer_3MhuY.error-toaster_VlsQO.visible_80LC6 .modal {
            opacity: 1;
            -webkit-transform: translateY(0) scale(1);
                    transform: translateY(0) scale(1);
}
.modalContainer_3MhuY.error_2WE0v .modal {
            max-width: 640px;
            top: 50%;
            -webkit-transform: translateY(-50%) scale(1.2) translateZ(0px);
                    transform: translateY(-50%) scale(1.2) translateZ(0px);
...
.modalContainer_3MhuY.error_2WE0v .modal h1 {
...
.modalContainer_3MhuY.error_2WE0v .modal .modal-content {
                clear: fix;
                text-align: center;
            }
.modalContainer_3MhuY.error_2WE0v .modal .modal-content p {
                    text-align: left;
                }
.modalContainer_3MhuY.error_2WE0v .modal .body {
                margin-bottom: 24px;
            }
.modalContainer_3MhuY.error_2WE0v .modal .try-again-btn {
                width: 100%;
                margin-bottom: 30px;
            }
.modalContainer_3MhuY.error_2WE0v .modal .back-lnk {
                color: #0046be;
                text-decoration: none;
                font-weight: 600;
            }
.modalContainer_3MhuY.error_2WE0v .modal footer {
                width: auto;
...
.modalContainer_3MhuY.error_2WE0v.visible_80LC6 .modal {
            opacity: 1;
            -webkit-transform: translateY(-50%) scale(1) translateZ(0px);
                    transform: translateY(-50%) scale(1) translateZ(0px);
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
...
.modalContainer_3MhuY.fullscreen_1W8jG {
    z-index: 1060;
    overflow: hidden;
    bottom: auto;
    height: 100%;
}
.modalContainer_3MhuY.fullscreen_1W8jG .modal {
            border-radius: 0px;
            width: 100%;
            height: 100%;
            margin: 0 auto;
...
.modalContainer_3MhuY.fullscreen_1W8jG.visible_80LC6 .modal {
            opacity: 1;
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            max-height: 100%;
}
.modalContainer_3MhuY.fullscreen_1W8jG a[class="closeIcon"] {
        top: 16px;
        z-index: 5;
...
.modalContainer_3MhuY.visible_80LC6 {
            visibility: visible;
}
.modalContainer_3MhuY .bgFade {
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            opacity: 0;
...
.modalContainer_3MhuY .modal a.closeIcon {
                cursor: pointer;
                position: absolute;
                right: 16px;
            }
.modalContainer_3MhuY .modal header {
                padding: 0;
                font-weight: 200;
                margin-bottom: 16px;
                font-size: 20px;
...
.modalContainer_3MhuY.visible_80LC6 .modal {
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
}
.modalContainer_3MhuY.visible_80LC6 .bgFade {
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            opacity: 1;
}
