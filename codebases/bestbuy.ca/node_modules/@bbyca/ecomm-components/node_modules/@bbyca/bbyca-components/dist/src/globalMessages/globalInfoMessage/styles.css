...
@media (min-width: 768px) {
    .globalMessageContainer_wuKTE {
        font-size: 14px;
        line-height: 20px;
    }

    .globalMessageContainer_wuKTE p {
        font-size: 14px;
    }
}
...
.globalMessageContainer_wuKTE p,
.globalMessageContainer_wuKTE .contentContainer_2RFl3 p {
    font-size: 14px;
    margin: 0 0 8px;
    padding: 0;
}

.globalMessageContainer_wuKTE p:last-child,
.globalMessageContainer_wuKTE .contentContainer_2RFl3 p:last-child {
    margin-bottom: 0px;
}

.globalMessageContainer_wuKTE p.message_O3vjh {
    font-weight: 600;
    margin-bottom: 8px;
}

.contentContainer_2RFl3 {
    background-color: #fff;
    padding: 16px;
}

.contentContainer_2RFl3 a {
    font-size: 14px;
...
.globalMessageContainer_wuKTE :before {
        display: none;
    }
