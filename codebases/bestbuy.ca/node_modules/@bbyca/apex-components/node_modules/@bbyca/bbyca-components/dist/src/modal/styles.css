.modalContainer_2Gzf5.defaultTheme_evnYM .modal {
            border-radius: 2px;
            max-width: 1280px;
            top: 50%;
...
.modalContainer_2Gzf5.defaultTheme_evnYM.visible_1ZXp- .modal {
            opacity: 1;
...
.modalContainer_2Gzf5.toaster_3Wuv1 .modal {
            position: fixed;
            top: auto;
            bottom: 0;
            margin: 0 auto;
...
.modalContainer_2Gzf5.toaster_3Wuv1.visible_1ZXp- .modal {
            opacity: 1;
            margin-bottom: 0;
            -webkit-transform: translateY(0) scale(1);
                    transform: translateY(0) scale(1);
}
.modalContainer_2Gzf5.error-toaster__QgEB .modal {
            position: fixed;
            top: auto;
            bottom: 0;
            margin: 0 auto;
...
.modalContainer_2Gzf5.error-toaster__QgEB .bgFade {
            background-color: rgba(0, 0, 0, 0);
        }
.modalContainer_2Gzf5.error-toaster__QgEB.visible_1ZXp- .modal {
            opacity: 1;
            -webkit-transform: translateY(0) scale(1);
                    transform: translateY(0) scale(1);
}
.modalContainer_2Gzf5.error_3a5FB .modal {
            max-width: 640px;
            top: 50%;
            -webkit-transform: translateY(-50%) scale(1.2) translateZ(0px);
                    transform: translateY(-50%) scale(1.2) translateZ(0px);
...
.modalContainer_2Gzf5.error_3a5FB .modal h1 {
...
.modalContainer_2Gzf5.error_3a5FB .modal .modal-content {
                clear: fix;
                text-align: center;
            }
.modalContainer_2Gzf5.error_3a5FB .modal .modal-content p {
                    text-align: left;
                }
.modalContainer_2Gzf5.error_3a5FB .modal .body {
                margin-bottom: 24px;
            }
.modalContainer_2Gzf5.error_3a5FB .modal .try-again-btn {
                width: 100%;
                margin-bottom: 30px;
            }
.modalContainer_2Gzf5.error_3a5FB .modal .back-lnk {
                color: #0046be;
                text-decoration: none;
                font-weight: 600;
            }
.modalContainer_2Gzf5.error_3a5FB .modal footer {
                width: auto;
...
.modalContainer_2Gzf5.error_3a5FB.visible_1ZXp- .modal {
            opacity: 1;
            -webkit-transform: translateY(-50%) scale(1) translateZ(0px);
                    transform: translateY(-50%) scale(1) translateZ(0px);
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
...
.modalContainer_2Gzf5.fullscreen_1kX-B {
    z-index: 1060;
    overflow: hidden;
    bottom: auto;
    height: 100%;
}
.modalContainer_2Gzf5.fullscreen_1kX-B .modal {
            border-radius: 0px;
            width: 100%;
            height: 100%;
            margin: 0 auto;
...
.modalContainer_2Gzf5.fullscreen_1kX-B.visible_1ZXp- .modal {
            opacity: 1;
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            max-height: 100%;
}
.modalContainer_2Gzf5.fullscreen_1kX-B a[class="closeIcon"] {
        top: 16px;
        z-index: 5;
...
.modalContainer_2Gzf5.visible_1ZXp- {
            visibility: visible;
}
.modalContainer_2Gzf5 .bgFade {
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            opacity: 0;
...
.modalContainer_2Gzf5 .modal a.closeIcon {
                cursor: pointer;
                position: absolute;
                right: 16px;
            }
.modalContainer_2Gzf5 .modal header {
                padding: 0;
                font-weight: 200;
                margin-bottom: 16px;
                font-size: 20px;
...
.modalContainer_2Gzf5.visible_1ZXp- .modal {
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
}
.modalContainer_2Gzf5.visible_1ZXp- .bgFade {
            -webkit-transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            transition: all 0.5s cubic-bezier(0.19, 1, 0.22, 1);
            opacity: 1;
}
