...
var additionalAnimationDelay = 45;
...
function checkPositionBounds(positionX, positionY, bounds, limitToBounds, paddingValue) {
    var minPositionX = bounds.minPositionX, minPositionY = bounds.minPositionY, maxPositionX = bounds.maxPositionX, maxPositionY = bounds.maxPositionY;
    var x = boundLimiter(positionX, minPositionX - paddingValue, maxPositionX + paddingValue, limitToBounds);
    var y = boundLimiter(positionY, minPositionY - paddingValue, maxPositionY + paddingValue, limitToBounds);
    return { x: x, y: y };
}
...
function handlePanning(event) {
    var _this = this;
    var _a = this.stateProvider, scale = _a.scale, positionX = _a.positionX, positionY = _a.positionY, _b = _a.options, limitToBounds = _b.limitToBounds, minScale = _b.minScale, _c = _a.pan, lockAxisX = _c.lockAxisX, lockAxisY = _c.lockAxisY, padding = _c.padding, paddingSize = _c.paddingSize;
    if (!this.startCoords)
        return;
    ...
    var paddingScaleValue = function () {
        return (paddingSize * _this.stateProvider.wrapperComponent.offsetWidth) / 100;
    };
    // padding
    var paddingValue = padding && scale >= minScale ? paddingScaleValue() : 0;
    // If position didn't change
    if (newPositionX === positionX && newPositionY === positionY)
        return;
    var calculatedPosition = checkPositionBounds(newPositionX, newPositionY, this.bounds, limitToBounds, paddingValue);
...
function handleCalculateZoom(delta, step, disablePadding, getTarget) {
    ...
    var newScale = checkZoomBounds(roundNumber(targetScale, 2), minScale, maxScale, size, paddingEnabled);
    return newScale;
}
...
function handleCalculatePositions(mouseX, mouseY, newScale, bounds, limitToBounds) {
    ...
    var newPositions = checkPositionBounds(calculatedPositionX, calculatedPositionY, bounds, limitToBounds, 0);
    return newPositions;
}
/**
 * Wheel zoom event
...
function handleDoubleClick(event) {
    ...
    var newScale = handleCalculateZoom.call(this, delta, step);
...
function handleZoomControls(customDelta, customStep) {
    ...
    var newScale = handleCalculateZoom.call(this, customDelta, customStep);
...
function animateVelocity() {
    var _this = this;
    var _a = this.stateProvider, positionX = _a.positionX, positionY = _a.positionY, limitToBounds = _a.options.limitToBounds, _b = _a.pan, velocityBaseTime = _b.velocityBaseTime, lockAxisX = _b.lockAxisX, lockAxisY = _b.lockAxisY, velocityAnimationType = _b.velocityAnimationType;
    if (!this.velocity || !this.bounds)
        return handleDisableAnimation.call(this);
    var _c = this.velocity, velocityX = _c.velocityX, velocityY = _c.velocityY, velocity = _c.velocity;
    ...
    // animation start timestamp
    animate.call(this, velocityAnimationType, animationTime, function (step) {
        ...
        // Save panned position
        _this.stateProvider.positionX = calculatedPosition.x;
        _this.stateProvider.positionY = calculatedPosition.y;
        // apply animation changes
        _this.setContentComponentTransformation();
    });
}
function calculateVelocityStart(event) {
    ...
    if (this.lastMousePosition) {
        ...
        var scaleMultiplier = scale / 10;
        var windowToWrapperScaleX = getWindowScale(window.innerWidth / wrapperComponent.offsetWidth, velocityMinSpeed);
        var windowToWrapperScaleY = getWindowScale(window.innerHeight / wrapperComponent.offsetHeight, velocityMinSpeed);
        var clientX = position_1.clientX, clientY = position_1.clientY;
        var distanceX = ((clientX - this.lastMousePosition.clientX) / scaleMultiplier) *
            windowToWrapperScaleX;
        var distanceY = ((clientY - this.lastMousePosition.clientY) / scaleMultiplier) *
        ...
        this.throttle = setTimeout(function () { return (_this.throttle = false); }, throttleTime);
    }
...
var StateProvider = /** @class */ (function (_super) {
    ...
    function StateProvider() {
        ...
        _this.handleWheel = function (event) {
            ...
            var _c = _this.props, onWheelStart = _c.onWheelStart, onWheel = _c.onWheel, onWheelStop = _c.onWheelStop, onZoomChange = _c.onZoomChange;
            ...
            _this.setContentComponentTransformation(null, null, null);
        ...
        _this.handleStartPanning = function (event) {
            var _a = _this.stateProvider, wrapperComponent = _a.wrapperComponent, scale = _a.scale, minScale = _a.options.minScale, _b = _a.pan, disabled = _b.disabled, limitToWrapperBounds = _b.limitToWrapperBounds;
        ...
        _this.setContentComponent = function (contentComponent) {
            _this.setState({ contentComponent: contentComponent }, function () {
                if (_this.stateProvider.options.centerContent) {
                    var scale = _this.stateProvider.scale;
        ...
        _this.setContentComponentTransformation = function (scale, posX, posY) {
...
var TransformWrapper = function (_a) {
    ...
    return (React__default.createElement(StateProvider, { defaultValues: deleteUndefinedProps({
            positionX: defaultPositionX,
            positionY: defaultPositionY,
            scale: defaultScale,
...
var TransformComponent = /** @class */ (function (_super) {
    ...
    TransformComponent.prototype.render = function () {
        ...
        return (React__default.createElement("div", { ref: this.wrapperRef, className: "react-transform-component " + styles.container + " " + wrapperClass },
            React__default.createElement("div", { ref: this.contentRef, className: "react-transform-element " + styles.content + " " + contentClass, style: style }, children)));
    };
