...
// From https://raw.githubusercontent.com/yahoo/react-intl/v1.2.2/dist/react-intl.js
// with a modification to use ReactDOM for the call to `renderToStaticMarkup`
...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.returnExports = factory(root['react'], root['react-dom/server']);
    }
}(this, function (React, ReactDOMServer) {
// /COURSERA-MODIFICATION
    "use strict";
    ...
    var $$$react$dom$server$$default = ReactDOMServer;
        ...
        render: function () {
            ...
            var values = Object.keys(props).reduce(function (values, name) {
                ...
                if (typeof value === 'string') {
                    ...
                    value = $$$react$dom$server$$default.renderToStaticMarkup(value);
                }
    ...
    return src$main$$default; // COURSERA MODIFICATION
}));
