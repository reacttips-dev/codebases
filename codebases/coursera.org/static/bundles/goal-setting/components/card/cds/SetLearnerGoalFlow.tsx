...
import GoalSettingSetGoal from 'bundles/goal-setting/components/cds/GoalSettingSetGoal';
import GoalSettingSetSchedule from 'bundles/goal-setting/components/cds/GoalSettingSetSchedule';
...
export class SetLearnerGoalFlow extends React.Component<Props, State> {
  state = {
  ...
  handeGoalSelected = (choice: GoalChoice) => {
    const { branchId, createGoal, beforeGoalSave } = this.props;
...
export default compose<Props, InputProps>(withCreateGoalMutation)(SetLearnerGoalFlow);
