...
export function ShowButton({ count, onClick, forumPostId }: ShowMoreButtonProps & DefaultButtonProps) {
  return (
    <ShowMoreControlButton
      ...
      trackingName="resource_panel_forum_thread_modal_show_N_replies_button"
    >
...
export function HideButton({ onClick, forumPostId }: DefaultButtonProps) {
  return (
    <ShowMoreControlButton
      ...
      onClick={onClick}
      forumPostId={forumPostId}
      trackingName="resource_panel_forum_thread_modal_hide_replies_button"
    >
      {_t('Hide replies')}
    </ShowMoreControlButton>
  );
  ...
  return (
    <div>
      {hasBeenClicked && shouldShowMore && (
        <ShowMoreControlButton
          trackingName="resource_panel_forum_thread_modal_show_more_replies_button"
          forumPostId={forumPostId}
