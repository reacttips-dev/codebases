/*
  This is a copy of the file here: static/bundles/course-home/page-course-welcome/next-step-card/components/OldCourseRatingAdapter.jsx, 
...
import CourseRatingSharing from 'bundles/course-home/page-course-welcome/next-step-card/components/course-complete/CourseRatingSharing';
// import 'css!./__styles__/OldAccomplishmentsAdapter';

const loadOldCourseRating = () => import(
  'bundles/course-home/page-course-welcome/next-step-card/components/course-complete/CourseRatingSharing'
);

class CourseRatingAdapterSharing extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <span className="rc-OldCourseRatingAdapter">
        {CourseRating && ratingFeedback && <CourseRatingSharing course={course} ratingFeedback={ratingFeedback} />}
      </span>
    );
  }
}
