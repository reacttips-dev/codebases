...
import CourseHeader from 'bundles/course-v2/components/navigation/CourseHeader';
import CourseNavigationItem from 'bundles/course-v2/components/navigation/CourseNavigationItem';
...
import 'css!./__styles__/CourseNavigation';
...
const CourseNavigation = (props: Props) => {
  ...
  return (
    <div className={classNames('rc-CourseNavigation', className, { 'mobile-enabled': showMobileNavigation })}>
