...
import UrlView from 'bundles/compound-assessments/components/form-parts/url/UrlView';
      ...
      <div className={bem()}>
        {isReadOnly ? (
          ...
          <div>
            ...
            {isInvalid && <ValidationError id={prompt.id} message={!!url && !isURL(url) ? INVALID_URL_ERROR : null} />}
          </div>
        )}
      </div>
    );
