...
import 'css!./__styles__/MathExpressionPreview';

const bem = initBem('MathExpressionPreview');
...
export const MathExpressionPreviewView: React.FC<MathExpressionPreviewViewProps> = ({
  ...
  <div className={bem()} role="alert">
    ...
    {latexData && latexData.success && !isLatexDataLoading && latexData.message && (
      <div
        className={bem('math-expression-preview')}
