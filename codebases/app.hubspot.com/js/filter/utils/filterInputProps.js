...
var allowedProps = (_allowedProps = {}, _defineProperty(_allowedProps, 'buttonUse', true), _defineProperty(_allowedProps, 'data-selenium-test', true), _defineProperty(_allowedProps, 'dropdownFooter', true), _defineProperty(_allowedProps, 'placeholder', true), _defineProperty(_allowedProps, 'onChange', true), _defineProperty(_allowedProps, 'className', true), _defineProperty(_allowedProps, 'value', true), _allowedProps);
/**
