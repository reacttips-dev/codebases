...
import BulkBetAssignButtonContainerAsync from './BulkBetAssignButtonContainerAsync';
...
var BulkBetAssignButtonContainer = /*#__PURE__*/function (_PureComponent) {
  _inherits(BulkBetAssignButtonContainer, _PureComponent);

  function BulkBetAssignButtonContainer(props) {
    var _this;

    _classCallCheck(this, BulkBetAssignButtonContainer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(BulkBetAssignButtonContainer).call(this, props));
    _this.getCurrentSearchQuery = _this.getCurrentSearchQuery.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(BulkBetAssignButtonContainer, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_jsx(BulkBetAssignButtonContainerAsync, {
        ...
        canAssignWhenNotOwner: isScoped(ScopesContainer.get(), 'bet-assignment-when-not-owner') || isScoped(ScopesContainer.get(), 'bet-assign-all-domains-to-any-user'),
        options: options,
        viewId: viewId
      });
    }
  ...
  return BulkBetAssignButtonContainer;
}(PureComponent);

BulkBetAssignButtonContainer.propTypes = {
  bulkActionProps: BulkActionPropsType.isRequired,
  options: PropTypes.object
};
export default BulkBetAssignButtonContainer;