...
var UISearchableSelectInput = createReactClass({
  ...
  componentDidUpdate: function componentDidUpdate() {
    // Reposition the Tether, as the results list may have changed height.
  ...
  handleSearchChange: function handleSearchChange(evt) {
    ...
    callIfPossible(onSearchChange, evt); // We reposition the Tether after the new search results flush to the DOM,
    // by way of componentDidUpdate().
  ...
  render: function render() {
    ...
    var _this$props2 = this.props,
        ...
        popoverRef = _this$props2.popoverRef,
        typeaheadPlaceholder = _this$props2.typeaheadPlaceholder,
        value = _this$props2.value,
        rest = _objectWithoutProperties(_this$props2, ["autoFocus", "children", "className", "dropdownClassName", "error", "inputRef", "itemComponent", "layout", "minimumSearchCount", "onBlur", "options", "placeholder", "popoverRef", "typeaheadPlaceholder", "value"]);

    this.hasBeenClosed = this.hasBeenClosed || this.props.open === false;
    this.popoverRef = this.popoverRef || /*#__PURE__*/createRef();
    ...
    return /*#__PURE__*/_jsx(FieldsetContextConsumer, {
      children: function children(_ref) {
        ...
        return /*#__PURE__*/_jsxs(UIAbstractDropdown, Object.assign({}, rest, {
          ...
          popoverRef: popoverRef || _this.popoverRef,
