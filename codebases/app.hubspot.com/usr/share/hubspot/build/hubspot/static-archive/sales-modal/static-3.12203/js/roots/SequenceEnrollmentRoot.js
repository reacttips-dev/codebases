...
var SequenceEnrollmentRoot = /*#__PURE__*/function (_Component) {
  _inherits(SequenceEnrollmentRoot, _Component);

  function SequenceEnrollmentRoot(props, context) {
    var _this;

    _classCallCheck(this, SequenceEnrollmentRoot);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SequenceEnrollmentRoot).call(this, props, context));
  ...
  _createClass(SequenceEnrollmentRoot, [{
    key: "inferEnrollType",
  ...
  return SequenceEnrollmentRoot;
}(Component);

SequenceEnrollmentRoot.defaultProps = {
  selectConnectedAccount: false,
  useCachedConnectedAccount: true
};
SequenceEnrollmentRoot.propTypes = {
...
export default SequenceEnrollmentRoot;