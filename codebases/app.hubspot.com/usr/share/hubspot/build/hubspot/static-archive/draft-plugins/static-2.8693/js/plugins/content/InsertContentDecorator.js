...
import { EDITABLE, PLAIN_TEXT, RENDERED } from 'draft-plugins/plugins/content/ContentOutputTypes';
import { contentCorePlugins, contentMergeTagPlugins } from 'draft-plugins/plugins/content/contentPlugins';
  ...
  return createReactClass({
    ...
    getRenderedContent: function getRenderedContent(_ref5) {
      ...
      var id = _ref5.id,
          offset = _ref5.offset,
          length = _ref5.length;
      return apiFunctions.fetchRenderedContent(id, this.props.contactEmail, this.props.contactVid).then(function (_ref6) {
        var body = _ref6.body,
