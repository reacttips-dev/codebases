...
export default (function () {
  ...
  switch (action.type) {
    case CONTACT_PROPERTIES_FETCH_SUCCEEDED:
      return state.set('contactProperties', action.payload);

    case COMPANY_PROPERTIES_FETCH_SUCCEEDED:
      return state.set('companyProperties', action.payload);

    case DEAL_PROPERTIES_FETCH_SUCCEEDED:
      return state.set('dealProperties', action.payload);

    case TICKET_PROPERTIES_FETCH_SUCCEEDED:
      return state.set('ticketProperties', action.payload);

    case SENDER_PROPERTIES_INIT:
      return state.set('senderProperties', getSenderProperties());
