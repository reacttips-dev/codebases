...
import { INPUT_DEFAULT_PADDING_X, LABEL_DEFAULT_PADDING_BOTTOM, LABEL_DEFAULT_PADDING_TOP } from 'HubStyleTokens/sizes';
...
var renderLabel = function renderLabel(children, label, labelClassName, error, htmlFor, labelId, required, tooltip, tooltipPlacement, tooltipProps, renderedInput, handleLabelClick, disabledFieldset, FormLabel, refCallback) {
...
var UIFormControl = createReactClass({
  ...
  labelRefCallback: function labelRefCallback(ref) {
    this.setState({
      labelTarget: findDOMNode(ref)
    });
  },
  render: function render() {
    ...
    var labelTarget = this.state.labelTarget;
            ...
            return /*#__PURE__*/_jsx("div", Object.assign({
              ...
              children: /*#__PURE__*/_jsxs("div", {
                ...
                children: [(label != null || help != null) && /*#__PURE__*/_jsxs(LabelWrapper, {
                  ...
                  hasLabel: label != null,
                  hasHelp: help != null,
                  children: [renderLabel(_children, label, labelClassName, error, htmlFor, _this._labelId, required, tooltip, tooltipPlacement, tooltipProps, renderedInput, _this.handleLabelClick, fieldsetContext.disabled, FormLabel, _this.labelRefCallback), renderHelp(help, helpClassName, inputId)]
                }), /*#__PURE__*/_jsx("div", {
                  ...
                  children: /*#__PURE__*/_jsx(UITooltip, {
                    ...
                    _insetAdjustment: -1 * parseInt(INPUT_DEFAULT_PADDING_X, 10),
                    target: labelTarget,
